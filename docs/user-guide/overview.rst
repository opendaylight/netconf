...
The following table describes the conceptional layers featured on the NETCONF plugin:
...
YANG leaf-list or list node, the path segment must be constructed by having leaf-list or list node name, followed by
...
For examples, refer to the :ref:`netconf-mdsal` section. It includes both bierman02 and rfc8040 sample APIs.
