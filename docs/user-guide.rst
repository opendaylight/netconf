...
.. code-block::
    ...
    http://localhost:8182/rests/operations/ietf-subscribed-notifications:establish-subscription
...
.. code-block::
    ...
    .. code-block::
        ...
        GET
        http://localhost:8182/rests/subscriptions/{subscription-id}
        Accept: text/event-stream
...
.. code-block::
    ...
    http://localhost:8182/rests/operations/ietf-subscribed-notifications:modify-subscription
...
.. code-block::
    ...
    http://localhost:8182/rests/operations/ietf-subscribed-notifications:kill-subscription
