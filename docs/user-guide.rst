...
Additionally, a PATCH request can be used to modify and existing
        ...
        "edit" : [
          {
            ...
            "value" : {
             "node": [
                {
                 "node-id": "{{node}}",
                 "netconf-node-topology:password" : "jamo"
                }
             ]
            }
         }
...
DELETE request to the same URL that was used to create the device:
