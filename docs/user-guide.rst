...
*heartbeat-interval* — Maximum idle time of web-socket session before the session is closed (milliseconds).

*idle-timeout* — Interval in milliseconds between sending of ping control frames.
