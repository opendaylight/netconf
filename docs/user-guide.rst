...
iana-ssh-encryption-algs, iana-ssh-key-exchange-algs, iana-ssh-mac-algs, iana-ssh-public-key-algs accessible `here <https://github.com/opendaylight/ietf/tree/master/model/iana>`__.
Not all algorithms listed are supported by ODL, supported algorithms can be found `here <https://apache.googlesource.com/mina-sshd/+/8eb688bcefeb5310d880078f0852a647aa8c5d4c/README.md#implemented_available-support>`__
or listed in map inside relevant implementations of `AlgorithmPolicy <https://github.com/opendaylight/netconf/blob/master/transport/transport-ssh/src/main/java/org/opendaylight/netconf/transport/ssh/AlgorithmPolicy.java>`__ class.
