...
The relevant values can be found in yang enums defined by RFC9644 RFC: iana-ssh-encryption-algs,
iana-ssh-key-exchange-algs, iana-ssh-mac-algs, iana-ssh-public-key-algs accessible `here <https://github.com/opendaylight/ietf/tree/master/model/iana>`__.
