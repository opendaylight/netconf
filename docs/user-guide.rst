...
Netconf Call Home server supports supports both of the secure transports used
...
Call Home Server allows to configure credentials per device basis, this is done by
adding username and password into ssh-client-params container.
