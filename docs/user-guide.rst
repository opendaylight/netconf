...
Reading selected module
-----------------------

Overview
~~~~~~~~

If user would like to read selected module from a Controller or NETCONF device, it is possible to use
...
*Read mounted module from device*
