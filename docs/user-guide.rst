...
OpenDaylight's NETCONF implementation enables dynamic subscription management for receiving notifications
...
ensuring interoperability across different NETCONF clients and servers.
...
.. code-block::
    ...
    http://localhost:8181/rests/operations/ietf-subscribed-notifications:establish-subscription
      ...
      **Authentication:** ``admin:admin``
      ...
      .. code-block:: xml
          ...
          <input xmlns="urn:ietf:params:xml:ns:yang:ietf-subscribed-notifications">
            ...
            <stream-xpath-filter>/example-module:foo/</stream-xpath-filter>
          </input>
...
Once a subscription is established, you can begin listening to the stream of notifications.
...
.. code-block::
    ...
    .. code-block::
        ...
        GET
        http://localhost:8181/rests/subscriptions/{subscription-id}
        Accept: text/event-stream
...
Modify an existing subscription to adjust parameters like the filtering XPath or encoding.
...
.. code-block::
    ...
    http://localhost:8181/rests/operations/ietf-subscribed-notifications:modify-subscription
   ...
   .. tab:: XML
      ...
      **Authentication:** ``admin:admin``
      ...
      .. code-block:: xml
          ...
          <input xmlns="urn:ietf:params:xml:ns:yang:ietf-subscribed-notifications">
            <subscription-id>123</subscription-id>
            <stream-xpath-filter>/new_xpath_filter_expression/</stream-xpath-filter>
       ...
       **Authentication:** ``admin:admin``
       ...
       .. code-block:: json

           {
               "input": {
                 "subscription-id": "123",
                 "stream-xpath-filter": "new_xpath_filter_expression",
                 "encoding": "xml"
               }
           }
...
~~~~~~~~~~~~~~~~~~~~~~~~~~
To terminate a subscription, you may either delete it (delete-subscription) or forcibly kill it (kill-subscription).

Using delete-subscription
^^^^^^^^^^^^^^^^^^^^^^^^^

This RPC allows a subscriber to delete a subscription that was previously created by that same subscriber using the
...
.. code-block::
    ...
    http://localhost:8181/rests/operations/ietf-subscribed-notifications:kill-subscription
