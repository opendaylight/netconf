...
-  Check that you can see config data for simulated device by executing GET request to:
   ...
   ::
       ...
       http://localhost:8181/restconf/data/network-topology:network-topology/topology=topology-netconf/node=17830-sim-device/yang-ext:mount?content=config
...
-  Now execute edit-config request by executing a POST request to:
   ...
   ::
       ...
       http://localhost:8181/restconf/data/network-topology:network-topology/topology=topology-netconf/node=17830-sim-device/yang-ext:mount
...
-  Check that you can see the same modified data in operational for
   ...
   ::
       ...
       http://localhost:8181/restconf/data/network-topology:network-topology/topology=topology-netconf/node=17830-sim-device/yang-ext:mount?content=nonconfig
...
::
    ...
    POST http://localhost:8181/restconf/operations/network-topology:network-topology/topology=topology-netconf/node=17830-sim-device/yang-ext:mount/example-ops:reboot
