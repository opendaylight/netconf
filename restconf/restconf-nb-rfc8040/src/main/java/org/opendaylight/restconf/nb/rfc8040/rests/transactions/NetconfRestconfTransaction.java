...
final class NetconfRestconfTransaction extends RestconfTransaction {
    ...
    public void cancel() {
        resultsFutures = null;
        executeWithErrorsLogging(netconfService::discardChanges);
        executeWithErrorsLogging(netconfService::unlock);
    }
    ...
    private static void executeWithErrorsLogging(final Supplier<ListenableFuture<? extends DOMRpcResult>> operation) {
