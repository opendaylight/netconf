...
public final class YangInstanceIdentifierDeserializer {
    ...
    private QName getQNameOfDataSchemaNode(final String nodeName) {
        ...
        if (dataSchemaNode instanceof ContainerSchemaNode) {
            ...
            for (final CaseSchemaNode caseNode : ((ChoiceSchemaNode) dataSchemaNode).getCases().values()) {
                if (caseNode.getQName().getLocalName().equals(nodeName)) {
                    return caseNode.getQName();
                }
            }
        }
