...
public final class ReadDataTransactionUtil {
    ...
    private static @NonNull NormalizedNode<?, ?> prepareData(final @NonNull NormalizedNode<?, ?> configDataNode,
        ...
        if (configDataNode instanceof OrderedMapNode) {
            ...
            final NormalizedNodeAttrBuilder<YangInstanceIdentifier.NodeWithValue, Object, LeafSetEntryNode<Object>> builder =
                    Builders.leafSetEntryBuilder().withNodeIdentifier(((LeafSetEntryNode<?>) configDataNode).getIdentifier  ()).withValue(configDataNode.getValue());
            return builder.build();
