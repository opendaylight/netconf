...
public final class ReadDataTransactionUtil {
    ...
    private static @Nullable NormalizedNode<?, ?> readDataViaTransaction(final @NonNull RestconfStrategy strategy,
            final @NonNull LogicalDatastoreType store, final boolean closeTransactionChain) {
        ...
        return extractReadData(strategy, closeTransactionChain, listenableFuture);
    }
    ...
    private static NormalizedNode<?, ?> extractReadData(final @NonNull RestconfStrategy strategy,
        ...
        if (closeTransactionChain) {
            ...
            FutureCallbackTx.addCallback(dataFuture, READ_TYPE_TX, dataFactory, strategy.getTransactionChain());
        } else {
