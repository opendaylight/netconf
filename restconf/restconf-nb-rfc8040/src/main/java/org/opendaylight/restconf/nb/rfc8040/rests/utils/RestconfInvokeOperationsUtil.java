...
public final class RestconfInvokeOperationsUtil {
    ...
    public static DOMActionResult invokeAction(final ContainerNode data, final Absolute schemaPath,
            final DOMActionService actionServiceHandler, final YangInstanceIdentifier yangIId) {
        return prepareActionResult(actionServiceHandler.invokeAction(schemaPath, prepareDataTreeId(yangIId), data));
    }
