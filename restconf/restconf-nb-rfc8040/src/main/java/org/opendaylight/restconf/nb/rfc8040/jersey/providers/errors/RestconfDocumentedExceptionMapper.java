...
public final class RestconfDocumentedExceptionMapper implements ExceptionMapper<RestconfDocumentedException> {
    ...
    private static final ImmutableSet<MediaType> JSON_MEDIA_TYPES = ImmutableSet.of(MediaType.APPLICATION_JSON_TYPE,
        YANG_DATA_JSON_TYPE, YANG_PATCH_JSON_TYPE);
    private static final ImmutableSet<MediaType> XML_MEDIA_TYPES = ImmutableSet.of(MediaType.APPLICATION_XML_TYPE,
