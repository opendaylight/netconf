...
final class ApiPathParser {
    ...
    private int parseStep(final String str, final int offset, final int limit) throws ParseException {
        if (offset == limit) {
            // We have an empty identifier. This runs contrary to RFC8040 specification, but is a common error with
            // clients assuming this is plain web. See https://jira.opendaylight.org/browse/NETCONF-24.
            // FIXME: make this behaviour tuneable through a system property
            return limit;
        }
