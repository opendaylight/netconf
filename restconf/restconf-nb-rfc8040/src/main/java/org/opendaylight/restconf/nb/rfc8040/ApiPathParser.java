...
abstract class ApiPathParser {
    ...
    private ApiPathParser(final String str) {
    ...
    final Step parseStep(final int offset, final int limit) throws ParseException {
        ...
        final var keyValues = parseKeyValues(idx + 1, limit);
    ...
    private ImmutableList<String> parseKeyValues(final int offset, final int limit) throws ParseException {
