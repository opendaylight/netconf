...
public final class ListenersBroker {
     ...
     *     if such listener cannot be found.
     */
    @Nonnull
    public Optional<ListenerAdapter> getDataChangeListenerFor(@Nonnull final String streamName) {
        final long stamp = dataChangeListenersLock.readLock();
        try {
    ...
    /**
     * Gets set of {@link NotificationListenerAdapter} specified by stream name.
     *
     * @param streamName Stream name.
     * @return {@link NotificationListenerAdapter} specified by stream name wrapped in {@link Optional}
     *     or {@link Optional#empty()} if is such listener cannot be found.
     */
    @Nonnull
    public Optional<NotificationListenerAdapter> getNotificationListenerFor(@Nonnull final String streamName) {
        final long stamp = notificationListenersLock.readLock();
        try {
    ...
    public ListenerAdapter registerDataChangeListener(@Nonnull final YangInstanceIdentifier path,
            @Nonnull final String streamName, @Nonnull final NotificationOutputType outputType) {
    ...
    /**
     * Creates new ({@link NotificationDefinition}) listener using input stream name and schema paths
     ...
     */
    public NotificationListenerAdapter registerNotificationListener(@Nonnull final SchemaPath schemaPath,
            @Nonnull final String streamName, @Nonnull final NotificationOutputType outputType) {
     ...
     */
    @SuppressWarnings("checkstyle:IllegalCatch")
    public void removeAndCloseDataChangeListener(@Nonnull final ListenerAdapter listener) {
        final long stamp = dataChangeListenersLock.writeLock();
        try {
     ...
     */
    @SuppressWarnings("checkstyle:IllegalCatch")
    private void removeAndCloseDataChangeListenerTemplate(@Nonnull final ListenerAdapter listener) {
        final long stamp = dataChangeListenersLock.writeLock();
        try {
     ...
     */
    @SuppressWarnings("checkstyle:IllegalCatch")
    public void removeAndCloseNotificationListener(@Nonnull final NotificationListenerAdapter listener) {
        final long stamp = notificationListenersLock.writeLock();
        try {
    ...
    @SuppressWarnings({"checkstyle:IllegalCatch"})
    private void removeAndCloseNotificationListenerTemplate(@Nonnull NotificationListenerAdapter listener) {
        try {
            Preconditions.checkNotNull(listener).close();
     ...
     */
    void removeAndCloseListener(@Nonnull final BaseListenerInterface listener) {
     ...
     */
    @Nonnull
    public static String createStreamNameFromUri(@Nonnull final String uri) {
