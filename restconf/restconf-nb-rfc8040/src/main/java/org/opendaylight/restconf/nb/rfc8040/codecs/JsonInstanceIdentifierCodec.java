...
public final class JsonInstanceIdentifierCodec extends AbstractStringInstanceIdentifierCodec {
    private final @NonNull DataSchemaContextTree dataContextTree;
    private final EffectiveModelContext context;

    public JsonInstanceIdentifierCodec(final EffectiveModelContext context) {
