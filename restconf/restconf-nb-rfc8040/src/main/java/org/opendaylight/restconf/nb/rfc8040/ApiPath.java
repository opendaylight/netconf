...
public final class ApiPath implements Immutable {
    ...
    private static ImmutableList<Step> parseEncoded(final String str, final int firstPercent)
        ...
        do {
            ...
            final int b = parseEscape(str, idx, limit);
    ...
    private static String unescapeValue(final String str, final int offset, final int limit) throws ParseException {
        ...
        while (true) {
            ...
            // We have taken care of almost all escapes but those we need for framing at this point
            final byte b = parseEscape(str, idx, limit);
            switch (b) {
                case '/':
                case ',':
                case ':':
    ...
    private static byte parseEscape(final String str, final int offset, final int limit) throws ParseException {
        if (limit - offset < 3) {
