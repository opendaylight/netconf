...
public final class ApiPath implements Immutable {
    ...
    public static ApiPath parse(final String str) throws ParseException {
        return str.isEmpty() ? EMPTY : parse(ApiPathParser.newStrict(), str);
    }

    private static ApiPath parse(final ApiPathParser parser, final String str) throws ParseException {
    ...
    public static ApiPath valueOf(final @Nullable String str) {
        ...
        try {
            return parse(ApiPathParser.newUrl(), str);
