...
public final class RestconfMappingNodeUtil {
     ...
     */
    public static ContainerNode mapDataChangeStream(final EffectiveModelContext schemaContext,
     ...
     */
    public static ContainerNode mapNotificationStreams(final EffectiveModelContext schemaContext,
    ...
    private static MapEntryNode buildStreamNode(final NotificationDefinition notification,
            final List<StreamAccessMonitoringData> accessInformation, final EffectiveModelContext schemaContext) {
    ...
    private static MapEntryNode buildStreamAccessNode(final NotificationOutputType outputType,
        ...
        streamAccessNodeBuilder.withChild(ImmutableLeafNodeBuilder.create()
                ...
                .withValue(streamLocation.toString())
                .build());
