...
public final class ApiSegment implements Immutable {
    ...
    public Optional<ApiSegment> nextSegment(final EffectiveModelContext nextModelContext) {
        return remaining.isEmpty() ? Optional.empty() : Optional.of(create(nextModelContext, remaining));
    }
