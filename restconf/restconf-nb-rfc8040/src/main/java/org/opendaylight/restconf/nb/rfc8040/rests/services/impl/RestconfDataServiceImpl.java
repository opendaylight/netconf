...
public class RestconfDataServiceImpl implements RestconfDataService {
    private static final class QueryParams {
        ...
        QueryParams(final @Nullable String point, final @Nullable String insert) {
            this.insert = insert;
            this.point = point;
        }
    }
    ...
    public Response putData(final String identifier, final NormalizedNodeContext payload, final UriInfo uriInfo) {
        ...
        final QueryParams checkedParams = checkQueryParameters(uriInfo);
        ...
        return PutDataTransactionUtil.putData(payload, ref, transactionNode, checkedParams.insert, checkedParams.point);
    }
    ...
    public Response postData(final NormalizedNodeContext payload, final UriInfo uriInfo) {
        ...
        return PostDataTransactionUtil.postData(uriInfo, payload, transactionNode,
                getSchemaContext(mountPoint), checkedParams.insert, checkedParams.point);
    }
