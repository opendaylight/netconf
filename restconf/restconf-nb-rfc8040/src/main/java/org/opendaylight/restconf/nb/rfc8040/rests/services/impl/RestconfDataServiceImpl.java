...
public class RestconfDataServiceImpl implements RestconfDataService {
    ...
    private void createAllYangNotificationStreams(final EffectiveModelContext schemaContext, final UriInfo uriInfo,
        ...
        for (final NotificationDefinition notificationDefinition : notifications) {
            ...
            writeNotificationStreamToDatastore(schemaContext, uriInfo, transaction, exist, notifiStreamXML, notifications);
            writeNotificationStreamToDatastore(schemaContext, uriInfo, transaction, exist, notifiStreamJSON, notifications);
        }
        try {
