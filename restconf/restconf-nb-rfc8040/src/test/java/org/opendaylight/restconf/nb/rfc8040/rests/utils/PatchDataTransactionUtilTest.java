...
public class PatchDataTransactionUtilTest {
    ...
    public void deleteNonexistentDataTest() {
        ...
        deleteMdsal(patchContext, new MdsalRestconfStrategy(iidContext, transactionChainHandler));
        deleteNetconf(patchContext, new NetconfRestconfStrategy(netconfService, iidContext));
    }
    ...
    private void deleteMdsal(PatchContext patchContext, RestconfStrategy strategy) {
        final PatchStatusContext patchStatusContext =
                PatchDataTransactionUtil.patchData(patchContext, strategy, this.refSchemaCtx);
