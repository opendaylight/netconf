...
public class YangInstanceIdentifierSerializerTest {
    ...
    public void serializePercentEncodingTest() {
        ...
        final String result = YangInstanceIdentifierSerializer.create(YangInstanceIdentifierSerializerTest.SCHEMA_CONTEXT, data);
    ...
    public void serializeIncludedNodesSerializationTest() {
        ...
        assertThrows(RestconfDocumentedException.class,
            () -> YangInstanceIdentifierSerializer.create(YangInstanceIdentifierSerializerTest.SCHEMA_CONTEXT, data));
    }
}
