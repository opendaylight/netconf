...
public class RestconfDocumentedExceptionMapperTest {
            ...
            },
            {
                ...
                Response.status(Status.BAD_REQUEST)
                        ...
                        .entity("{\n"
                                ...
                                + "instance-identifier-patch-module:my-list1[instance-identifier-patch-module:name"
                                + "='sample']/instance-identifier-patch-module:my-leaf12\",\n"
    ...
    private static HttpHeaders mockHttpHeaders(final MediaType contentType, final List<MediaType> acceptedTypes) {
        ...
        Mockito.when(httpHeaders.getMediaType()).thenReturn(contentType);
        Mockito.when(httpHeaders.getAcceptableMediaTypes()).thenReturn(acceptedTypes);
        return httpHeaders;
    }
    ...
    private static void compareResponseWithExpectation(final Response expectedResponse, final Response actualResponse) {
        ...
        if (expectedResponse.getMediaType().equals(RestconfDocumentedExceptionMapper.YANG_DATA_JSON_TYPE)) {
