...
public class RestconfDataServiceImplTest {
    ...
    public void testReadData() {
        ...
        doReturn(FluentFutures.immediateFluentFuture(Optional.of(this.buildBaseCont))).when(this.read)
                .read(LogicalDatastoreType.CONFIGURATION, this.iidBase);
        doReturn(FluentFutures.immediateFluentFuture(Optional.absent()))
    ...
    public void testReadDataMountPoint() {
        doReturn(new MultivaluedHashMap<String, String>()).when(this.uriInfo).getQueryParameters();
        doReturn(FluentFutures.immediateFluentFuture(Optional.of(this.buildBaseContConfig))).when(this.read)
                .read(LogicalDatastoreType.CONFIGURATION, this.iidBase);
        doReturn(FluentFutures.immediateFluentFuture(Optional.of(this.buildBaseContOperational))).when(this.read)
    ...
    public void testPutData() {
        ...
        doReturn(FluentFutures.immediateTrueFluentFuture()).when(this.readWrite)
...
//                .createTransactionChain(RestConnectorProvider.TRANSACTION_CHAIN_LISTENER);
    ...
    public void testPostData() {
        ...
        doReturn(FluentFutures.immediateFalseFluentFuture())
