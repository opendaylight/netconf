...
public final class JSONDataTreeCandidateFormatter extends DataTreeCandidateFormatter {
    ...
    String createText(final EffectiveModelContext schemaContext, final Collection<DataTreeCandidate> input,
        ...
        jsonWriter.name("notification").beginObject();
        jsonWriter.name("data-changed-notification").beginObject();
        jsonWriter.name("xmlns").value("urn:opendaylight:params:xml:ns:yang:controller:md:sal:remote");
        ...
        jsonWriter.name("xmlns").value("urn:ietf:params:xml:ns:netconf:notification:1.0");
