...
public class ReadDataTransactionUtilTest {
    ...
    public void parseUriParametersDefaultTest() {
        ...
        final WriterParameters parsedParameters = ReadDataTransactionUtil.parseUriParameters(
                "", uriInfo, schemaContext);
    ...
    public void parseUriParametersUserDefinedTest() {
        ...
        final WriterParameters parsedParameters = ReadDataTransactionUtil.parseUriParameters("", uriInfo, schemaContext);
    ...
    public void parseUriParametersContentParameterNegativeTest() {
        ...
        try {
            ReadDataTransactionUtil.parseUriParameters("", uriInfo, schemaContext);
