...
public class IdentifierCodecTest {
     ...
     * <code>String</code> URI is <code>null</code>. <code>EMPTY</code> <code>YangInstanceIdentifier</code> is
    ...
    public void codecDeserializeRootTest () {
        ...
        assertEquals("Empty Yang instance identifier expected", YangInstanceIdentifier.EMPTY, dataYangII);
    }

    /**
     * Positive test of serialization <code>EMPTY</code> <code>YangInstanceIdentifier</code>. An empty
     * <code>String</code> is expected to be returned.
     */
    @Test
    public void codecSerializeRootTest () {
        ...
        assertTrue("Empty string expected", serialized.isEmpty());
    }
}
