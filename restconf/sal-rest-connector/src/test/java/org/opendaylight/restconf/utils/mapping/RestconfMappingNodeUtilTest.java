...
public class RestconfMappingNodeUtilTest {
    ...
    public void setup() throws Exception {
        ...
        when(leafName.getQName()).thenReturn(QName.create("", RestconfMappingNodeConstants.NAME));
        when(leafDescription.getQName()).thenReturn(QName.create("", RestconfMappingNodeConstants.DESCRIPTION));
        when(leafReplaySupport.getQName()).thenReturn(QName.create("", RestconfMappingNodeConstants.REPLAY_SUPPORT));
        when(leafReplayLog.getQName()).thenReturn(QName.create(RestconfMappingNodeConstants.REPLAY_LOG));
        when(leafEvents.getQName()).thenReturn(QName.create("", RestconfMappingNodeConstants.EVENTS));

        allStreamChildNodes = Sets.newHashSet(
                leafName, leafDescription, leafReplaySupport, leafReplayLog, leafEvents);
    ...
    public void restconfMappingNodeTest() {
        ...
        final MapNode modules = RestconfMappingNodeUtil.restconfMappingNode(
                getTestingRestconfModule("ietf-restconf"), this.modules);
    ...
    public void restconfMappingNodeNoGroupingsNegativeTest() {
        ...
        // test
        try {
            RestconfMappingNodeUtil.restconfMappingNode(mockRestconfModule, this.modules);
    ...
    public void restconfMappingNodeRestconfGroupingNoChildNegativeTest() {
        ...
        when(mockRestconfGrouping.getQName()).thenReturn(QName.create("", RestconfModule.RESTCONF_GROUPING_SCHEMA_NODE));
     ...
     */
    @Test
    public void toStreamEntryNodeIllegalListStreamneagtiveTest() {
        thrown.expect(IllegalStateException.class);
    ...
    public void toStreamEntryNodeMissingStreamNameNegativeTest() {
        prepareMockListWithMissingLeaf(leafName);
    ...
    public void toStreamEntryNodeMissingStreamDescriptionTest() {
        prepareMockListWithMissingLeaf(leafDescription);
    ...
    public void toStreamEntryNodeMissingStreamReplaySupportTest() {
        prepareMockListWithMissingLeaf(leafReplaySupport);
    ...
    public void toStreamEntryNodeMissingStreamReplayLogTest() {
        prepareMockListWithMissingLeaf(leafReplayLog);
    ...
    public void toStreamEntryNodeMissingStreamEventsTest() {
        prepareMockListWithMissingLeaf(leafEvents);
    ...
    public void toStreamEntryNodeStreamNameTest() {
        prepareMockListWithIllegalLeaf(leafName);
    ...
    public void toStreamEntryNodeStreamDescriptionTest() {
        prepareMockListWithIllegalLeaf(leafDescription);
    ...
    public void toStreamEntryNodeStreamReplaySupportTest() {
        prepareMockListWithIllegalLeaf(leafReplaySupport);
    ...
    public void toStreamEntryNodeStreamReplayLogTest() {
        prepareMockListWithIllegalLeaf(leafReplayLog);
    ...
    public void toStreamEntryNodeStreamEventsTest() {
        prepareMockListWithIllegalLeaf(leafEvents);
    ...
    private void verifyLoadedModules(final MapNode modules) {
        ...
        verifyLoadedModulesMap(this.modules, loadedModules);
    }
     ...
     */
    private final void verifyLoadedModulesMap(Set<Module> expectedModules, Map<String, String> loadedModules) {
    ...
    /**
     * Verify if stream was correctly written into {@link MonitoringModule#STREAM_LIST_SCHEMA_NODE} node in Restconf
     * module.
    ...
    private final void verifyStream(final String streamName, final MapEntryNode streamNode) {
        ...
        while (entries.hasNext()) {
            final Map.Entry e = ((AbstractMap.SimpleImmutableEntry) entries.next());
     ...
     */
    private final Module getTestingRestconfModule(final String s) {
        return this.schemaContext.findModuleByName(s, Draft11.RestconfModule.IETF_RESTCONF_QNAME.getRevision());
    }

    private final void prepareMockListWithMissingLeaf(final LeafSchemaNode leaf) {
    ...
    private final void prepareMockListWithIllegalLeaf(final LeafSchemaNode leaf) {
        // prepare set of leaf without selected leaf
        final Set childLeafs = new HashSet<>(this.allStreamChildNodes);
        childLeafs.remove(leaf);
