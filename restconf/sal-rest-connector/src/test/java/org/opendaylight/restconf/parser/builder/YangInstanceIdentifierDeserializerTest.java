...
public class YangInstanceIdentifierDeserializerTest {
    ...
    @Ignore
    @Test
    public void prepareNodeWithValueNullQnameNegativeTest() {}
    ...
    @Ignore
    @Test
    public void allKeysEmptyTest() {}

    // FIXME this is bug in current implementation + correctly implement this test
    /**
     * When for leaf list there is no specified key value an <code>Exception</code> is expected.
     */
    @Ignore
    @Test
    public void leafListMissingKeyNegativeTest() {
        String URI = "/list-test:top/list1=%2C%27" + '"' + "%3A" + '"' + "%20%2F,,foo/list2=a,b/result=";
        YangInstanceIdentifierDeserializer.create(schemaContext, URI);
    }
}
