...
public class ParameterAwareNormalizedNodeWriterFieldsTest {
     ...
     * Fields parameter selects 0/1 of containers children to be written.
     */
    @Test
    public void writeContainerWithSelectedFieldsTest() throws Exception {
        final List<Set<QName>> selectedFields = new ArrayList<>();
        selectedFields.add(Sets.newHashSet());

        final ParameterAwareNormalizedNodeWriter parameterWriter = ParameterAwareNormalizedNodeWriter.forStreamWriter(
                writer, null, selectedFields);
     ...
     * Fields parameter selects 1/1 of containers children to be written.
     */
    @Test
    public void writeContainerAllFieldsTest() throws Exception {
        final List<Set<QName>> selectedFields = new ArrayList<>();
        selectedFields.add(Sets.newHashSet(leafSetNodeIdentifier.getNodeType()));
    ...
    /**
     * Test write {@link MapNode} when all its children are selected to be written.
     * Fields parameter selects 1/1 of map node children to be written.
     */
    @Test
    public void writeMapNodeAllFieldsTest() throws Exception {
        final List<Set<QName>> selectedFields = new ArrayList<>();
        selectedFields.add(Sets.newHashSet(mapEntryNodeIdentifier.getNodeType()));
