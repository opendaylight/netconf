...
public class DeleteDataTransactionUtilTest {
    ...
    @Mock CheckedFuture<Boolean, ReadFailedException> checkDataExistsFuture;
    ...
    public void init() throws Exception {
        ...
        Mockito.when(this.transaction.exists(LogicalDatastoreType.CONFIGURATION, YangInstanceIdentifier.EMPTY))
                .thenReturn(this.checkDataExistsFuture);
    ...
    public void deleteData() throws Exception {
        ...
        Mockito.when(this.checkDataExistsFuture.get()).thenReturn(Boolean.TRUE);
    ...
    public void deleteDataNegativeTest() throws Exception {
        // assert that data to delete exists
        Mockito.when(this.checkDataExistsFuture.get()).thenReturn(Boolean.FALSE);
