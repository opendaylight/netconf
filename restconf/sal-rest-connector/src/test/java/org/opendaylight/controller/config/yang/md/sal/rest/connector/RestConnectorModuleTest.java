...
public class RestConnectorModuleTest {
    ...
    private void setInnerField(final RestConnectorModule rcm, final String name, final Object value) throws Exception {
        final Field declaredField = rcm.getClass().getSuperclass().getDeclaredField(name);
        declaredField.setAccessible(true);
        declaredField.set(rcm, value);
    }

    private void setField(final RestConnectorModule rcm, final String name, final Object value) throws Exception {
