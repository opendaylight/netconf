...
public abstract class Draft16AbstractBodyReaderTest {
    ...
    protected static DOMMountPointServiceHandler mountPointServiceHandler = mock(DOMMountPointServiceHandler.class);

    Draft16AbstractBodyReaderTest() throws Exception {
