...
public class TestDraft16XmlPATCHBodyReaderMountPoint extends Draft16AbstractBodyReaderTest {
    ...
    public TestDraft16XmlPATCHBodyReaderMountPoint() throws Exception {
        super();
