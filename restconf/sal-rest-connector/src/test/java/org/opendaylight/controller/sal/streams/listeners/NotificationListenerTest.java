...
public class NotificationListenerTest {
    ...
    @Test
    public void test() {
        final SchemaPath schemaPathNotification = SchemaPath.create(true,
                QName.create("notifi:test", "2016-09-27", "notifi"));
        ...
        final NotificationListenerAdapter notificationListenerAdapter = Notificator
                .createNotificationListener(paths, "streamName", "JSON").get(0);
    ...
    public void testWithAugment() {
        final SchemaPath schemaPathNotifi = SchemaPath.create(true,
                QName.create("http://example.com/schema/interfaces", "2016-10-07", "notifi"));
    ...
    private void prepareNotifiWithAugment(final DOMNotification notification, final SchemaPath schemaPathNotifi) {
        ...
        final LeafNode augmentLeaf = prepareLeaf("http://example.com/schema/ds0", "2016-10-07", "ds0ChannelNumber",
                "ds0ChannelNumber=8888");
        final LeafNode ifIndexLeaf = prepareLeaf("http://example.com/schema/interfaces", "2016-10-07", "ifIndex", "1");
        ...
        final QName mapNodeListIfEntryQName = QName.create("http://example.com/schema/interfaces", "2016-10-07",
                "ifEntry");
        Mockito.when(listIfEntry.getNodeType()).thenReturn(mapNodeListIfEntryQName);
        Mockito.when(listIfEntry.getValue()).thenReturn(
        ...
        final QName interfacesContQName = QName.create("http://example.com/schema/interfaces", "2016-10-07",
                "interfaces");
    ...
    private void prepareNotifi(final DOMNotification notification, final SchemaPath schemaPathNotification) {
        ...
        final LeafNode leafDescrContConfig = prepareLeaf("urn:system:connector", "2016-05-10", "description",
                "connector created for testing");
        final LeafNode leafAdminStatusContConfig = prepareLeaf("urn:system:connector", "2016-05-10", "admin-status",
                "system-connector:unlocked");
