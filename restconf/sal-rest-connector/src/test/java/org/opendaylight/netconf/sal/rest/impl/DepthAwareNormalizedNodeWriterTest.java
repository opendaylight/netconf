...
public class DepthAwareNormalizedNodeWriterTest {
    ...
    private String leafSetEntryValue;
    ...
    public void setUp() {
        ...
        leafSetEntryValue = "value";
        leafSetEntryNodeIdentifier = new NodeWithValue<>(leafSetEntryNodeQName, leafSetEntryValue);
        ...
        // values
        Mockito.when(leafSetEntryNodeData.getValue()).thenReturn(leafDataValue);
    ...
    public void writeContainerWithChildrenTest() throws Exception {
        ...
        inOrder.verify(writer, Mockito.times(1)).leafSetEntryNode(
                leafSetEntryNodeIdentifier.getNodeType(), leafSetEntryValue);
