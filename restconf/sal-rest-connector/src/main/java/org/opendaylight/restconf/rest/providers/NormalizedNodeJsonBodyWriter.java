 ...
 */
package org.opendaylight.restconf.rest.providers;
...
@Provider
@Produces({ Draft09.MediaTypes.API + RestconfConstants.JSON, Draft09.MediaTypes.DATA + RestconfConstants.JSON,
        Draft09.MediaTypes.OPERATION + RestconfConstants.JSON, MediaType.APPLICATION_JSON })
public class NormalizedNodeJsonBodyWriter implements MessageBodyWriter<NormalizedNodeContext> {
    ...
    public void writeTo(final NormalizedNodeContext t, final Class<?> type, final Type genericType,
        ...
        final InstanceIdentifierContext<SchemaNode> context = (InstanceIdentifierContext<SchemaNode>) t
    ...
    private void writeNormalizedNode(final JsonWriter jsonWriter, SchemaPath path,
        ...
        if (SchemaPath.ROOT.equals(path)) {
            /*
             * Creates writer without initialNs and we write children of root
             * data container which is not visible in restconf
             */
            ...
            /*
             * RpcDefinition is not supported as initial codec in
             * JSONStreamWriter, so we need to emit initial output
             * declaratation..
             */
    ...
    private void writeChildren(final RestconfNormalizedNodeWriter nnWriter, final ContainerNode data)
            throws IOException {
    ...
    private RestconfNormalizedNodeWriter createNormalizedNodeWriter(final InstanceIdentifierContext<SchemaNode> context,
        ...
        final NormalizedNodeStreamWriter streamWriter = JSONNormalizedNodeStreamWriter.createNestedWriter(codecs, path,
