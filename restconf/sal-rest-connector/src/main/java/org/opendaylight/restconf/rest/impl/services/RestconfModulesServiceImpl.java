...
public class RestconfModulesServiceImpl implements RestconfModulesService {
    ...
    public NormalizedNodeContext getModule(final String identifier, final UriInfo uriInfo) {
        ...
        // final QName moduleNameAndRevision =
        // getModuleNameAndRevision(identifier);
        // Module module = null;
        // DOMMountPoint mountPoint = null;
        // final SchemaContext schemaContext;
        // if (identifier.contains(ControllerContext.MOUNT)) {
        // final InstanceIdentifierContext<?> mountPointIdentifier =
        // this.restSchemaController
        // .toMountPointIdentifier(identifier);
        // mountPoint = mountPointIdentifier.getMountPoint();
        // module =
        // this.restSchemaController.findModuleByNameAndRevision(mountPoint,
        // moduleNameAndRevision);
        // schemaContext = mountPoint.getSchemaContext();
        // } else {
        // module =
        // this.restSchemaController.findModuleByNameAndRevision(moduleNameAndRevision);
        // schemaContext = this.restSchemaController.getGlobalSchema();
        // }
        //
        // if (module == null) {
        // final String errMsg = "Module with name '" +
        // moduleNameAndRevision.getLocalName() + "' and revision '"
        // + moduleNameAndRevision.getRevision() + "' was not found.";
        // LOG.debug(errMsg);
        // throw new RestconfDocumentedException(errMsg, ErrorType.PROTOCOL,
        ...
        // controllerContext.getRestconfModuleRestConfSchemaNode(restconfModule,
        // Draft02.RestConfModule.MODULE_LIST_SCHEMA_NODE);
        // Preconditions.checkState(moduleSchemaNode instanceof ListSchemaNode);
        //
        // return new NormalizedNodeContext(
        // new InstanceIdentifierContext<>(null, moduleSchemaNode, mountPoint,
