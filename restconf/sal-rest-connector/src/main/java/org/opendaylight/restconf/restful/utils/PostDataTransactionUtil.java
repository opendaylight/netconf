...
public final class PostDataTransactionUtil {
    ...
    private static CheckedFuture<Void, TransactionCommitFailedException> submitData(final YangInstanceIdentifier path,
        ...
        if (data instanceof MapNode) {
            ...
            transaction.merge(LogicalDatastoreType.CONFIGURATION, YangInstanceIdentifier.create(emptySubTree.getIdentifier()), emptySubTree);
     ...
     *            - path to data
     */
    private static void putData(final NormalizedNode<?, ?> child, final DOMTransactionChain transactionChain,
        ...
        readWriteTx.put(LogicalDatastoreType.CONFIGURATION, path, child);
    }
