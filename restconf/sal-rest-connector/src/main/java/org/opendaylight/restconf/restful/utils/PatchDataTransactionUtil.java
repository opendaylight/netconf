...
public final class PatchDataTransactionUtil {
    ...
    public static PATCHStatusContext patchData(final PATCHContext context, final TransactionVarsWrapper transactionNode,
        ...
        int errorCounter = 0;
        final DOMDataReadWriteTransaction tx = transactionNode.getTransaction().newReadWriteTransaction();
        ...
        if (errorCounter == 0) {
            ...
            tx.cancel();
            RestConnectorProvider.resetTransactionChainForAdapaters(transactionNode.getTransaction());
