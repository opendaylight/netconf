...
public final class YangInstanceIdentifierSerializer {
    ...
    public static String create(final SchemaContext schemaContext, final YangInstanceIdentifier data) {
        ...
        final WrapparForMainVariables variables = new YangInstanceIdentifierSerializer.WrapparForMainVariables(current);

        prepareFirstArgForPath(variables, path, data);
    ...
    private static void prepareFirstArgForPath(final WrapparForMainVariables variables, final StringBuilder path,
    ...
    private static class WrapparForMainVariables {

        private DataSchemaContextNode<?> current;

        public WrapparForMainVariables(final DataSchemaContextNode<?> current) {
