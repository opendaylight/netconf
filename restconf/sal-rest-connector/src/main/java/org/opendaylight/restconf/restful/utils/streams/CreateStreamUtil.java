...
public final class CreateStreamUtil {
     ...
     *
     */
    public static CheckedFuture<DOMRpcResult, DOMRpcException> createStream(final NormalizedNodeContext payload,
    ...
    private static String prepareStream(final YangInstanceIdentifier path, final SchemaContext schemaContext,
        ...
        final String streamName = Notificator.createStreamNameFromUri(ParserIdentifier.toString(path, schemaContext)
