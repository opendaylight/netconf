...
public class MonitoringModule {
    ...
    public MonitoringModule(final RestSchemaController restSchemaController) {
        this.restSchemaController = restSchemaController;
    }

    protected Module getMonitoringModule() {
        final Module monitoringModule = this.restSchemaController.getMonitoringModule();
