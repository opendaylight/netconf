...
public abstract class AbstractRestconfServices {

    private static final Logger LOG = LoggerFactory.getLogger(AbstractRestconfServices.class);

    protected final RestSchemaController restSchemaController;

    public AbstractRestconfServices(final RestSchemaController restSchemaController) {
