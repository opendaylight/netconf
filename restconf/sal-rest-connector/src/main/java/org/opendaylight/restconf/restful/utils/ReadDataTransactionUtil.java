...
public final class ReadDataTransactionUtil {
     ...
     */
    @Nonnull public static WriterParameters parseUriParameters(@Nonnull final String defaultNamespace,
        ...
        if (!fields.isEmpty()) {
            builder.setFields(ParserFieldsParameter.parseFieldsParameter(fields.get(0), defaultNamespace, context));
        }
