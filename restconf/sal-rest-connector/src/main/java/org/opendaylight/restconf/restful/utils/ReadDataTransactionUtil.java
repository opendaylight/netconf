...
public final class ReadDataTransactionUtil {
     ...
     */
    @Nonnull public static WriterParameters parseUriParameters(@Nonnull final InstanceIdentifierContext<?> identifier,
        ...
        if (!fields.isEmpty()) {
            //
            ParserFieldsParameter.parseFieldsParameter(identifier, fields.get(0));
        }
