 ...
 */
package org.opendaylight.restconf.rest.api;

import org.opendaylight.yangtools.yang.common.QName;

public class Draft09 {
    ...
    public static interface MediaTypes {
        ...
        String ERRORS = "application/yang.errors";
        String YIN = "application/yin";
        String YANG = "application/yang";
    }

    public static interface RestConfModule {
        String REVISION = "2016-03-07";
        ...
        QName IETF_RESTCONF_QNAME = QName.create(Draft09.RestConfModule.NAMESPACE, Draft09.RestConfModule.REVISION,
        ...
        QName ERROR_PATH_QNAME = QName.create(IETF_RESTCONF_QNAME, "error-path");
    }
}
