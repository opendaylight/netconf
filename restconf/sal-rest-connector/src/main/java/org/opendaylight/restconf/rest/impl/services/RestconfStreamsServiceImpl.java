...
public class RestconfStreamsServiceImpl extends AbstractRestconfServices implements RestconfStreamsService {
    ...
    private MapEntryNode toStreamEntryNode(final String streamName, final DataSchemaNode streamSchemaNode) {
        ...
        instanceDataChildrenByName = ControllerContext.findInstanceDataChildrenByName((listStreamSchemaNode),
                "description");
