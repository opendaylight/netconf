...
public class ParameterAwareNormalizedNodeWriter implements RestconfNormalizedNodeWriter {
    ...
    protected final Optional<Integer> maxDepth;
    protected final Optional<List<String>> fields;
    ...
    public static ParameterAwareNormalizedNodeWriter forStreamWriter(
            final NormalizedNodeStreamWriter writer, final Optional<Integer> maxDepth, Optional<List<String>> fields) {
