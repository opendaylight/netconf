...
@Provider
@Produces({ Draft09.MediaTypes.API + RestconfConstants.XML, Draft09.MediaTypes.DATA + RestconfConstants.XML,
        Draft09.MediaTypes.OPERATION + RestconfConstants.XML, MediaType.APPLICATION_XML, MediaType.TEXT_XML })
