...
public class ListenerReader implements ClusteredDOMDataTreeChangeListener {
    ...
    private ListenerRegistration<DOMDataTreeChangeListener> registerDataTreeChangeListener;
    ...
    public Future<Optional<NormalizedNode<?, ?>>> readNode(final YangInstanceIdentifier path,
        ...
        this.registerDataTreeChangeListener = service.registerDataTreeChangeListener(identifier, this);
