...
public final class YangInstanceIdentifierDeserializer {
    ...
    public static Iterable<PathArgument> create(final SchemaContext schemaContext, final String data) {
        ...
        final int offset = 0;
        final WrapperForMainVariables variables = new YangInstanceIdentifierDeserializer.WrapperForMainVariables(data,
    ...
    private static void prepareNodeWithPredicates(final QName qname, final List<PathArgument> path,
            final WrapperForMainVariables variables) {
    ...
    private static QName prepareQName(final WrapperForMainVariables variables) {
        checkValid(
    ...
    private static String nextIdentifierFromNextSequence(final CharMatcher matcher, final WrapperForMainVariables variables) {
    ...
    private static void nextSequenceEnd(final CharMatcher matcher, final WrapperForMainVariables variables) {
        while (!allCharsConsumed(variables)
    ...
    private static QName getQNameOfDataSchemaNode(final String nodeName, final WrapperForMainVariables variables) {
    ...
    private static void validArg(final WrapperForMainVariables variables) {
    ...
    private static void skipCurrentChar(final WrapperForMainVariables variables) {
        variables.setOffset(variables.getOffset() + 1);
    }
    ...
    private static boolean allCharsConsumed(final WrapperForMainVariables variables) {
        return variables.getOffset() == variables.getData().length();
    }

    private static class WrapperForMainVariables {
        ...
        public WrapperForMainVariables(final String data, final DataSchemaContextNode<?> current, final int offset,
