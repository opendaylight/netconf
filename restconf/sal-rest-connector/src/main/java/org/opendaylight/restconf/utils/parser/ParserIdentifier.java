...
public final class ParserIdentifier {
    ...
    /**
     * Make {@link InstanceIdentifierContext} from identifier. Returned {@link InstanceIdentifierContext} refers only
     * to context on the controller, it never contains {@link DOMMountPoint}.
     *
     * @param identifier
     *            - path identifier
     * @param schemaContext
     ...
     */
    public static @Nonnull InstanceIdentifierContext<?> toInstanceIdentifier(@Nullable final String identifier,
     ...
     * controllers {@link SchemaContext}.
     * <br>
     ...
     * @return {@link InstanceIdentifierContext}
     */
    public static @Nonnull InstanceIdentifierContext<?> toCompleteInstanceIdentifier(
            @Nullable final String identifier,
            @Nonnull final SchemaContext schemaContext,
            @Nonnull final DOMMountPointService mountPointService) {
        if (identifier != null && identifier.contains(RestconfConstants.MOUNT)) {
            ...
            final Optional<DOMMountPoint> mountPoint = mountPointService.getMountPoint(mountYangInstanceIdentifier);
            ...
            final String pathId = pathsIt.next();
