...
public final class ParserIdentifier {
    ...
    private static DOMMountPointService domMountPointService = null;

    public static InstanceIdentifierContext<?> toInstanceIdentifier(final String identifier,
            final SchemaContext schemaContext, final boolean mountPoint) {
        final IdentifierCodec idCodec = new IdentifierCodec(schemaContext);
        ...
        if (identifier.contains(RestconfConstants.MOUNT)) {
            ...
            deserialize = idCodec.deserialize(mountPointId);
        } else {
            deserialize = idCodec.deserialize(identifier);
        }
    ...
    public static SchemaExportContext toSchemaExportContextFromIdentifier(final SchemaContext schemaContext,
        ...
        if (!Iterables.contains(pathComponents, RestconfConstants.MOUNT)) {
            ...
            final InstanceIdentifierContext<?> point = ParserIdentifier
                    .toMountPointIdentifier(pathBuilder.toString(), schemaContext, domMountPointService);
    ...
    public static InstanceIdentifierContext<?> toMountPointIdentifier(final String identifier,
            final SchemaContext schemaContext, final DOMMountPointService domMountPointService) {
        ParserIdentifier.domMountPointService = domMountPointService;
        return toInstanceIdentifier(identifier, schemaContext, true);
    }
}
