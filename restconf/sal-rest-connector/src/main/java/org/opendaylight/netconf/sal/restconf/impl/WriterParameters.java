...
public class WriterParameters {
    ...
    public Optional<List<QName>> getFields() {
        return fields;
    }
    ...
    public static class WriterParametersBuilder {
        ...
        private Optional<List<QName>> fields = Optional.absent();
        ...
        public WriterParametersBuilder setFields(final List<QName> fields) {
