 ...
 */
public class ListenerAdapter extends CommonSubscriberAbstract implements DOMDataChangeListener {
    ...
    private Node createCreatedChangedDataChangeEventElement(final Document doc, final Entry<YangInstanceIdentifier,
        ...
        try {
            ...
            final DOMResult domResult = writeNormalizedNode(normalized, path, schemaContext, nodePath);
