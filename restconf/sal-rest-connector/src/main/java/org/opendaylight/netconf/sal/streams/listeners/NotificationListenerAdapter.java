 ...
 *
 */
public class NotificationListenerAdapter extends CommonSubscriberAbstract implements DOMNotificationListener {
    ...
    private void addValuesToNotificationEventElement(final Document doc, final Element element,
        ...
        try {
            ...
            final DOMResult domResult = writeNormalizedNode(body,
                    YangInstanceIdentifier.create(body.getIdentifier()), schemaContext, this.path);
