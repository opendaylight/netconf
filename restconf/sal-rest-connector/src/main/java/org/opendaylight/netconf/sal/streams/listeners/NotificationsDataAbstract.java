 ...
 *
 */
abstract class NotificationsDataAbstract {

    private static final Logger LOG = LoggerFactory.getLogger(NotificationsDataAbstract.class);
    ...
    protected void deleteDataInDS() throws Exception {
        ...
        wTx.delete(LogicalDatastoreType.OPERATIONAL,
                IdentifierCodec.deserialize(
                        MonitoringModule.PATH_TO_STREAM_WITHOUT_KEY + this.localName, this.schemaHandler.get()));
    ...
    protected DOMResult writeNormalizedNode(final NormalizedNode<?, ?> normalized, final YangInstanceIdentifier path,
