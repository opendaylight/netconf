...
public class BrokerFacade {
    ...
    private void checkItemExists(final DOMDataReadWriteTransaction rWTransaction,
        ...
        Futures.addCallback(future, new FutureCallback<Boolean>() {
            ...
            public void onFailure(final Throwable t) {
                responseWaiter.countDown();
                handlingCallback(t, store, path, null, readData);
            }
        });
     ...
     * @param datastore Datastore from which data were red
     * @param path Path from which data were red
     * @param result Result of read from {@code datastore}
     * @param readData Result which will be set
     * @param <X> Result type
     */
