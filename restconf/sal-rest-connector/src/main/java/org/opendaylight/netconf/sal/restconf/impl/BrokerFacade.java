...
public class BrokerFacade {
    ...
    /**
     * Call POST request and submit transaction
     * @return
     */
    private CheckedFuture<Void, TransactionCommitFailedException> postDataViaTransaction(
        ...
        callPostRequest(rWTransaction, datastore, path, payload, schemaContext);
        return rWTransaction.submit();
    }

    /**
     * Call POST request and do NOT submit transaction
     */
    ...
    private void callPostRequest(final DOMDataReadWriteTransaction rWTransaction, final LogicalDatastoreType datastore,
    ...
    /**
     * Call PUT request and submit {@link DOMDataReadWriteTransaction}
     */
    private CheckedFuture<Void, TransactionCommitFailedException> putDataViaTransaction(
        ...
        callPutRequest(readWriteTransaction, datastore, path, payload, schemaContext);
        return readWriteTransaction.submit();
    }

    /**
     * Call PUT request and do NOT submit {@link DOMDataReadWriteTransaction}
     */
    private void putDataWithinTransaction(
            final DOMDataReadWriteTransaction writeTransaction, final LogicalDatastoreType datastore,
            final YangInstanceIdentifier path, final NormalizedNode<?, ?> payload, final SchemaContext schemaContext) {
        LOG.trace("Put {} within Restconf PATCH: {} with payload {}", datastore.name(), path, payload);
        callPutRequest(writeTransaction, datastore, path, payload, schemaContext);
    }
