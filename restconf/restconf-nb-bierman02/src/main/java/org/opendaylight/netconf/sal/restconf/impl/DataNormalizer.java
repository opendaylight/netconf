...
class DataNormalizer {
    ...
    Entry<YangInstanceIdentifier, Inference> toNormalized(final YangInstanceIdentifier legacy) {
        ...
        return Map.entry(YangInstanceIdentifier.create(normalizedArgs), stack.toInference());
    }
