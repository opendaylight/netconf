...
public class BaseYangSwaggerGenerator {
        ...
        for (final DataSchemaNode childNode : childSchemaNodes) {
            if (childNode instanceof ListSchemaNode || childNode instanceof ContainerSchemaNode) {
                ...
                if (childNode.isConfiguration() == addConfigApi) {
                    addApis(childNode, apis, resourcePath, pathParams, schemaContext, addConfigApi, parentName + "/" + node.getQName().getLocalName());
                }
            }
        }
    ...
    private List<Operation> operationPost(final String name, final String description, final DataNodeContainer dataNodeContainer,
        ...
        final List<Operation> operations = new ArrayList<>();
        if (isConfig) {
            final Post postBuilder = new Post(parentName + name, description, dataNodeContainer);
