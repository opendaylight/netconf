...
public class ApiDocServiceImpl implements ApiDocService {
    ...
    public synchronized Response getAllModulesDoc(final UriInfo uriInfo) {
        final SwaggerObject allModulesDoc;
        if (isNew(uriInfo).equals(URIType.RFC8040)) {
            allModulesDoc = allModulesDocGenerator.getAllModulesDoc(uriInfo, URIType.RFC8040);
        } else {
            allModulesDoc = allModulesDocGenerator.getAllModulesDoc(uriInfo, URIType.DRAFT02);
        }
