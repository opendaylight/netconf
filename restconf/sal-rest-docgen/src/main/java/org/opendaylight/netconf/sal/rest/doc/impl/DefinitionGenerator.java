...
public class DefinitionGenerator {
    ...
    public JsonGenerator convertToJsonSchema(final Module module, final EffectiveModelContext schemaContext,
            final JsonGenerator gen, final DefinitionNames definitionNames, final boolean isForSingleModule)
            throws IOException {
        ...
        processContainersAndLists(module, gen, definitionNames, schemaContext);
        processRPCs(module, gen, definitionNames, schemaContext);

        if (isForSingleModule) {
            processModule(module, gen, definitionNames, schemaContext);
        }
        return gen;
    }
