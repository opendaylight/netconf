...
public class ModelGenerator {
    ...
    public ObjectNode convertToJsonSchema(final Module module,
        ...
        final ObjectNode models = new ObjectNode(JsonNodeFactory.instance);
    ...
    private ObjectNode processTopData(final String filename, final ObjectNode models, final SchemaNode schemaNode) {
        final ObjectNode items = new ObjectNode(JsonNodeFactory.instance);

        items.put(REF_KEY, filename);
        final ObjectNode dataNodeProperties = new ObjectNode(JsonNodeFactory.instance);
        ...
        final ObjectNode properties = new ObjectNode(JsonNodeFactory.instance);
    ...
    private static void processIdentities(final Module module, final ObjectNode models) {
        ...
        for (final IdentitySchemaNode idNode : idNodes) {
            final ObjectNode identityObj = new ObjectNode(JsonNodeFactory.instance);
            ...
            final ObjectNode props = new ObjectNode(JsonNodeFactory.instance);
    ...
    private ObjectNode processLeafListNode(final LeafListSchemaNode listNode,
        ...
        final ObjectNode itemsVal = new ObjectNode(JsonNodeFactory.instance);
    ...
    private static String processBinaryType(final ObjectNode property) {
        final ObjectNode media = new ObjectNode(JsonNodeFactory.instance);
    ...
    private static ObjectNode getSchemaTemplate() {
        final ObjectNode schemaJSON = new ObjectNode(JsonNodeFactory.instance);
