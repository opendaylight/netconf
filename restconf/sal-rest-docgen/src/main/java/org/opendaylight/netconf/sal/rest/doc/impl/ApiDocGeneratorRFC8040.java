...
public class ApiDocGeneratorRFC8040 extends BaseYangOpenApiGeneratorRFC8040 {
    public ApiDocGeneratorRFC8040(final @NonNull DOMSchemaService schemaService) {
        super(schemaService);
    }

    public ApiDocGeneratorRFC8040(final @NonNull DOMSchemaService schemaService, final @NonNull String basePath) {
