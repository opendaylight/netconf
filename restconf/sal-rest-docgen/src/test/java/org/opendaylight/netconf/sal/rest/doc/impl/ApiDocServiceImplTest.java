...
public final class ApiDocServiceImplTest extends AbstractApiDocTest {
    ...
    public void before() {
        ...
        final MountPointSwaggerGeneratorRFC8040 mountPointRFC8040 =
                new MountPointSwaggerGeneratorRFC8040(SCHEMA_SERVICE, service, "rests");
        final ApiDocGeneratorRFC8040 apiDocGeneratorRFC8040 = new ApiDocGeneratorRFC8040(SCHEMA_SERVICE, "rests");
