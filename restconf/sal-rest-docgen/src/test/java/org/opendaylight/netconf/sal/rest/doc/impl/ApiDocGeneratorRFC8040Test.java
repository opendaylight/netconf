...
public final class ApiDocGeneratorRFC8040Test extends AbstractApiDocTest {
    ...
    public void testMandatory() {
        ...
        verifyRequiredField(definitions.get("mandatory-test_root-container_config_mandatory-container"), reqMandatoryContainer);
        verifyRequiredField(definitions.get("mandatory-test_root-container_mandatory-container"), reqMandatoryContainer);
