...
public class MountDocBenchmarkTest {
    ...
    public void before() throws Exception {
        ...
        final var mountPointRFC8040 = new MountPointSwaggerGeneratorRFC8040(mockSchemaService, mockMountPointService);
        final var apiDocGeneratorRFC8040 = new ApiDocGeneratorRFC8040(mockSchemaService);
        mountPointRFC8040.getMountPointSwagger().onMountPointCreated(INSTANCE_ID);
        final var allModulesDocGenerator = new AllModulesDocGenerator(apiDocGeneratorRFC8040);
    ...
    public void getMountDocTest() throws Exception {
        ...
        final var response = apiDocService.getMountDoc("1", mockUriInfo);
        final var mapper = new ObjectMapper();
        final var result = mapper.writer().writeValueAsString(response.getEntity());
