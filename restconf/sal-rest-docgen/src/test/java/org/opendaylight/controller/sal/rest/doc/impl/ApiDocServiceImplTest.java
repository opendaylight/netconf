...
public class ApiDocServiceImplTest {
    ...
    public void setUp() throws Exception {
        ...
        final AllModulesDocGenerator allModulesDocGenerator = new AllModulesDocGenerator(mountPointDraft02,
                mountPointRFC8040, apiDocGeneratorDraftO2, apiDocGeneratorRFC8040);
