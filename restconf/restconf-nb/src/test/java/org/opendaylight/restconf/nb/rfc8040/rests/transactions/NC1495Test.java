...
class NC1495Test {
    ...
    void testListOrderInNetconfRestconfStrategy() throws Exception {
        final var restconfStrategy = new NetconfRestconfStrategy(DATABIND, netconfService, null, null, null, null);
    ...
    void testListOrderInMdsalRestconfStrategy() throws Exception {
        final var restconfStrategy = new MdsalRestconfStrategy(DATABIND, dataBroker, ImmutableMap.of(), null, null,
            null, mountPointService);
