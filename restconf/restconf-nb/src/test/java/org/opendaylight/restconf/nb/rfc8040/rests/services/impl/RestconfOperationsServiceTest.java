...
public class RestconfOperationsServiceTest {
    ...
    public static void startUp() throws Exception {
        RUNTIME_CONTEXT = BindingRuntimeHelpers.createRuntimeContext(Module1Data.class, Module2Data.class,
            NetworkTopologyNetworkTopologyAugmentTestData.class);
        final var context = RUNTIME_CONTEXT.getEffectiveModelContext();
