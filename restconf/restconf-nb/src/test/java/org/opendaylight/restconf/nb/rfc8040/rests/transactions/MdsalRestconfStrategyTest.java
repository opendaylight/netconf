...
public final class MdsalRestconfStrategyTest extends AbstractRestconfStrategyTest {
    private static final DatabindContext MODULES_DATABIND =
        DatabindContext.ofModel(YangParserTestUtils.parseYangResourceDirectory("/modules"));
    ...
    RestconfStrategy testDeleteDataStrategy() {
        ...
        return new MdsalRestconfStrategy(JUKEBOX_DATABIND, mockDataBroker, null);
    }
    ...
    public void testPutContainerData() {
        ...
        new MdsalRestconfStrategy(JUKEBOX_DATABIND, mockDataBroker, null).putData(JUKEBOX_IID, EMPTY_JUKEBOX, null);
    ...
    public void testPutLeafData() {
        ...
        new MdsalRestconfStrategy(JUKEBOX_DATABIND, mockDataBroker, null).putData(GAP_IID, GAP_LEAF, null);
    ...
    public void testPutListData() {
        ...
        new MdsalRestconfStrategy(JUKEBOX_DATABIND, mockDataBroker, null).putData(JUKEBOX_IID, JUKEBOX_WITH_BANDS,
            null);
        verify(read).exists(LogicalDatastoreType.CONFIGURATION, JUKEBOX_IID);
    ...
    RestconfStrategy readDataConfigTestStrategy() {
        ...
        return new MdsalRestconfStrategy(mockDatabind, mockDataBroker, null);
    }
    ...
    public void readLeafWithDefaultParameters() {
        ...
        assertEquals(data, new MdsalRestconfStrategy(MODULES_DATABIND, mockDataBroker, null)
    ...
    public void readLeafInListWithDefaultParameters() {
        ...
        assertEquals(content, new MdsalRestconfStrategy(MODULES_DATABIND, mockDataBroker, null)
            .readData(ContentParam.ALL, path, WithDefaultsParam.TRIM));
    }
}
