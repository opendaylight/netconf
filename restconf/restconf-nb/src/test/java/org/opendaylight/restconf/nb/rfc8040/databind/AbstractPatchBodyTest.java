...
abstract class AbstractPatchBodyTest extends AbstractInstanceIdentifierTest {
    ...
    static final void checkPatchContext(final PatchRequest patchContext) {
        assertNotNull(patchContext.patchId());
        assertNotNull(patchContext.entities());
    }

    final @NonNull PatchRequest parse(final String uriPath, final String patchBody) throws IOException {
