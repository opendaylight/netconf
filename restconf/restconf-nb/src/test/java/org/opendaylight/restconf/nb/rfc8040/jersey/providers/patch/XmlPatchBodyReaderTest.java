    ...
    public void moduleTargetMapNodeTest() throws Exception {
        ...
        final var expectedData = Builders.mapBuilder()
                ...
                .withChild(ImmutableMapEntryNodeBuilder.create()
                        .withNodeIdentifier(YangInstanceIdentifier.NodeIdentifierWithPredicates.of(MAP, KEY, "key"))
    ...
    public void modulePatchTargetLeafSetNodeTest() throws Exception {
        ...
        final var expectedData = Builders.leafSetBuilder()
                ...
                .withChild(Builders.leafSetEntryBuilder()
                        .withNodeIdentifier(new YangInstanceIdentifier.NodeWithValue(LEAF_SET, "data1"))
                        .withValue("data1")
                        .build())
                .build();
