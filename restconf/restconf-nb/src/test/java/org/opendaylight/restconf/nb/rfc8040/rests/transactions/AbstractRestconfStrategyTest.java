...
abstract class AbstractRestconfStrategyTest extends AbstractJukeboxTest {
    ...
    public final void testPatchDataReplaceMergeAndRemove() {
        ...
        patch(new PatchRequest("patchRMRm",
            List.of(new Edit("edit1", Operation.Replace, ARTIST_IID, buildArtistList),
    ...
    public final void testPatchDataCreateAndDelete() {
        patch(new PatchRequest("patchCD", List.of(
    ...
    public final void testPatchMergePutContainer() {
        patch(new PatchRequest("patchM", List.of(new Edit("edit1", Operation.Merge, PLAYER_IID, EMPTY_JUKEBOX))),
    ...
    public final void testDeleteNonexistentData() {
        final var patchStatusContext = deleteNonexistentDataTestStrategy().patchData(new PatchRequest("patchD",
    ...
    abstract void assertTestDeleteNonexistentData(@NonNull PatchResult status);
    ...
    private static void patch(final PatchRequest patchContext, final RestconfStrategy strategy, final boolean failed) {
