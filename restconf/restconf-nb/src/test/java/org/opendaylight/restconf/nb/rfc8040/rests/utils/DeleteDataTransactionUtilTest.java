...
public class DeleteDataTransactionUtilTest {
    ...
    private void delete(final RestconfStrategy strategy) {
        final Response response = DeleteDataTransactionUtil.deleteData(strategy, YangInstanceIdentifier.of(), context);
        // assert success
    ...
    private void deleteFail(final RestconfStrategy strategy) {
        final var ex = assertThrows(RestconfDocumentedException.class,
            () -> DeleteDataTransactionUtil.deleteData(strategy, YangInstanceIdentifier.of(), context));
