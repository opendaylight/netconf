...
class IdentifierCodecTest {
    ...
    private static final String URI_WITH_LIST_AND_LEAF_STR =
        "list-test:top/list1=%2C%27" + '"' + "%3A" + '"' + "%20%2F,,foo/list2=a,b/result";
    private static final String URI_WITH_INT_VAL_LEAF_LIST_STR = "list-test:top/Y=4";
    private static final ApiPath URI_WITH_LIST_AND_LEAF;
    private static final ApiPath URI_WITH_INT_VAL_LEAF_LIST;

    static {
        try {
            URI_WITH_LIST_AND_LEAF = ApiPath.parse(URI_WITH_LIST_AND_LEAF_STR);
            URI_WITH_INT_VAL_LEAF_LIST = ApiPath.parse(URI_WITH_INT_VAL_LEAF_LIST_STR);
    ...
    void codecListAndLeafTest() {
        ...
        assertEquals(URI_WITH_LIST_AND_LEAF_STR, IdentifierCodec.serialize(dataYangII, MODEL_CONTEXT));
    }
    ...
    void codecLeafListTest() {
        ...
        assertEquals(URI_WITH_INT_VAL_LEAF_LIST_STR, IdentifierCodec.serialize(dataYangII, MODEL_CONTEXT));
    }
