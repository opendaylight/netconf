...
class RestconfModulesGetTest extends AbstractRestconfTest {
    ...
    void toSchemaExportContextFromIdentifierNotFoundTest() {
        ...
        assertEquals("Source not-existing-module@2016-01-01 not found", error.message());
    ...
    void validateAndGetRevisionNotParsableTest() {
        ...
        assertEquals("Supplied revision is not in expected date format YYYY-mm-dd", error.message());
    }
    ...
    void validateAndGetModulNameNotSuppliedTest() {
        ...
        assertEquals("Module name must be supplied", error.message());
    }
    ...
    public void validateAndGetModuleNameNotParsableNextTest() {
        ...
        assertEquals("Supplied name has not expected identifier format", error.message());
    }
