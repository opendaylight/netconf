...
public class XmlResourceBodyTest extends AbstractResourceBodyTest {
    ...
    public void emptyPathTest() {
        assertThrowsException("",
            "Instance identifier has to contain at least one path argument");
    ...
    public void wrongRootElementTest() {
        assertThrowsException("instance-identifier-module:cont",
            "Not correct message root element \"cont1\", should be "
                + "\"(instance:identifier:module?revision=2014-01-17)cont\"");
