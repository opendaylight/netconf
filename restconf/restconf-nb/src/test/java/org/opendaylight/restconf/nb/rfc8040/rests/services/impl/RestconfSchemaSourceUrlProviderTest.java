...
import static org.opendaylight.restconf.nb.rfc8040.rests.services.impl.RestconfSchemaSourceUrlProvider.SUPPORTED_MODULE_SET_NAME;
...
class RestconfSchemaSourceUrlProviderTest {
    ...
    void getSchemaSourceUrl(final String moduleName, final Revision revision, final Uri expected) {
        final var urlProvider = new RestconfSchemaSourceUrlProvider();
        final var result = urlProvider.getSchemaSourceUrl(SUPPORTED_MODULE_SET_NAME, moduleName, revision);
    ...
    private static Stream<Arguments> getSchemaSourceUrlArgs() {
        return Stream.of(
            // module-name, revision, expected result
            Arguments.of("odl-module", Revision.of("2023-02-23"), new Uri("/rests/modules/odl-module/2023-02-23")),
