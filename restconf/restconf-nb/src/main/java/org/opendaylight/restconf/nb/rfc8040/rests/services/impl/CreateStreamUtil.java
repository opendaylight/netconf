...
final class CreateStreamUtil {
    ...
    // FIXME: this really should be a normal RPC implementation
    static DOMRpcResult createNotificationStream(final ContainerNode input, final EffectiveModelContext refSchemaCtx) {
        ...
        // registration of the listener
        ListenersBroker.getInstance().registerNotificationListener(qnames, null, outputType);
