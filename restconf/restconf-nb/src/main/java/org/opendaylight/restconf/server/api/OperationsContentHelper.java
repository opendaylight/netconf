...
/**
 * Workaround for problems with invoking interface-private static methods in inner record classes:
 * - Eclipse tries to import static such references, hence we need to prefix each use
 * - When we do, SpotBugs ends up reporting UPM_UNCALLED_PRIVATE_METHOD
 */
