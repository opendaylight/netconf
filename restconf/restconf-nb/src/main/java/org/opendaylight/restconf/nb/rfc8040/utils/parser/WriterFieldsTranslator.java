...
public final class WriterFieldsTranslator {
     ...
     */
    public static @NonNull List<Set<QName>> translate(final @NonNull ResourceMode reqPath,
            final @NonNull FieldsParam input) {
        final var startNode = DataSchemaContext.of((DataSchemaNode) identifier.getSchemaNode());
        if (startNode == null) {
