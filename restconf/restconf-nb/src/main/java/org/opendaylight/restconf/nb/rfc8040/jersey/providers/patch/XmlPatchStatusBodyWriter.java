...
public class XmlPatchStatusBodyWriter extends AbstractPatchStatusBodyWriter {
    ...
    @Override
    public void writeTo(final PatchStatus patchStatusContext, final Class<?> type, final Type genericType,
    ...
    private static void writeDocument(final XMLStreamWriter writer, final PatchStatus context)
