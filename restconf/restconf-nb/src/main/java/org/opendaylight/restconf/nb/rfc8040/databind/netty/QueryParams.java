...
public final class QueryParams {
    ...
    /**
     * Normalize query parameters from an {@link QueryStringDecoder}.
     *
     * @param decoder An {@link QueryStringDecoder}
     ...
     */
    public static @NonNull ImmutableMap<String, String> normalize(final QueryStringDecoder decoder) {
        final var builder = ImmutableMap.<String, String>builder();
        for (var entry : decoder.parameters().entrySet()) {
     ...
     *
     * @param decoder {@link QueryStringDecoder}
     * @return {@link DataGetParams}
     */
    public static @NonNull DataGetParams newDataGetParams(final QueryStringDecoder decoder) {
