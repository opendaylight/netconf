    ...
    public JaxRsNorthbound(final WebServer webServer, final WebContextSecurer webContextSecurer,
        ...
        final var restconfBuilder = WebContext.builder()
            ...
            .addServlet(ServletDetails.builder()
                ...
                .servlet(servletSupport.createHttpServletBuilder(
                    new RestconfApplication(databindProvider, mountPointService, dataBroker, rpcService, actionService,
                        notificationService, schemaService, streamsConfiguration, listenersBroker))
                    .build())
                .asyncSupported(true)
                .build())
            .addServlet(ServletDetails.builder()
                ...
                .servlet(servletSupport.createHttpServletBuilder(
                    new DataStreamApplication(databindProvider,
                        new RestconfDataStreamServiceImpl(scheduledThreadPool, streamsConfiguration, listenersBroker)))
                    .build())
            ...
            .addServlet(ServletDetails.builder()
                ...
                .servlet(new WebSocketInitializer(scheduledThreadPool, streamsConfiguration, listenersBroker))
                .build())
