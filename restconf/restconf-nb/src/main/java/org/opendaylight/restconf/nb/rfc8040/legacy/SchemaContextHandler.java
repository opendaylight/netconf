...
import static org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.yang.library.rev190104.module.list.Module.QNAME;
...
public final class SchemaContextHandler implements EffectiveModelContextListener, AutoCloseable {
    ...
    public static final QName MODULE_QNAME_LIST = QNAME;
