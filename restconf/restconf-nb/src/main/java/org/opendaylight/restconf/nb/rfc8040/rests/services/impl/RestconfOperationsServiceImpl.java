...
public class RestconfOperationsServiceImpl implements RestconfOperationsService {
    ...
    private static Map.Entry<InstanceIdentifierContext, ContainerNode> contextForModelContext(
        ...
        final DataContainerNodeBuilder<YangInstanceIdentifier.NodeIdentifier, ContainerNode> operationsBuilder =
                Builders.containerBuilder()
                .withNodeIdentifier(new YangInstanceIdentifier.NodeIdentifier(OperationsContainerSchemaNode.QNAME));
