...
@NonNullByDefault
final class DataPostServerRequest extends JaxRsServerRequest<DataPostResult> {
    private static final Logger LOG = LoggerFactory.getLogger(DataPostServerRequest.class);

    DataPostServerRequest(final PrettyPrintParam defaultPrettyPrint, final UriInfo uriInfo, final AsyncResponse ar) {
