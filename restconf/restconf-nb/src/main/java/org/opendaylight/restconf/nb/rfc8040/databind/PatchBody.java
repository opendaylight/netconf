...
public abstract sealed class PatchBody extends AbstractBody permits JsonPatchBody, XmlPatchBody {
    ...
    public final @NonNull Patch toPatchContext(final @NonNull InstanceIdentifierContext targetResource)
            throws IOException {
    ...
    abstract @NonNull Patch toPatchContext(@NonNull InstanceIdentifierContext targetResource,
