...
public abstract sealed class OperationsGetBody extends FormattableBody {
    private static final class Leaf extends OperationsGetBody {
        private final QName rpc;

        Leaf(final EffectiveModelContext modelContext, final QName rpc) {
            super(modelContext);
    ...
    private static final class Container extends OperationsGetBody {
        private final ImmutableSetMultimap<QNameModule, QName> rpcs;

        Container(final EffectiveModelContext modelContext, final ImmutableSetMultimap<QNameModule, QName> rpcs) {
            super(modelContext);
    ...
    public static @NonNull FormattableBody of(final EffectiveModelContext modelContext) {
        ...
        return new Container(modelContext, rpcs.build());
    }

    public static @NonNull FormattableBody of(final DatabindPath.Rpc path) {
        return new Leaf(path.inference().modelContext(), path.rpc().argument());
    }
