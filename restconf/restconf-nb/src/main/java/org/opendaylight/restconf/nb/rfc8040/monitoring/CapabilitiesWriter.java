...
public final class CapabilitiesWriter
    ...
    private static final NodeIdentifier CAPABILITIES = NodeIdentifier.create(Capabilities.QNAME);
    private static final YangInstanceIdentifier PATH = YangInstanceIdentifier.create(
        NodeIdentifier.create(RestconfState.QNAME), CAPABILITIES);
    @VisibleForTesting
    ...
    @Inject
    @Activate
    public CapabilitiesWriter(final DOMDataBroker dataBroker, final DOMSchemaService schemaService) {
    ...
    static ContainerNode mapCapabilites() {
        return Builders.containerBuilder()
            .withNodeIdentifier(CAPABILITIES)
