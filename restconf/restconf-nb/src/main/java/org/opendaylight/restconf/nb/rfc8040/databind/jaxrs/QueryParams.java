...
public final class QueryParams {
    ...
    public static QueryParameters newQueryParameters(final ResourceMode reqPath, final ReadDataParams params) {
        final var fields = params.fields();
        if (fields == null) {
            return QueryParameters.of(params);
        }

        return reqPath.mountPoint() != null
            ? QueryParameters.ofFieldPaths(params, NetconfFieldsTranslator.translate(reqPath, fields))
                : QueryParameters.ofFields(params, WriterFieldsTranslator.translate(reqPath, fields));
    }
