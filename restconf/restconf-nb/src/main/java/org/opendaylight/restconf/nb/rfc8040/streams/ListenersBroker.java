...
@Singleton
@Component(factory = ListenersBroker.FACTORY_NAME)
public final class ListenersBroker implements RestconfStreamRegistry {
    ...
    public ListenersBroker(final DOMDataBroker dataBroker, final boolean useWebsockets) {
        this.dataBroker = requireNonNull(dataBroker);
        this.useWebsockets = useWebsockets;
    }

    @Inject
    public ListenersBroker(final DOMDataBroker dataBroker) {
        this(dataBroker, false);
    }

    @Activate
    public ListenersBroker(@Reference final DOMDataBroker dataBroker, final Map<String, ?> props) {
