 ...
 */
@NonNullByDefault
record TextParameters(boolean leafNodesOnly, boolean skipData, boolean changedLeafNodesOnly) {
    static final TextParameters EMPTY = new TextParameters(false, false, false);
}