...
public class RestconfDataServiceImpl implements RestconfDataService {
    ...
    public RestconfDataServiceImpl(final DatabindContextProvider databindContextProvider,
    ...
    public Response readData(final String identifier, final UriInfo uriInfo) {
        ...
        final EffectiveModelContext schemaContextRef = databindContextProvider.currentDatabindContext().modelContext();
        ...
        default -> Response.status(Status.OK)
                            .entity(NormalizedNodePayload.ofReadData(instanceIdentifier, node, queryParams))
                            .build();
        };
    }
