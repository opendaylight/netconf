...
public final class RestconfDataServiceImpl {
    ...
    public PatchStatus yangPatchDataXML(@Encoded @PathParam("identifier") final String identifier,
    ...
    public PatchStatus yangPatchDataXML(final InputStream body) {
        try (var xmlBody = new XmlPatchBody(body)) {
    ...
    public PatchStatus yangPatchDataJSON(@Encoded @PathParam("identifier") final String identifier,
            final InputStream body) {
    ...
    public PatchStatus yangPatchDataJSON(final InputStream body) {
        try (var jsonBody = new JsonPatchBody(body)) {
            return yangPatchData(jsonBody);
        }
    }

    private PatchStatus yangPatchData(final @NonNull PatchBody body) {
        return yangPatchData(InstanceIdentifierContext.ofLocalRoot(databindProvider.currentContext().modelContext()),
            body);
    }

    private PatchStatus yangPatchData(final String identifier, final @NonNull PatchBody body) {
    ...
    private PatchStatus yangPatchData(final @NonNull InstanceIdentifierContext targetResource,
    ...
    @VisibleForTesting
    PatchStatus yangPatchData(final InstanceIdentifierContext targetResource, final Patch context) {
