...
//    }
    ...
    public Response readDataRoot(final UriInfo uriInfo) {
        ...
        final var operations = operationsService.getOperations("network-topology:network-topology/topology=topology-netconf/node=17830-sim-device/yang-ext:mount", uriInfo);
