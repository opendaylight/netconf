...
//    }
    ...
    public Response readDataRoot(final UriInfo uriInfo) {
        ...
        final var operations = operationsService.getOperationsJSON();
        final var data = ((NormalizedNodePayload) dataService.readData(uriInfo).getEntity()).getData();
        ...
        final var result = Builders.containerBuilder()
                ...
                .withChild(Builders.containerBuilder()
                        ...
                        .withChild((DataContainerChild) data)
                        .build())
                .withChild(Builders.containerBuilder()
                        .withNodeIdentifier(YangInstanceIdentifier.NodeIdentifier.create(Operations.QNAME))
//                        .addChild(ImmutableNodes.leafNode(Operations.QNAME, operations))
                        .build())
