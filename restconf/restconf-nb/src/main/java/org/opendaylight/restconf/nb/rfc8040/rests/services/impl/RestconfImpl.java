...
public class RestconfImpl implements RestconfService {
    ...
    public RestconfImpl(final DatabindContextProvider databindContextProvider) {
        this.databindContextProvider = requireNonNull(databindContextProvider);
    }

    @Override
    public NormalizedNodePayload getLibraryVersion() {
        final EffectiveModelContext context = databindContextProvider.currentDatabindContext().modelContext();
