...
public final class JaxRsRestconf implements ParamConverterProvider {
    ...
    @NonNullByDefault
    private ServerRequest<DataGetResult> newDataGet(final UriInfo uriInfo, final AsyncResponse ar) {
    ...
    @NonNullByDefault
    private ServerRequest<DataPatchResult> newDataPATCH(final AsyncResponse ar) {
    ...
    @NonNullByDefault
    private ServerRequest<DataYangPatchResult> newDataYangPATCH(final UriInfo uriInfo, final AsyncResponse ar) {
        return new JaxRsServerRequest<>(prettyPrint, ar, uriInfo) {
            @Override
    ...
    @NonNullByDefault
    private <T extends DataPostResult> ServerRequest<T> newDataPOST(final UriInfo uriInfo, final AsyncResponse ar) {
        return new JaxRsServerRequest<>(prettyPrint, ar, uriInfo) {
            @Override
    ...
    @NonNullByDefault
    private ServerRequest<DataPutResult> newDataPUT(final UriInfo uriInfo, final AsyncResponse ar) {
        return new JaxRsServerRequest<>(prettyPrint, ar, uriInfo) {
            @Override
    ...
    @NonNullByDefault
    private ServerRequest<ModulesGetResult> newModulesGET(final AsyncResponse ar) {
        return new JaxRsServerRequest<>(prettyPrint, ar) {
            @Override
