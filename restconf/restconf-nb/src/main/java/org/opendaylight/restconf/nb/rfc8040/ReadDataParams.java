 ...
 */
@Beta
public record ReadDataParams(@NonNull ContentParam content, DepthParam depth, FieldsParam fields, WithDefaultsParam withDefaults,
        boolean tagged, PrettyPrintParam prettyPrint) implements Immutable {
