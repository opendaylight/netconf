...
public abstract class InstanceIdentifierContext {
    ...
    public static @NonNull InstanceIdentifierContext ofLocalRoot(final DatabindContext context) {
        return new Root(context, null);
    }

    @VisibleForTesting
    public static @NonNull InstanceIdentifierContext ofLocalPath(final DatabindContext context,
    ...
    public static @NonNull InstanceIdentifierContext ofMountPointPath(final DOMMountPoint mountPoint,
            final DatabindContext databind, final YangInstanceIdentifier path) {
