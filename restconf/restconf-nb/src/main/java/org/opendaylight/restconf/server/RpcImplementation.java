...
public abstract class RpcImplementation {
    /**
     * Input of {@link RpcImplementation#invoke(String, RpcInput)}.
     */
    ...
    /**
     * Output of {@link RpcImplementation#invoke(String, RpcInput)}.
     */
     ...
     */
    public abstract RestconfFuture<RpcOutput> invoke(String restconfUri, RpcInput input);
