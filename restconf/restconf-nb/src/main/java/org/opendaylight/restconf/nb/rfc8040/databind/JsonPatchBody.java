...
public final class JsonPatchBody extends PatchBody {
    ...
    PatchRequest toPatchContext(final InstanceIdentifierContext targetResource, final InputStream inputStream)
        ...
        try (var jsonReader = new JsonReader(new InputStreamReader(inputStream, StandardCharsets.UTF_8))) {
            ...
            final var entities = read(jsonReader, targetResource, patchId);
            // Note: sequencing
            return new PatchRequest(patchId.get(), entities);
        }
    }

    private static ImmutableList<PatchEdit> read(final JsonReader in, final InstanceIdentifierContext path,
        ...
        final var edits = ImmutableList.<PatchEdit>builder();
    ...
    private static void parseByName(final @NonNull String name, final @NonNull PatchEdit edit,
            ...
            final ImmutableList.@NonNull Builder<PatchEdit> resultCollection,
