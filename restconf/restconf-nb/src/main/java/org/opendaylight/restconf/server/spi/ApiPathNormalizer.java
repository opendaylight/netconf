...
public final class ApiPathNormalizer implements PointNormalizer {
    ...
    public @NonNull ApiPath canonicalize(final YangInstanceIdentifier path) {
        ...
        do {
            ...
            if (arg instanceof NodeIdentifier) {
                ...
                step = canonicalize(prefix, nodeType.getLocalName(), withValue.getValue());
            } else if (arg instanceof NodeIdentifierWithPredicates withPredicates) {
                step = canonicalize(prefix, withPredicates);
            } else {
    ...
    private @NonNull ListInstance canonicalize(final String prefix, final NodeIdentifierWithPredicates pathArg) {
        throw new UnsupportedOperationException();
    }

    private @NonNull ListInstance canonicalize(final String prefix, final String localName, final Object value) {
        return new ListInstance(prefix, localName, ImmutableList.of(encodeValue(null, null, value)));
    }
