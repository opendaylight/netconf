 ...
 */
public record MdsalServerRpcOperations(@NonNull DOMRpcService rpcService) implements ServerRpcOperations {
    private static final Logger LOG = LoggerFactory.getLogger(MdsalServerRpcOperations.class);

    public MdsalServerRpcOperations {
