...
enum OperationsContent {
    ...
    public final @NonNull String bodyFor(final @Nullable EffectiveModelContext context, final String identifier) {
        if (!isValidContext(context)) {
            // No modules, or defensive return empty content
            return emptyBody;
        }
    ...
    private boolean isValidContext(final EffectiveModelContext context) {
        if (context == null) {
            return false;
        }
