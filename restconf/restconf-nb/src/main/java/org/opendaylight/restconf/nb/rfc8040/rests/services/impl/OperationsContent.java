...
enum OperationsContent {
    ...
    public final @NonNull String bodyFor(final @Nullable EffectiveModelContext context, String identifier) {
        ...
        final var moduleRpcs = getModuleRpcs(context, modules);
        List<Entry<@NonNull String, List<String>>> filteredModuleRpcs = moduleRpcs.stream()
    ...
    private List<Entry<@NonNull String, List<String>>> getModuleRpcs(EffectiveModelContext context,
            Map<QNameModule, ModuleEffectiveStatement> modules) {
