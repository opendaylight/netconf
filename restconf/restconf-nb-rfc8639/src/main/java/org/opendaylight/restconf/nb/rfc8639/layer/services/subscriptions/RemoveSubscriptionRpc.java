...
public final class RemoveSubscriptionRpc implements DOMRpcImplementation {
    ...
    public RemoveSubscriptionRpc(final SubscriptionsHolder subscriptionsHolder,
            final ListeningExecutorService executorService, final boolean isKill) {
