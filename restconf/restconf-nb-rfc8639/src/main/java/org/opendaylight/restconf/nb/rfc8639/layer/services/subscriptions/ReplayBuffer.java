...
public class ReplayBuffer {
    ...
    private final NavigableMap<Instant, DOMNotification> timeStampToNotification = new TreeMap<>();
    ...
    public ReplayBuffer(final TransactionChainHandler transactionChainHandler, final SchemaContext schemaContext,
            final long replayBufferMaxSize) {
