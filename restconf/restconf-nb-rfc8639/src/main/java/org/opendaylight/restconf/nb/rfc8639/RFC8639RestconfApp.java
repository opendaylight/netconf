...
public class RFC8639RestconfApp extends Application {
    ...
    public void init() {
        ...
        final OnEffectiveModelContextChangeNotificationTracker onEffectiveModelContextChangeNotificationTracker =
                new OnEffectiveModelContextChangeNotificationTracker(domNotificationService, transactionChainHandler,
                        replayBuffersForNotifications, new InetSocketAddress(8181), 20000);
