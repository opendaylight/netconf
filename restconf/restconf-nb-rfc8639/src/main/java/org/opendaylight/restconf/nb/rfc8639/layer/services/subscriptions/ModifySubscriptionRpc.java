...
public final class ModifySubscriptionRpc implements DOMRpcImplementation {
    ...
    public ModifySubscriptionRpc(final NotificationsHolder notificationsHolder, final DOMSchemaService domSchemaService,
            final TransactionChainHandler transactionChainHandler, final ListeningExecutorService executorService) {
        this.notificationsHolder = requireNonNull(notificationsHolder);
