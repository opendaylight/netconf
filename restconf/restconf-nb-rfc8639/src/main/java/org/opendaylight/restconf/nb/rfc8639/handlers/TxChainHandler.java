...
/**
 * Implementation of {@link TxChainHandler}.
 */
public class TxChainHandler implements Handler<DOMTransactionChain>, AutoCloseable {
    private static final Logger LOG = LoggerFactory.getLogger(TxChainHandler.class);
     ...
     */
    public TxChainHandler(final DOMDataBroker dataBroker) {
    ...
    /**
     * Verify if {@link DOMTransactionChain} exist in {@link TxChainHandler} queue.
     * @param transactionChain object to check.
     * @return true if object still exist in {@link TxChainHandler}.
     */
