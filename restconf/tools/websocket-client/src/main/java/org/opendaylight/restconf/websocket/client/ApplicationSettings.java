...
final class ApplicationSettings {
    ...
    static {
        ...
        PARSER.addArgument("-u")
                .dest("username")
                .help("User name used with basic authentication that can be required on upgrade-request.")
                .metavar("USERNAME")
                .type(String.class);
        PARSER.addArgument("-p")
                .dest("password")
                .help("Password used with basic authentication that can be required on upgrade-request.")
                .metavar("PASSWORD")
                .type(String.class);
    }
    ...
    private void verifyParsedArguments() {
        ...
        Preconditions.checkArgument((username == null && password == null) || (username != null
                && password != null), "Both basic authentication username and password must be specified at once.");
    }
