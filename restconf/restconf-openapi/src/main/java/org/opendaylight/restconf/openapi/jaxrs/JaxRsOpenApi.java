...
public final class JaxRsOpenApi {
    ...
    public Response getAllModulesDoc(@Context
    final UriInfo uriInfo, @QueryParam("width")
    final Integer width,
            @QueryParam("depth")
            final Integer depth, @QueryParam("offset")
    ...
    @Path("/single/meta")
    @Produces(MediaType.APPLICATION_JSON)
    public Response getAllModulesMeta(@QueryParam("offset")
    final Integer offset, @QueryParam("limit")
    final Integer limit)
            throws IOException {
    ...
    @Path("/{module}")
    @Produces(MediaType.APPLICATION_JSON)
    public Response getDocByModule(@PathParam("module")
    final String module, @QueryParam("revision")
    final String revision,
            @Context
            final UriInfo uriInfo, @QueryParam("width")
            final Integer width, @QueryParam("depth")
            final Integer depth)
            throws IOException {
    ...
    public Response getApiExplorer(@Context
    ...
    @Path("/mounts")
    @Produces(MediaType.APPLICATION_JSON)
    public Response getListOfMounts(@Context
    final UriInfo uriInfo) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response getMountDocByModule(@PathParam("instance")
    final long instanceNum, @PathParam("module")
    final String module,
            @QueryParam("revision")
            final String revision, @Context
            final UriInfo uriInfo, @QueryParam("width")
            final Integer width,
            @QueryParam("depth")
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response getMountDoc(@PathParam("instance")
    final long instanceNum, @Context
    final UriInfo uriInfo,
            @QueryParam("width")
            final Integer width, @QueryParam("depth")
            final Integer depth,
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response getMountMeta(@PathParam("instance")
    final long instanceNum, @QueryParam("offset")
    final Integer offset,
            @QueryParam("limit")
            final Integer limit) throws IOException {
