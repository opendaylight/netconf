...
public final class OpenApiInputStream extends InputStream {
    ...
    public OpenApiInputStream(final EffectiveModelContext context, final String openApiVersion, final Info info,
            final List<Server> servers, final List<Map<String, List<String>>> security, final boolean isForSingleModule,
            final String deviceName, final String urlPrefix, final boolean includeDataStore) throws IOException {
        ...
        stack.add(new PathsStream(context, writer, generator, stream, isForSingleModule, deviceName, urlPrefix,
            includeDataStore));
