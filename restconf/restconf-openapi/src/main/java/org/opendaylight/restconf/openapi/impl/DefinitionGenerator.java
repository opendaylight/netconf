...
public final class DefinitionGenerator {
    ...
    private static ArrayList<HashMap<String, Object>> createExamples(ListSchemaNode node) {
        ...
        for (int i = 0; i < minElements; i++) {
            ...
            while (it.hasNext()) {
                ...
                if (schema instanceof TypedDataSchemaNode leafSchemaNode) {
                    ...
                    // if schema is key of list, edit example to not contain duplicate values, add value of i to number
                    // types and "_i" to string
                    if (key.contains(name)) {
                        if (exampleValue instanceof String string) {
                            ...
                            exampleValue = number + i;
                        } else if (exampleValue instanceof Double number) {
                            exampleValue = number + i;
                        }
                    }
