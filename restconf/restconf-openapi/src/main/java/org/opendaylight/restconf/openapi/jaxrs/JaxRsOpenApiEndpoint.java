...
@Component(service = JaxRsOpenApiEndpoint.class)
@Provider
@Path("/")
public final class JaxRsOpenApiEndpoint {
    private final OpenApiServiceImpl openApiService;


    @Activate
    public JaxRsOpenApiEndpoint(@Reference OpenApiServiceImpl openApiService) {
