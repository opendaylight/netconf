...
public record Operation(boolean deprecated, ArrayNode tags, ArrayNode parameters, ArrayNode security, ArrayNode servers,
    ...
    public static class Builder {
        ...
        public Builder tags(ArrayNode tags) {
            this.tags = tags;
            return this;
        }

        public Builder parameters(ArrayNode parameters) {
            this.parameters = parameters;
            return this;
        }

        public Builder security(ArrayNode security) {
            this.security = security;
            return this;
        }

        public Builder servers(ArrayNode servers) {
            this.servers = servers;
            return this;
        }

        public Builder callbacks(ObjectNode callbacks) {
            this.callbacks = callbacks;
            return this;
        }

        public Builder externalDocs(ObjectNode externalDocs) {
            this.externalDocs = externalDocs;
            return this;
        }

        public Builder requestBody(ObjectNode requestBody) {
            this.requestBody = requestBody;
            return this;
        }

        public Builder responses(ObjectNode responses) {
