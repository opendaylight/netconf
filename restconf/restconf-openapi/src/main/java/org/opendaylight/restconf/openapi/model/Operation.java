...
public record Operation(boolean deprecated, ArrayNode tags, ArrayNode parameters, List<Map<String, List<?>>> security,
    ...
    public static class Builder {
        ...
        public Builder security(final List<Map<String, List<?>>> security) {
