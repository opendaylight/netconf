 ...
 */
@Component(service = OpenApiServiceImpl.class)
@Singleton
public final class OpenApiServiceImpl implements OpenApiService {
    ...
    @Override
    public OpenApiInputStream getAllModulesDoc(final URI uri, final @Nullable Integer width,
            final @Nullable Integer depth, final @Nullable Integer offset, final @Nullable Integer limit)
            throws IOException {
        return openApiGeneratorRFC8040.getControllerModulesDoc(uri,
     ...
     */
    @Override
    public OpenApiInputStream getDocByModule(final String module, final String revision, final URI uri,
            final @Nullable Integer width, final @Nullable Integer depth) throws IOException {
        return openApiGeneratorRFC8040.getApiDeclaration(module, revision, uri,
     ...
     */
    @Override
    public URI getApiExplorer() throws URISyntaxException {
    ...
    @Override
    public OpenApiInputStream getMountDoc(final String instanceNum, final URI uri, final @Nullable Integer width,
            final @Nullable Integer depth, final @Nullable Integer offset, final @Nullable Integer limit)
            throws IOException {
    ...
    public MetadataStream getMountMeta(final String instanceNum, final @Nullable Integer offset,
        ...
        return mountPointOpenApiRFC8040.getMountPointApiMeta(Long.parseLong(instanceNum),
