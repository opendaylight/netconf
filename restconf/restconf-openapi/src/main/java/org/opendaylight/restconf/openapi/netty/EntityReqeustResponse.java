...
@NonNullByDefault
final class EntityReqeustResponse extends ByteStreamRequestResponse {
    private static final JsonFactory FACTORY = JsonFactory.builder().build();

    private final OpenApiEntity entity;

    EntityReqeustResponse(final OpenApiEntity entity) {
    ...
    protected void writeBody(final OutputStream out) throws IOException {
        entity.generate(FACTORY.createGenerator(out));
    }
}
