...
public final class PaginationService {
     ...
     */
    public PaginationService(final @NonNull Set<Module> modulesWithoutDuplications, final @NonNull Integer offset,
     ...
     * @param modulesWithoutDuplications The set of modules without duplications.
     */
    public PaginationService(final @NonNull Set<Module> modulesWithoutDuplications) {
        metadata = new HashMap<>();
        this.modules = getAllModules(modulesWithoutDuplications, metadata);
    }

    private static Collection<? extends Module> getPortionOfModels(final Set<Module> modulesWithoutDuplications,
    ...
    private static Collection<? extends Module> getAllModules(final Set<Module> modulesWithoutDuplications,
