...
public final class OpenApiNettyEndpoint {
    ...
    @Activate
    public OpenApiNettyEndpoint(@Reference final PrincipalService principalService,
            @Reference OpenApiService openApiService, final Configuration config) {
        ...
        final var dispatcher =
            new OpenApiRequestDispatcher(principalService, openApiService, baseUri, restconfServerUri);
        try {
            ...
            LOG.info("RESTCONF OpenApi server started at {}", config.bind$_$port());
