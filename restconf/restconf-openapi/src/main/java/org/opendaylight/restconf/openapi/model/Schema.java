...
public record Schema(
    ...
    private Schema(final Builder builder) {
        this(builder.schemaEnum != null ? List.copyOf(builder.schemaEnum) : null,
            builder.required != null ? List.copyOf(builder.required) : null,
            builder.discriminator, builder.examples, builder.externalDocs,
            builder.properties != null ? Map.copyOf(builder.properties) : null, builder.xml, builder.description,
            builder.ref, builder.title, builder.type);
    }
