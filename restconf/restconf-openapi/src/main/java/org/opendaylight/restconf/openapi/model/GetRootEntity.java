...
public final class GetRootEntity extends GetEntity {
    ...
    public void generate(final @NonNull JsonGenerator generator) throws IOException {
        ...
        if (type.equals(DATA)) {
            ...
            generator.writeEndObject(); // end of ietf-netconf-monitoring:netconf-state
        }
        ...
        if (type.equals(DATA)) {
            ...
            generator.writeStringField(NAME, "netconf-state");
            generator.writeStringField("namespace", "urn:ietf:params:xml:ns:yang:ietf-netconf-monitoring");
