...
public final class PathsStream extends InputStream {
    ...
    public int read() throws IOException {
        if (reader == null) {
            reader = new BufferedReader(
                new InputStreamReader(new ByteArrayInputStream(writeNextEntity(new PathsEntity(toPaths(modules)))),
    ...
    private Deque<PathEntity> toPaths(final Collection<? extends Module> modules) {
