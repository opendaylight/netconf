...
public class MountPointOpenApi implements DOMMountPointListener, AutoCloseable {
    ...
    private final Map<YangInstanceIdentifier, Long> instanceIdToLongId = new ConcurrentHashMap<>(
            new TreeMap<>((o1, o2) -> o1.toString().compareToIgnoreCase(o2.toString())));
    private final Map<Long, YangInstanceIdentifier> longIdToInstanceId = new ConcurrentHashMap<>(new HashMap<>());
