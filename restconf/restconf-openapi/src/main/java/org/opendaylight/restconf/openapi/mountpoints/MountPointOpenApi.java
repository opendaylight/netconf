...
public class MountPointOpenApi implements DOMMountPointListener, AutoCloseable {
    ...
    public OpenApiInputStream getMountPointApi(final URI uri, final Long id, final String module,
    ...
    public OpenApiInputStream getMountPointApi(final URI uri, final Long id, final int width,
    ...
    private OpenApiInputStream generateDataStoreOpenApi(final EffectiveModelContext modelContext,
            final URI uri, final String urlPrefix, final String deviceName, final int width,
