...
final class OpenApiResourceInstance extends WebHostResourceInstance {
    ...
    private static final HeadersResponse OPTIONS_ONLY_METHOD_NOT_ALLOWED =
        HeadersResponse.ofTrusted(HttpResponseStatus.METHOD_NOT_ALLOWED,
    ...
    private static final HeadersResponse JSON_OK = HeadersResponse.ofTrusted(HttpResponseStatus.OK,
    ...
    private Response api(final ImplementedMethod method, final URI targetUri, final SegmentPeeler peeler,
        ...
        return switch (next) {
            ...
            case "ui" -> HeadersResponse.ofTrusted(HttpResponseStatus.SEE_OTHER,
