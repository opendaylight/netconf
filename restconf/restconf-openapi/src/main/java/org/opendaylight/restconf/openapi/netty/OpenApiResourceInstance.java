...
final class OpenApiResourceInstance extends WebHostResourceInstance {
    ...
    private Response apiModule(final URI targetUri, final String module, final boolean withContent,
        ...
        try {
            entity = service.getDocByModule(module, revision, targetUri, width, depth, basePath, forwardedHeader,
    ...
    private Response apiMount(final URI targetUri, final long instance, final boolean withContent,
        ...
        final DocumentEntity entity;
        try {
            entity = service.getMountDoc(instance, targetUri, width, depth, offset, limit, basePath, forwardedHeader,
                forwardedProtoHeader);
        } catch (IOException e) {
            return new ExceptionRequestResponse(e);
        }
    ...
    private Response single(final URI targetUri, final boolean withContent, final HttpHeaders headers) {
        ...
        final DocumentEntity entity;
        try {
            entity = service.getAllModulesDoc(targetUri, width, depth, offset, limit, basePath, forwardedHeader,
                forwardedProtoHeader);
        } catch (IOException e) {
            return new ExceptionRequestResponse(e);
        }
