...
final class OpenApiResourceInstance extends WebHostResourceInstance {
    ...
    private RequestResponse prepareMountsInstance(final ImplementedMethod method, final URI targetUri,
        ...
        return peeler.hasNext() ? EmptyRequestResponse.NOT_FOUND : switch (next) {
            case "meta" -> prepareMountsInstanceMeta(targetUri, headers, restconf, instance);
            default -> prepareMountsInstanceModule(targetUri, headers, restconf, instance, next);
        };
    }
    ...
    private RequestResponse prepareMountsInstanceMeta(final URI targetUri, final HttpHeaders headers,
            final Link restconf, final long instance) {

    }

    private RequestResponse prepareMountsInstanceModule(final URI targetUri, final HttpHeaders headers,
            final Link restconf, final long instance, final String module) {
