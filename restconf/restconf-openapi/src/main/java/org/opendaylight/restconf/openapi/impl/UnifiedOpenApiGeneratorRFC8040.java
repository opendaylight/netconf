...
public class UnifiedOpenApiGeneratorRFC8040 extends BaseYangOpenApiGeneratorRFC8040 implements AutoCloseable {

    private final MountPointOpenApi mountPointOpenApi;

    public UnifiedOpenApiGeneratorRFC8040(final @NonNull DOMSchemaService schemaService,
        final DOMMountPointService mountService, final @NonNull String basePath) {
