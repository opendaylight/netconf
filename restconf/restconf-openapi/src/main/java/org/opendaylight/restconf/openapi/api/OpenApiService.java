...
public interface OpenApiService {
    ...
    InputStream getAllModulesDoc(URI uri,Integer width, Integer depth, Integer offset, Integer limit)
        throws IOException;
     ...
     * @throws IOException When I/O error occurs.
     */
    InputStream getAllModulesMeta(Integer offset, Integer limit) throws IOException;

    /**
     * Generates Swagger compliant document listing APIs for module.
     */
    InputStream getDocByModule(String module, String revision, URI uri, Integer width, Integer depth)
        throws IOException;
     ...
     */
    List<MountPointInstance> getListOfMounts();
     ...
     * @throws IOException When I/O error occurs.
     */
    InputStream getMountDocByModule(String instanceNum,
        String module, String revision, URI uri, Integer width, Integer depth) throws IOException;
     ...
     * @throws IOException When I/O error occurs.
     */
    InputStream getMountDoc(String instanceNum, URI uri, Integer width, Integer depth, Integer offset,
     ...
     * @throws IOException When I/O error occurs.
     */
    InputStream getMountMeta(String instanceNum, Integer offset, Integer limit) throws IOException;
}
