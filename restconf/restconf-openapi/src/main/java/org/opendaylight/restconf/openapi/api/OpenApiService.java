...
public interface OpenApiService {
     ...
     * @throws IOException When I/O error occurs.
     */
    DocumentEntity getMountDocByModule(String instanceNum, String module, String revision, URI uri, Integer width,
     ...
     *
     * <p>
     * We really on {@link EffectiveModelContext} usage of {@link ImmutableCollection} which preserves iteration order,
     * so we are able to read first 40 modules with {@code ?offset=0&limit=20} and consequent request with parameters
     * {@code ?offset=20&limit=20}.
     *
     * <p>
     ...
     * @throws IOException When I/O error occurs.
     */
    DocumentEntity getMountDoc(String instanceNum, URI uri, Integer width, Integer depth, Integer offset,
