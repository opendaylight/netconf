...
public interface OpenApiService {
     ...
     * so we are able to read first 40 modules with ?offset=0&limit=20 and consequent request ?offset=20&limit=20.
     *
    ...
    Response getAllModulesDoc(@Context UriInfo uriInfo, @QueryParam("offset") final Integer offset,
