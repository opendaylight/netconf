...
public interface OpenApiService {
    ...
    OpenApiInputStream getAllModulesDoc(URI uri,Integer width, Integer depth, Integer offset, Integer limit)
        throws IOException;
     ...
     */
    OpenApiInputStream getDocByModule(String module, String revision, URI uri, Integer width, Integer depth)
        throws IOException;

    /**
     * Redirects to embedded swagger ui.
     */
    URI getApiExplorer() throws URISyntaxException;
     ...
     * @throws IOException When I/O error occurs.
     */
    OpenApiInputStream getMountDoc(String instanceNum, URI uri, Integer width, Integer depth, Integer offset,
