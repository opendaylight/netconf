window.onload = function() {
    ...
    xmlHttp.open("GET", document.URL.split('/openapi')[0] + "/openapi/api/v3/mounts/?depth=3&width=5", false);
    xmlHttp.send( null );

    var base_url_rfc = document.URL.split('/openapi')[0] + '/openapi/api/v3/mounts/?depth=3&width=5';
