...
public class ToasterDocumentTest extends AbstractDocumentTest {
    ...
    public void getDocByModuleTest(final String revision, final String jsonPath)
        throws Exception {
    ...
    public void getMountDocByModuleTest(final String revision, final String jsonPath)
        throws Exception {
        final var expectedJson = getExpectedDoc("toaster-document/" + jsonPath);
