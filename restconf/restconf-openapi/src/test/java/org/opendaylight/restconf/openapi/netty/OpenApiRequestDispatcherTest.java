...
class OpenApiRequestDispatcherTest {
    ...
    void allModulesDocs() throws Exception {
        ...
        doReturn(resultStream).when(openApiService).getAllModulesDoc(RESTCONF_SERVER_URI, WIDTH, DEPTH, OFFSET, LIMIT);
    ...
    void moduleDocs() throws Exception {
        doReturn(JSON_CONTENT_BYTES).when(resultStream).readAllBytes();
        doReturn(resultStream).when(openApiService).getDocByModule(MODULE, REVISION, OPENAPI_BASE_URI, WIDTH, DEPTH);
    ...
    void mountInstanceDocs() throws Exception {
        ...
        doReturn(resultStream).when(openApiService)
            .getMountDoc(INSTANCE, OPENAPI_BASE_URI, WIDTH, DEPTH, OFFSET, LIMIT);
    ...
    void moduleInstanceModuleDocs() throws Exception {
        doReturn(JSON_CONTENT_BYTES).when(resultStream).readAllBytes();
        doReturn(resultStream).when(openApiService)
            .getMountDocByModule(INSTANCE, MODULE, REVISION, OPENAPI_BASE_URI, WIDTH, DEPTH);
