...
public final class MountPointOpenApiTest extends AbstractOpenApiTest {
    ...
    public void testGetMountPointApi() throws Exception {
        ...
        assertEquals("Unexpected api list size", 41, paths.size());
        ...
        assertEquals("Unexpected GET paths size", 33, getOperations.size());
        assertEquals("Unexpected POST paths size", 39, postOperations.size());
        assertEquals("Unexpected PUT paths size", 31, putOperations.size());
        assertEquals("Unexpected PATCH paths size", 31, patchOperations.size());
        assertEquals("Unexpected DELETE paths size", 31, deleteOperations.size());
    }
