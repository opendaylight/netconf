...
public class SwaggerDocumentTest {
    ...
    public void getAllModulesDocTest() throws Exception {
        ...
        final var expectedJson = MAPPER.readTree(getClass().getClassLoader().getResourceAsStream("swagger-document/controller-all.json"));
    ...
    public void getDocByModuleTest() throws Exception {
        ...
        final var controllerDocToaster = openApiService.getAllModulesDoc(getToasterController);
        final var jsonControllerDoc = MAPPER.valueToTree(controllerDocToaster.getEntity());
        final var expectedJson = MAPPER.readTree(getClass().getClassLoader().getResourceAsStream("swagger-document/controller-toaster.json"));
        assertEquals(expectedJson, jsonControllerDoc);
    }
    ...
    public void getMountDocTest() throws Exception {
        ...
        final var deviceDocAll = openApiService.getAllModulesDoc(getAllDevice);
        final var jsonDeviceDoc = MAPPER.valueToTree(deviceDocAll.getEntity());
        final var expectedJson = MAPPER.readTree(getClass().getClassLoader().getResourceAsStream("swagger-document/device-all.json"));
    ...
    public void getMountDocByModuleTest() throws Exception {
        ...
        final var deviceDocToaster = openApiService.getAllModulesDoc(getToasterDevice);
        final var jsonDeviceDoc = MAPPER.valueToTree(deviceDocToaster.getEntity());
        final var expectedJson = MAPPER.readTree(getClass().getClassLoader().getResourceAsStream("swagger-document/device-toaster.json"));
        assertEquals(expectedJson, jsonDeviceDoc);
    }
}
