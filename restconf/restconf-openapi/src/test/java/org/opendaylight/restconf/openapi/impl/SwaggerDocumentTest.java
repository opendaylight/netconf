...
public class SwaggerDocumentTest {
    ...
    public void getAllModulesDocTest() throws Exception {
        ...
        JSONAssert.assertEquals(expectedJson, jsonControllerDoc, JSONCompareMode.NON_EXTENSIBLE);
    }
    ...
    public void getMountDocTest() throws Exception {
        ...
        JSONAssert.assertEquals(expectedJson, jsonDeviceDoc, JSONCompareMode.NON_EXTENSIBLE);
    }
