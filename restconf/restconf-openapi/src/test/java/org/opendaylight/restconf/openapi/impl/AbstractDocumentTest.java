...
public abstract class AbstractDocumentTest {
    ...
    protected static String getAllModulesDoc() throws Exception {
        ...
        final var controllerDocAll = openApiService.getAllModulesDoc(getAllController, 0, 0, 3).getEntity();
    ...
    protected static String getMountDoc() throws Exception {
        ...
        final var deviceDocAll = openApiService.getMountDoc("1", getAllDevice, 0, 0, 3);
