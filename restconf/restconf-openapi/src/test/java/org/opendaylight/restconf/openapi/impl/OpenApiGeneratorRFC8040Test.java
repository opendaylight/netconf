...
public final class OpenApiGeneratorRFC8040Test {
    ...
    public void testSimpleOpenApiObjects() {
        ...
        verifyPutRequestRef(JsonNodeMyYangData.put(), "#/components/schemas/my-yang_data", "data", CONTAINER);
        verifyPutRequestRef(JsonNodeMyYangData.get(), "#/components/schemas/my-yang_data", "data", CONTAINER);
    ...
    public void testToaster2OpenApiObjects() {
        ...
        verifyPutRequestRef(jsonNodeToaster.put(), "#/components/schemas/toaster2_toaster", "toaster",
            CONTAINER);
        verifyPutRequestRef(jsonNodeToaster.get(), "#/components/schemas/toaster2_toaster", "toaster",
            CONTAINER);
        ...
        verifyPutRequestRef(jsonNodeToasterSlot.put(), "#/components/schemas/toaster2_toaster_toasterSlot",
            "toasterSlot", LIST);
        verifyPutRequestRef(jsonNodeToasterSlot.get(), "#/components/schemas/toaster2_toaster_toasterSlot",
            "toasterSlot", LIST);
        ...
        verifyPutRequestRef(jsonNodeSlotInfo.put(), "#/components/schemas/toaster2_toaster_toasterSlot_slotInfo",
            "slotInfo", CONTAINER);
        verifyPutRequestRef(jsonNodeSlotInfo.get(), "#/components/schemas/toaster2_toaster_toasterSlot_slotInfo",
            "slotInfo", CONTAINER);
        ...
        verifyPutRequestRef(jsonNodeLst.put(), "#/components/schemas/toaster2_lst", "lst", LIST);
        verifyPutRequestRef(jsonNodeLst.get(), "#/components/schemas/toaster2_lst", "lst", LIST);
        ...
        verifyPutRequestRef(jsonNodeLst1.put(), "#/components/schemas/toaster2_lst_lst1", "lst1", LIST);
