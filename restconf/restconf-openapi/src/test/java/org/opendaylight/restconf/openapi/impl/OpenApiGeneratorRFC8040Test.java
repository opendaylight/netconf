...
public final class OpenApiGeneratorRFC8040Test {
    ...
    public void testMandatory() {
        ...
        final var reqMandatoryContainerElements = Set.of("mandatory-leaf", "leaf-list-with-min-elemnets");
    ...
    private static void verifyRequiredField(final Schema rootContainer, final Set<String> expectedContainerArray) {
        ...
        assertEquals(expectedContainerArray.size(), actualContainerArray.size());
        assertEquals(expectedContainerArray, actualContainerArray);
    }
}
