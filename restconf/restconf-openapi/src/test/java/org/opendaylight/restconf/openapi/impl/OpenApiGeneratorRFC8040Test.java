...
public final class OpenApiGeneratorRFC8040Test extends AbstractOpenApiTest {
    ...
    public void testMandatory() {
        ...
        verifyRequiredField(schemas.get(CONFIG_ROOT_CONTAINER), reqRootContainerArray);
        containersWithRequired.add(CONFIG_ROOT_CONTAINER);
        verifyRequiredField(schemas.get(ROOT_CONTAINER), reqRootContainerArray);
        ...
        verifyRequiredField(schemas.get(CONFIG_MANDATORY_CONTAINER), reqMandatoryContainerArray);
        containersWithRequired.add(CONFIG_MANDATORY_CONTAINER);
        verifyRequiredField(schemas.get(MANDATORY_CONTAINER), reqMandatoryContainerArray);
        containersWithRequired.add(MANDATORY_CONTAINER);

        final var reqMandatoryListArray = new String[]{"mandatory-list-field"};
        verifyRequiredField(schemas.get(CONFIG_MANDATORY_LIST), reqMandatoryListArray);
        containersWithRequired.add(CONFIG_MANDATORY_LIST);
        verifyRequiredField(schemas.get(MANDATORY_LIST), reqMandatoryListArray);
