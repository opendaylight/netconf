...
def generate_uri(identifier, datastore_flag: str = "config", node_value_list: list = ()):
...
def generate_rfc8040_uri(identifier, datastore_flag: str = "config", node_value_list: list = ()):
    node_value_path = ""
