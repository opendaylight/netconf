...
def check_devices_are_up_and_running(device_count):
    ...
    assert int(stdout) == device_count, (
...
def start_testtool(
    ...
    wait_running_timeout = TESTTOOL_BASE_STARTUP_TIMEOUT + device_count * TESTTOOL_PER_DEVICE_TIMEOUT
    wait_all_devices_are_up_and_running(device_count, timeout=wait_running_timeout, log_response=log_response)
