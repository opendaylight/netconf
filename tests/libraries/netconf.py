...
def check_device_connected(device_name, log_response=True):
...
def check_device_completely_gone(
        device_name,
        log_response=True
):
    """
...
def remove_device_from_netconf(device_name, location="location"):
