...
class ClusteringCrudSuite:
    ...
    Attributes:
        ...
        SCHEMA_DIRECTORY (str | None): Schema cache directory to configure the
            device with, or None to leave the library default alone.
    ...
    SCHEMA_DIRECTORY: str | None = None
    ...
    def configured_device(
        ...
        Args:
            ...
            device_schema_directory: Fixture that prepares the schema cache
                directory the device is configured with, when the suite uses one.
            allure_step_with_separate_logging: Fixture used to log distinct steps
                into the Allure report.
        ...
        with allure_step_with_separate_logging("step_configure_device_via_configurer"):
            ...
            schema_directory = (
                ...
                else {"schema_directory": self.SCHEMA_DIRECTORY}
            )
