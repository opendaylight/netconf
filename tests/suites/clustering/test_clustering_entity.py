...
class TestClusteringEntity:
    ...
    def configured_device(self, netconf_testtool, allure_step_with_separate_logging):
        ...
        with allure_step_with_separate_logging(
            ...
            netconf_cluster.wait_device_ownership_settled(
    ...
    def test_entity(self, configured_device, allure_step_with_separate_logging):
        with allure_step_with_separate_logging(
            ...
            for host in NODE_IPS:
                netconf.wait_device_config_data(DEVICE_NAME, EMPTY_DATA, host=host)
        ...
        with allure_step_with_separate_logging(
            ...
            for host in NODE_IPS:
                netconf.wait_device_config_data(DEVICE_NAME, ORIGINAL_DATA, host=host)
        ...
        with allure_step_with_separate_logging(
            ...
            owner, followers = netconf_cluster.get_device_entity_owner_and_followers(
                DEVICE_NAME, host=CONFIGURER_IP
            )
        ...
        with allure_step_with_separate_logging("step_wait_for_new_owner_to_appear"):
            ...
            def new_owner_elected():
                ...
                new_owner, _ = netconf_cluster.get_device_entity_owner_and_followers(
            ...
            with utils.report_known_bug_on_failure("6067"):
                for host in (follower1_ip, follower2_ip):
                    netconf.wait_device_config_data(
                        DEVICE_NAME, ORIGINAL_DATA, host=host
                    )
        ...
        with allure_step_with_separate_logging(
            ...
            with utils.report_known_bug_on_failure("6067"):
                for host in (follower1_ip, follower2_ip):
                    netconf.wait_device_config_data(
                        DEVICE_NAME, MODIFIED_DATA, host=host
                    )
        ...
        with allure_step_with_separate_logging(
            ...
            with utils.report_known_bug_on_failure("5761"):
                netconf.wait_device_config_data(
                    DEVICE_NAME, MODIFIED_DATA, host=original_owner_ip
                )
        ...
        with allure_step_with_separate_logging(
            ...
            for host in NODE_IPS:
                netconf.wait_device_config_data(DEVICE_NAME, MODIFIED_DATA_2, host=host)
