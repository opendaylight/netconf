...
class OutageCycle:
    ...
    Attributes:
        ...
        apply_data (Callable): Library function performing the data operation.
...
OUTAGE_CYCLES = (
    OutageCycle(
        ...
        apply_data=cluster.create_device_data,
    ...
    OutageCycle(
        ...
        apply_data=cluster.modify_device_data,
    ...
    OutageCycle(
        ...
        apply_data=cluster.delete_device_data,
        template_dir=f"{DIRECTORY_WITH_TEMPLATE_FOLDERS}/datamod1",
...
class TestClusteringOutages:
    ...
    def dump_topology(self, host: str):
        ...
        for content in ("config", "nonconfig"):
            ...
            log.info(f"{content} topology as seen by {host}: {topology}")
    ...
    def run_outage_cycle(self, cycle: OutageCycle, allure_step_with_separate_logging):
        ...
        """
        node = cycle.node
        node_ip = cluster.member_ip(node)
        writer_ip = cluster.member_ip(cycle.writer_node)
