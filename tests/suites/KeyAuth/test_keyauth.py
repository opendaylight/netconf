...
# https://github.com/opendaylight/integration-test/blob/901c7e139945b436d95a44b3b592904c3d7a4f9f/csit/suites/netconf/KeyAuth/keyauth.robot
#
...
class TestKeyAuth:
    ...
    def add_netconf_key(self):
        ...
        templated_requests.post_templated_request(
            DIRECTORY_WITH_KEYAUTH_TEMPLATE, mapping, json=False
        )
