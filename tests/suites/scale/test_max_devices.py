        ...
        try:
            for device_count in DEVICE_COUNTS:
                ...
                with allure_step_with_separate_logging(
                    ...
                    netconf.get_data_from_devices_concurrently(device_count, NUM_WORKERS)

                with allure_step_with_separate_logging(f"step_stop_testtool_{device_count}_devices"):
            ...
            if device_names:
                with allure_step_with_separate_logging("step_deconfigure_all_devices"):
                    ...
                    templated_requests.delete_templated_request("variables/netconf/scale/remove_all_nodes", mapping=mapping)
