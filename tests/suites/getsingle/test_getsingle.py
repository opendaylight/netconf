...
# NOTE: Kept in sync with the getmulti suite (NETCONF-1642). The upstream Robot
# suite uses DEVICE_COUNT=500; the count is reduced here so the suite is runnable
# on a single local / CI node. It is a plain constant and should track whatever
# value the getmulti suite settles on.
DEVICE_COUNT = 10
TIMEOUT_FACTOR = 10
