...
class TestPerformance:
    ...
    @pytest.fixture
    def device_on_netconf(self, netconf_testtool, allure_step_with_separate_logging):
    ...
    def test_performance(self, device_on_netconf, allure_step_with_separate_logging):
