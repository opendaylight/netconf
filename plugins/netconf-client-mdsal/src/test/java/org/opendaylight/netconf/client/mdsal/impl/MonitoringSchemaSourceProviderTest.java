...
class MonitoringSchemaSourceProviderTest {
    ...
    @Mock
    private RpcTransformer<ContainerNode, DOMRpcResult> transformer;
    @Mock
    private NetconfMessage message;
    @Mock
    private RpcResult<NetconfMessage> rpcResult;
    ...
    void testGetSourceWithCancellationAfterLongDelay() {
        ...
        // Wait 3 seconds expecting a CancellationException to be thrown.
        final var execException = assertThrows(ExecutionException.class,
            () -> provider.getSource(SOURCE_IDENTIFIER).get(3, TimeUnit.SECONDS));
        // Assert that get SchemaSource failed with a CancellationException after reaching the TRANSACTION_DELAY
