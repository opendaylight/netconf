...
class NetconfDataTreeServiceImplTest extends AbstractTestModelTest {
    ...
    @Test
    void get() {
        netconService.get(LogicalDatastoreType.OPERATIONAL, YangInstanceIdentifier.of(), List.of());
        verify(rpcService).invokeNetconf(eq(Get.QNAME), any());
    }

    @Test
    void getConfig() {
        netconService.get(LogicalDatastoreType.CONFIGURATION, YangInstanceIdentifier.of(), List.of());
