...
class NetconfFieldsParamTest extends AbstractFieldsTranslatorTest {
    ...
    void testSimplePath() throws Exception {
        final var result = FieldsParamParser.fieldsParamsToPaths(JUKEBOX_SCHEMA, jukeboxSchemaNode, assertFields("library"));
    ...
    void testDoublePath() throws Exception {
        final var result = FieldsParamParser.fieldsParamsToPaths(JUKEBOX_SCHEMA, jukeboxSchemaNode, assertFields("library;player"));
        assertNotNull(result);
    ...
    void testSubPath() throws Exception {
        final var result = FieldsParamParser.fieldsParamsToPaths(JUKEBOX_SCHEMA, jukeboxSchemaNode, assertFields("library/artist/album/name"));
        assertNotNull(result);
        assertEquals(1, result.size());
        final var pathArguments = result.getFirst().getPathArguments();
    ...
    void testNamespace() throws Exception {
        final var result = FieldsParamParser.fieldsParamsToPaths(JUKEBOX_SCHEMA, jukeboxSchemaNode, assertFields("augmented-jukebox:augmented-library"));
        assertNotNull(result);
        assertEquals(1, result.size());
    ...
    void testMultipleChildren1() throws Exception {
        final var result = FieldsParamParser.fieldsParamsToPaths(TEST_SERVICES_SCHEMA, testServices, assertFields("services(type-of-service;instance/instance-name;instance/provider)"));
        assertNotNull(result);
    ...
    void testMultipleChildren2() throws Exception {
        final var result = FieldsParamParser.fieldsParamsToPaths(TEST_SERVICES_SCHEMA, testServices, assertFields("services(type-of-service;instance(instance-name;provider))"));
        assertNotNull(result);
        assertEquals(3, result.size());
    ...
    void testMultipleChildren3() throws Exception {
        final var result = FieldsParamParser.fieldsParamsToPaths(TEST_SERVICES_SCHEMA, testServices, assertFields("services(instance/instance-name;type-of-service;next-data/next-service)"));
        assertNotNull(result);
        assertEquals(3, result.size());
    ...
    void testMultipleChildren4() throws Exception {
        final var result = FieldsParamParser.fieldsParamsToPaths(TEST_SERVICES_SCHEMA, testServices, assertFields("services(type-of-service;instance(instance-name;provider);next-data(next-service))"));
        assertNotNull(result);
    ...
    void testAugmentedChild() throws Exception {
        final var result = FieldsParamParser.fieldsParamsToPaths(JUKEBOX_SCHEMA, jukeboxSchemaNode, assertFields("player/augmented-jukebox:speed"));
        assertNotNull(result);
        assertEquals(1, result.size());
        final var pathArguments = result.getFirst().getPathArguments();
    ...
    void testListFieldUnderList() throws Exception {
        final var result = FieldsParamParser.fieldsParamsToPaths(TEST_SERVICES_SCHEMA, testServices, assertFields("services/instance"));
        assertNotNull(result);
        assertEquals(1, result.size());
    ...
    void testLeafList() throws Exception {
        final var result = FieldsParamParser.fieldsParamsToPaths(TEST_SERVICES_SCHEMA, testServices, assertFields("protocols"));
        assertNotNull(result);
        assertEquals(1, result.size());
    ...
    void testKeyedList() throws Exception {
        final var result = FieldsParamParser.fieldsParamsToPaths(JUKEBOX_SCHEMA, jukeboxSchemaNode, assertFields("library/artist(name)"));
        assertNotNull(result);
        assertEquals(1, result.size());
    }
    ...
    void testDuplicateNodes1() throws Exception {
        final var result = FieldsParamParser.fieldsParamsToPaths(FOO_SCHEMA, foo, assertFields("bar(alpha;beta/gamma);baz(alpha;beta/gamma)"));
        assertNotNull(result);
        assertEquals(4, result.size());
        assertEquals(
    ...
    void testDuplicateNodes2() throws Exception {
        final var result = FieldsParamParser.fieldsParamsToPaths(FOO_SCHEMA, foo, assertFields("bar(alpha;beta/delta);baz(alpha;beta/epsilon)"));
        assertNotNull(result);
        assertEquals(4, result.size());
        assertEquals(
            Set.of(List.of(NodeIdentifier.create(BAR_Q_NAME), NodeIdentifier.create(ALPHA_Q_NAME)),
