...
public class Candidate extends AbstractDataStore {
    ...
    Candidate(NetconfBaseOps netconfOps, final RemoteDeviceId id, boolean rollbackSupport,
    ...
    @Override
    public ListenableFuture<? extends DOMRpcResult> editConfig(final EffectiveOperation operation, final YangInstanceIdentifier path) {
