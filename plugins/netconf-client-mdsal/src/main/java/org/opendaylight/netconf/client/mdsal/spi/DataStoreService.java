...
public interface DataStoreService {
     ...
     * ListenableFuture.
     * <p/><p>
     * Release a configuration lock. Provided ListenableFuture waits until release of lock
     * operation is done.
     * <p/><p>
     * Result of {@code <unlock>} operation or {@code <discard-changes>} if calls is only logged.
     * <p/>
     ...
     * <p/><p>
     * This method is primarily intended for exception unrelated to result of {@link ListenableFuture} provided by this
     * interface. This method is automatically wired to result of all ListenableFuture provided by this interface.
     * <p/>
     ...
     * <p/><p>
     * If The {@code <lock>} operation is allowed or not already called by this instance, this operation will call it.
     * <p/>
