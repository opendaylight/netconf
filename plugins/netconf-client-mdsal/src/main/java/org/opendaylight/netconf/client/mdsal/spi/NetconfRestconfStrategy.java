...
public final class NetconfRestconfStrategy extends RestconfStrategy {
    ...
    public void getData(final ServerRequest<DataGetResult> request, final Data path, final DataGetParams params) {
        ...
        if (fieldPaths != null) {
            readData(params.content(), path, params.withDefaults(), fieldPaths, netconfGetRequest);
        } else {
            readData(params.content(), path, params.withDefaults(), netconfGetRequest);
        }
    }
     ...
     */
    public void readData(final @NonNull ContentParam content, final @NonNull Data path,
            final @Nullable WithDefaultsParam withDefa, final @NonNull List<YangInstanceIdentifier> fields,
            final @NonNull ServerRequest<Optional<NormalizedNode>> getRequest) {
