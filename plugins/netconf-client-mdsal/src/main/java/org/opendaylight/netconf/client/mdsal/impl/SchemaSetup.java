...
final class SchemaSetup implements FutureCallback<EffectiveModelContext> {
    ...
    private static boolean isDisconnectException(final Exception e) {
        return e instanceof ExecutionException ex && ex.getCause() instanceof MissingSchemaSourceException miss
