...
public final class RpcsTimeoutAndRecoveryHandler implements RpcsDecorator {
     ...
     */
    public final class NormalizedTimeoutRpcs implements Normalized {
     ...
     */
    public final class SchemalessTimeoutRpcs implements Schemaless {
    ...
    private final class RequestTimeoutTask<V> implements TimerTask, FutureCallback<V> {
        ...
        public void onFailure(final Throwable throwable) {
            // User/Application RPC failed (The RPC did not reach the remote device, or it has timed out)
