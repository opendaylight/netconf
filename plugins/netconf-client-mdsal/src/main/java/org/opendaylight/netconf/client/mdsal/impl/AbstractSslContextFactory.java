...
abstract class AbstractSslContextFactory implements SslContextFactory {
    private final DefaultSslContextFactoryProvider keyStoreProvider;

    AbstractSslContextFactory(final DefaultSslContextFactoryProvider keyStoreProvider) {
    ...
    abstract @NonNull SslContext wrapSslContext(@NonNull SslContext sslContext);
}
