...
public final class DefaultBaseNetconfSchemas implements BaseNetconfSchemas {
    ...
    private BaseSchema loadBaseSchema(final int offset, final boolean candidate, final boolean confirmedCommit,
        ...
        final var builder = new ModuleInfoSnapshotBuilder(parserFactory)
            .add(org.opendaylight.yang.svc.v1.urn.ietf.params.xml.ns.netconf.base._1._0.rev110601.YangModuleInfoImpl
                .getInstance());
        ...
        if (monitoring) {
            builder.add(org.opendaylight.yang.svc.v1.urn.ietf.params.xml.ns.yang.ietf.netconf.monitoring.rev101004
                .YangModuleInfoImpl.getInstance());
        }
        if (notifications) {
            builder
                .add(org.opendaylight.yang.svc.v1.urn.ietf.params.xml.ns.netconf.notification._1._0.rev080714
                    .YangModuleInfoImpl.getInstance())
                .add(org.opendaylight.yang.svc.v1.urn.ietf.params.xml.ns.yang.ietf.netconf.notifications.rev120206
                    .YangModuleInfoImpl.getInstance());
        }
        ...
        final var created = new BaseSchema(snapshot.modelContext());
