...
public class FieldsParamParser {
    ...
    public FieldsParamParser(final EffectiveModelContext context, @Nullable final FieldsParam fields) {
     ...
     */
    public List<YangInstanceIdentifier> toPaths(final @NonNull DataSchemaContext startNode)
