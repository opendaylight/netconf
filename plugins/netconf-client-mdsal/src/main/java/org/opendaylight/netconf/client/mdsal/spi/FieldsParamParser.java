...
public class FieldsParamParser {
    ...
    public final DataSchemaContext startNode;

    public FieldsParamParser(final EffectiveModelContext context, @Nullable final DataSchemaContext fields) {
        this.modelContext = context;
        this.startNode = fields;
    }
     ...
     *
     *
     * @param fields value of the {@code fields} parameter.
     ...
     */
    public List<YangInstanceIdentifier> toPaths(final @Nullable FieldsParam fields)
