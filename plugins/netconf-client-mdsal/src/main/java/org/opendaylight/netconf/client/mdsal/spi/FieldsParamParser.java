...
public final class FieldsParamParser {
    ...
    private FieldsParamParser(final @NonNull EffectiveModelContext context,
            final @NonNull DataSchemaContext startNode) {
     ...
     */
    public static List<YangInstanceIdentifier> fieldsParamsToPaths(final @NonNull EffectiveModelContext context,
            final @NonNull DataSchemaContext startNode, final @Nullable FieldsParam fields) throws RequestException {
     ...
     *    of {@link YangInstanceIdentifier.PathArgument}s
     *
    ...
    private record LinkedPathElement(
            ...
            @NonNull List<YangInstanceIdentifier.PathArgument> mixinNodesToTarget,
