...
public final class NetconfDeviceBuilder {
    ...
    public @NonNull NetconfDeviceBuilder setInitialRpcsHandler(final InitialRpcsHandler initialRpcsHandler) {
        this.initialRpcsHandler = requireNonNull(initialRpcsHandler);
        return this;
    }
    ...
    public @NonNull NetconfDevice build() {
        return new NetconfDevice(
            ...
            requireNonNull(initialRpcsHandler, "InitialRpcsHandler is not initialized"),
