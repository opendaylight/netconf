...
public final class NetconfDeviceBuilder {
    ...
    private RpcsHandler rpcsHandler;
    ...
    public @NonNull NetconfDeviceBuilder setRpcsHandler(final RpcsHandler rpcsHandler) {
        this.rpcsHandler = requireNonNull(rpcsHandler);
        return this;
    }
    ...
    public @NonNull NetconfDevice build() {
        return new NetconfDevice(
            ...
            requireNonNull(rpcsHandler, "RpcsHandler is not initialized"),
