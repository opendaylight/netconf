...
public interface RemoteDeviceHandler extends AutoCloseable {
     ...
     *
     * <p>
     * This can include, for example, creating YANG operational datastore state, setting up a {@link DOMMountPoint}
     * with services, and similar.
     *
     * <p>
     * Implementations of this method must not invoke {@link #close()} or cause it to be invoked.
     *
