...
public class FieldParams {
    ...
    public final FieldsParam fields;

    public FieldParams(final EffectiveModelContext context, @Nullable final FieldsParam fields) {
     ...
     */
    public List<YangInstanceIdentifier> fieldsParamToPaths(final @NonNull DataSchemaContext startNode)
        ...
        return parsed.stream().map(FieldParams::buildPath).toList();
    }
