...
public class NetconfDevice implements RemoteDevice<NetconfDeviceCommunicator> {
    ...
    public void onRemoteSessionUp(final NetconfSessionPreferences remoteSessionCapabilities,
        ...
        Futures.addCallback(Futures.transformAsync(futureSchema, result -> Futures.transform(
            // Potentially acquire mount point list and interpret it
            createMountPointContext(result.modelContext(), baseSchema, listener),
            mount -> new NetconfDeviceSchema(result.capabilities(), mount), processingExecutor), processingExecutor),
            new FutureCallback<>() {
                @Override
