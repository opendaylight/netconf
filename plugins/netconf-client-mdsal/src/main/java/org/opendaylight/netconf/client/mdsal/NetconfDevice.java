...
public class NetconfDevice implements RemoteDevice<NetconfDeviceCommunicator> {
    ...
    private final InitialRpcsHandler initialRpcsHandler;
    ...
    public NetconfDevice(final RemoteDeviceId id,final BaseNetconfSchemaProvider baseSchemaProvider,
            final DeviceNetconfSchemaProvider deviceSchemaProvider, final InitialRpcsHandler initialRpcsHandler,
            final Executor globalProcessingExecutor, final boolean reconnectOnSchemasChange) {
        this(id, baseSchemaProvider, deviceSchemaProvider, initialRpcsHandler, globalProcessingExecutor,
    ...
    public NetconfDevice(final RemoteDeviceId id, final BaseNetconfSchemaProvider baseSchemaProvider,
        ...
        this.initialRpcsHandler = initialRpcsHandler;
        this.salFacade = initialRpcsHandler.remoteDeviceHandler();
    ...
    public synchronized void onRemoteSessionUp(final NetconfSessionPreferences remoteSessionCapabilities,
        ...
        final var initRpcs = initialRpcsHandler.decorateRpcs(netconfRpc);
