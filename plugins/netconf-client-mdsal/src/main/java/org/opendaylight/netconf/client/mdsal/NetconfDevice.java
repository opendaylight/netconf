...
public class NetconfDevice implements RemoteDevice<NetconfDeviceCommunicator> {
    ...
    @GuardedBy("this")
    private ListenableFuture<DeviceSources> sourceResolverFuture;
    ...
    public synchronized void onRemoteSessionUp(final NetconfSessionPreferences remoteSessionCapabilities,
        ...
        sourceResolverFuture = Futures.submit(new DeviceSourcesResolver(id, baseSchema, initRpc,
    ...
    private synchronized void cleanupInitialization() {
        connected = false;
        if (sourceResolverFuture != null) {
            sourceResolverFuture.cancel(true);
        }
