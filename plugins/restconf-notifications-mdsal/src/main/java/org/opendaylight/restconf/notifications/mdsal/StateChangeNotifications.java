...
public class StateChangeNotifications {
    ...
    public ListenableFuture<?> subscriptionModified(String eventTime, Long id, String uri, String filter) throws InterruptedException {
    ...
    private ListenableFuture<?> subscriptionCompletedResumed(String eventTime, Long id, String action) throws InterruptedException {
        final var node = ImmutableNodes.newContainerBuilder()
            .withNodeIdentifier(new NodeIdentifier(NODE_IDENTIFIER))
            .withChild(ImmutableNodes.leafNode(EVENT_TIME, eventTime))
            .withChild(ImmutableNodes.newContainerBuilder()
    ...
    public ListenableFuture<?> subscriptionTerminated(String eventTime, Long id, String errorId) throws InterruptedException {
        return subscriptionTerminatedSuspended(eventTime, id, errorId, "subscription-terminated");
    }

    public ListenableFuture<?> subscriptionSuspended(String eventTime, Long id, String errorId) throws InterruptedException {
        return subscriptionTerminatedSuspended(eventTime, id, errorId, "subscription-resumed");
    }

    private ListenableFuture<?> subscriptionTerminatedSuspended(String eventTime, Long id, String errorId, String action) throws InterruptedException {
        final var node = ImmutableNodes.newContainerBuilder()
            .withNodeIdentifier(new NodeIdentifier(NODE_IDENTIFIER))
            .withChild(ImmutableNodes.leafNode(EVENT_TIME, eventTime))
            .withChild(ImmutableNodes.newContainerBuilder()
