 ...
 */
@Singleton
@Component(service = RestconfSubscriptionsStreamRegistry.class)
public final class RestconfSubscriptionsStreamRegistry extends AbstractRestconfStreamRegistry {
    ...
    //FIXME: Make putStream accessible so we can use it directly
    public ListenableFuture<?> addStream(final @NonNull MapEntryNode stream) {
