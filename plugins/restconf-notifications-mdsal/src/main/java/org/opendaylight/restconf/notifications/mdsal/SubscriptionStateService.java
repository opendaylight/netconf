...
public class SubscriptionStateService {
    ...
    public ListenableFuture<?> subscriptionModified(final Instant eventTime, final Uint32 id, final String streamName,
        ...
        if (stopTime == null) {
            body.withChild(ImmutableNodes.leafNode(STOP_TIME_NODEID,
                DateAndTime.getDefaultInstance("2024-10-30T12:34:56Z")));
        }
        if (uri == null) {
            body.withChild(ImmutableNodes.leafNode(URI_NODEID, "new Uri"));
        }
