...
class SubscriptionStateServiceTest {
    private static final DateAndTime STOP_TIME = DateAndTime.getDefaultInstance("2024-10-30T12:34:56Z");
...
//                new YangInstanceIdentifier.NodeIdentifier(QName.create(eventQName, "stream-subtree-filter"))).body());
            ...
            assertEquals(URI, notification.getChildByArg(
                new YangInstanceIdentifier.NodeIdentifier(QName.create(eventQName, "uri"))).body());
        }
