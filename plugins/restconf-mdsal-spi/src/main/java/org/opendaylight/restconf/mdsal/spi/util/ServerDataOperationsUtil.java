...
public final class ServerDataOperationsUtil {
    ...
    public static Data getConceptualParent(final Data data) {
        ...
        return new Data(data.databind(), childAndStack.stack().toInference(), parentPath, childAndStack.node());
    }
    ...
    @NonNullByDefault
    public static void completeDataGET(final ServerRequest<DataGetResult> request,
    ...
    public static void buildMapEntryBuilder(
    ...
    public static void appendContainer(final DataContainerNodeBuilder<?, ?> builder, final ContainerNode container,
    ...
    public static void appendLeaf(final DataContainerNodeBuilder<?, ?> builder, final LeafNode<?> leaf,
    ...
    public static void appendMap(final DataContainerNodeBuilder<?, ?> builder, final MapNode map,
    ...
    public static void buildList(final CollectionNodeBuilder<MapEntryNode, ? extends MapNode> builder,
    ...
    public static void buildCont(final DataContainerNodeBuilder<NodeIdentifier, ContainerNode> builder,
    ...
    public static @NonNull DataSchemaContext getChildContext(final DataSchemaContext ctxNode,
    ...
    public static NormalizedNode mergeConfigAndSTateDataIfNeeded(final NormalizedNode stateDataNode,
     ...
     */
    public static @NonNull NormalizedNode mergeStateAndConfigData(final @NonNull NormalizedNode stateDataNode,
     ...
     * @param configDataNode data node of config data
     */
    public static void validateNodeMerge(final @NonNull NormalizedNode stateDataNode,
            final @NonNull NormalizedNode configDataNode) throws RequestException {
     ...
     * @return {@link NormalizedNode}
     */
    public static @NonNull NormalizedNode prepareRpcData(final @NonNull NormalizedNode configDataNode,
     ...
     */
    public static void mapRpcDataNode(final @NonNull NormalizedNode dataNode,
     ...
     */
    public static <T extends NormalizedNode> void mapValueToBuilder(
     ...
     * @param builder   - builder
     */
    public static <T extends NormalizedNode> void mapDataToBuilder(
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T extends NormalizedNode> void mergeDataToBuilder(
            final @NonNull Map<PathArgument, T> configMap, final @NonNull Map<PathArgument, T> stateMap,
            final @NonNull NormalizedNodeContainerBuilder<?, PathArgument, T, ?> builder) {
