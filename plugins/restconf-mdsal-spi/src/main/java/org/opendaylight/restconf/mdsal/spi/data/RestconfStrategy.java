...
public abstract class RestconfStrategy extends AbstractServerDataOperations {
    ...
    protected final NormalizedNode prepareDataByParamWithDef(final NormalizedNode readData,
            final YangInstanceIdentifier path, final WithDefaultsMode defaultsMode) throws ServerException {
    ...
    // FIXME: require DatabindPath.Data here
    protected final @NonNull ServerException decodeException(final Throwable ex, final String txType,
