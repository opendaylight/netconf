...
public abstract class RestconfTransaction {
     ...
     */
    public final void delete(final YangInstanceIdentifier path) throws ServerException {
        LOG.trace("Delete {}", path);
        deleteImpl(requireNonNull(path));
    }

    protected abstract void deleteImpl(@NonNull YangInstanceIdentifier path) throws ServerException;
    ...
    protected abstract void removeImpl(@NonNull YangInstanceIdentifier path) throws ServerException;
     ...
     * @param data    the data object to be merged to the specified path
     */
    public final void create(final YangInstanceIdentifier path, final NormalizedNode data) throws ServerException {
