...
final class MdsalSubscriptionReceiver<T extends RestconfStream.Receiver> extends ForwardingSubscriptionReceiver<T> {
    ...
    public void updateSentEventRecord() {
        ...
        Futures.addCallback(updateReceiver(counterValue, RestconfStream.FilteredRecordType.SENT_EVENT_RECORDS),
            new FutureCallback<>() {
                @Override
    ...
    public void updateExcludedEventRecord() {
        ...
        Futures.addCallback(updateReceiver(counterValue, RestconfStream.FilteredRecordType.EXCLUDED_EVENT_RECORDS),
            new FutureCallback<>() {
                @Override
                public void onSuccess(final Void result) {
    ...
    public ListenableFuture<Void> updateReceiver(final long counter,
        ...
        final var sentEventIid = YangInstanceIdentifier.builder()
            ...
            .node(YangInstanceIdentifier.NodeIdentifierWithPredicates.of(Subscription.QNAME, QNAME_ID,
