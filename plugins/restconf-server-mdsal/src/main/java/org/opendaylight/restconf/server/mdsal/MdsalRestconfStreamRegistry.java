...
import static org.opendaylight.restconf.subscription.SubscriptionUtil.QNAME_EXCLUDE_EVENT_RECORDS;
...
public final class MdsalRestconfStreamRegistry extends AbstractRestconfStreamRegistry {
    ...
    @Override
    public ListenableFuture<Void> updateReceiver(final ReceiverHolder receiver,
        ...
        switch (recordType) {
            ...
            case EXCLUDE_EVENT_RECORDS -> {
                sentEventIid.node(NodeIdentifier.create(QNAME_EXCLUDE_EVENT_RECORDS));
                counterValue = ImmutableNodes.leafNode(
                    QNAME_EXCLUDE_EVENT_RECORDS, Uint64.valueOf(receiver.excludedEventCounter().get()));
            }
                ...
                .withChild(ImmutableNodes.newContainerBuilder()
                    ...
                    .withChild(ImmutableNodes.newSystemMapBuilder()
                        ...
                        .withChild(ImmutableNodes.newMapEntryBuilder()
                            ...
                            .withChild(ImmutableNodes.leafNode(QNAME_SENT_EVENT_RECORDS,
                                Uint64.valueOf(0)))
