...
final class MdsalRestconfStreamSubscription<T extends RestconfStream.Subscription>
    ...
    /**
     * <p> Writes updated SentEventRecord counter for all the receivers in subscription into datastore via a merge
     * operation, and the method returns a {@link ListenableFuture} that completes when the commit succeeds or fails.
     */
    ...
    /**
     * <p> Writes updated ExcludedEventRecord counter for all the receivers in subscription into datastore via a merge
     * operation, and the method returns a {@link ListenableFuture} that completes when the commit succeeds or fails.
     */
