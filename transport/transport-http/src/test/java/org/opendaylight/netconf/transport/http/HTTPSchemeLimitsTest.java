...
class HTTPSchemeLimitsTest {
    ...
    void limitsSurviveTheTransportConfiguration() {
        final var limits = new HTTPServerLimits(1024, 2048, 4096, 8192, 16384, 65535, 0, BytebufAllocator.Unpooled);
    ...
    void unsetLeavesYieldTheirDefaults() {
        ...
        final var expected = new HTTPServerLimits(
            ...
            HTTPServerLimits.DEFAULT.initialWindowSize(),
            HTTPServerLimits.DEFAULT.socketReceiveBufferSize(),
            HTTPServerLimits.DEFAULT.bytebufAllocator());
    ...
    private static HTTPServerLimits limits(final int maxInitialLineLength, final int maxHeaderSize,
        ...
        return new HTTPServerLimits(maxInitialLineLength, maxHeaderSize, 8192, maxRequestBodySize, 16384, 65535, 32768,
            BytebufAllocator.Pooled);
    }
