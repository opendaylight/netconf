...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev251111.HttpServerGrouping;
...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev251111.http.server.grouping.ProtocolVersions;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev251111.http.server.grouping.SupportedVersions;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev251111.http.server.grouping.client.authentication.users.UserBuilder;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev251111.http.server.grouping.client.authentication.users.user.auth.type.basic.BasicBuilder;
        ...
        final var authHandler = BasicAuthHandlerFactory.ofNullable(new HttpServerGrouping() {
            ...
            public ClientAuthentication getClientAuthentication() {
                final var user1 = new UserBuilder()
                    .setUserId(USERNAME1)
                    .setAuthType(new org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev251111
            ...
            @Override
            public SupportedVersions nonnullSupportedVersions() {
                throw new UnsupportedOperationException();
            }
        });
