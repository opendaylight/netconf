...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev240316.http.server.grouping.client.authentication.users.UserBuilder;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev240316.http.server.grouping.client.authentication.users.user.auth.type.basic.BasicBuilder;
        ...
        final var authHandler = BasicAuthHandlerFactory.ofNullable(new HttpServerGrouping() {
            ...
            public ClientAuthentication getClientAuthentication() {
                final var user1 = new UserBuilder()
                    .setUserId(USERNAME1)
                    .setAuthType(new org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev240316
