    ...
    private void integrationTest(final boolean http2) throws Exception {
        ...
        try {
            ...
            try {
                ...
                clientEventStreamService.startEventStream(DATA_URI, eventStreamListener, requestCallback);
                verify(requestCallback, timeout(1000)).onFailure(exceptionCaptor.capture());
                ...
                clientEventStreamService.startEventStream(STREAM_URI, eventStreamListener, requestCallback);
                verify(requestCallback, timeout(1000)).onSuccess(any());
