...
/**
 * A headers-only {@link Response}.
 */
@NonNullByDefault
public record HeadersResponse(HttpResponseStatus status, ReadOnlyHttpHeaders headers) implements Response {
