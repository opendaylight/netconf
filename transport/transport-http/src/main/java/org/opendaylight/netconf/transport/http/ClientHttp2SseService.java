...
final class ClientHttp2SseService extends ChannelInboundHandlerAdapter
    ...
    @NonNullByDefault
    private final class FrameListener extends ClientHttp2SseFrameListener {
        private final int streamId;

        FrameListener(final String uri, final EventStreamListener listener,
                final FutureCallback<Registration> requestCallback, final int streamId) {
    ...
    ClientHttp2SseService(final @NonNull Channel channel, final @NonNull IntSupplier streamIdSupplier) {
