...
final class ClientHttp2SseService extends ChannelInboundHandlerAdapter
    ...
    private final @NonNull Supplier<Integer> streamIdSupplier;
    ...
    ClientHttp2SseService(final @NonNull Channel channel, final @NonNull Supplier<Integer> streamIdSupplier) {
