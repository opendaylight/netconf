...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.client.rev230417.HttpClientStackGrouping;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.client.rev230417.http.client.stack.grouping.transport.Tcp;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.client.rev230417.http.client.stack.grouping.transport.Tls;
...
public final class HTTPClient extends HTTPTransportStack {
    ...
    public ListenableFuture<HttpResponse> invoke(final HttpRequest request) {
