 ...
 */
// FIXME: NETCONF-1681: HTTPClient's tcp/tls connect-then-attach-pipeline shape does not fit QUIC's one-shot handshake,
//  forcing the two overrides below to just throw. Refactoring of HTTPClient's hierarchy should be done.
