 ...
 *        {@code 431 Request Header Fields Too Large}. Advertised as {@code SETTINGS_MAX_HEADER_LIST_SIZE} on HTTP/2 and
 *        as {@code SETTINGS_MAX_FIELD_SECTION_SIZE} on HTTP/3, where it is enforced by the codec rather than answered
 *        with a status code.
