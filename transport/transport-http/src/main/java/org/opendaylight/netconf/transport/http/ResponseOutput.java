...
public final class ResponseOutput {
    ...
    public ResponseBodyOutputStream start(final HttpResponseStatus status, final HttpHeaders headers) {
        return new ResponseBodyOutputStream(channel, status, headers);
    }
