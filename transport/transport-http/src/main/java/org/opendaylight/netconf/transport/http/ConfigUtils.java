...
public final class ConfigUtils {
    ...
    /**
     * Builds transport configuration for {@link HTTPClient} using QUIC transport with no authorization.
     *
     * @param host remote address
     * @param port remote port
     * @param certificate server certificate
    ...
    public static Transport clientTransportQuic(final @NonNull String host, final int port,
            final @NonNull Certificate certificate, final Uint64 initialMaxData,
            final Uint64 initialMaxStreamDataBidirectional, final Uint32 initialMaxStreamsBidirectional) {
