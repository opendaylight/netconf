...
public final class ConfigUtils {
     ...
     */
    public static org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev251111
        .http.server.listen.stack.grouping.Transport serverTransportTcp(final @NonNull String host, final int port) {
     ...
     */
    public static org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev251111
        .http.server.listen.stack.grouping.Transport serverTransportTls(final @NonNull String host, final int port,
     ...
     * @return transport configuration
     */
    public static org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev251111.http.server.listen
        .stack.grouping.Transport serverTransportTls(
            final org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev251111.http.server.listen
        ...
        return new org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev251111.http.server
            .listen.stack.grouping.transport.HttpOverTlsBuilder()
