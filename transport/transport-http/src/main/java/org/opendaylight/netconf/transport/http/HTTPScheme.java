...
public enum HTTPScheme {
    ...
    /**
     * Internal h2c upgrade signal used to let {@link HTTPServerSessionBootstrap} install the HTTP/2 multiplexer
     * before {@link Http2FrameCodec} replays the upgraded request on stream 1.
     */
    enum HTTP2UpgradeSetup {
        INSTANCE
    }
    ...
    private static final class UpgradeMultiplexHandler extends ChannelInboundHandlerAdapter {
        ...
        public void handlerAdded(final ChannelHandlerContext ctx) {
            ctx.fireUserEventTriggered(HTTP2UpgradeSetup.INSTANCE);
