 ...
 */
abstract class ClientHttp1SseHandler extends ChannelInboundHandlerAdapter {
    ...
    ClientHttp1SseHandler(final @NonNull String uri, final @NonNull EventStreamListener listener,
            final @NonNull FutureCallback<Registration> requestCallback) {
