...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260402.http.server.listen.stack.grouping.transport.HttpOverTcp;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260402.http.server.listen.stack.grouping.transport.HttpOverTcpBuilder;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260402.http.server.listen.stack.grouping.transport.http.over.tcp.http.over.tcp.HttpServerParameters;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260402.http.server.listen.stack.grouping.transport.http.over.tcp.http.over.tcp.HttpServerParametersBuilder;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260402.http.server.listen.stack.grouping.transport.http.over.tcp.http.over.tcp.TcpServerParameters;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260402.http.server.listen.stack.grouping.transport.http.over.tcp.http.over.tcp.TcpServerParametersBuilder;
...
public final class HTTPServerOverTcp {
    ...
    static @NonNull HttpOverTcp of(final @NonNull TcpServerParameters tcpParams,
        ...
        return new HttpOverTcpBuilder()
            .setHttpOverTcp(new org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260402
    ...
    static @Nullable ClientAuthentication clientAuthentication(final @Nullable Map<String, String> userCryptHashMap) {
        ...
        final var userMap = userCryptHashMap.entrySet().stream()
            .map(entry -> new org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260402
                .http.server.grouping.client.authentication.users.UserBuilder()
                .setUserId(entry.getKey())
                .setAuthType(
                    new org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260402
