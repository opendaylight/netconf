...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260204.http.server.listen.stack.grouping.transport.http.over.tcp.http.over.tcp.HttpServerParameters;
...
public final class HTTPServerOverTcp {
    ...
    public static @NonNull HttpOverTcp of(final @NonNull String host, final int port) {
        return of(host, port, null, HTTPServerLimits.DEFAULT);
    }
     ...
     */
    @NonNullByDefault
    public static HttpOverTcp of(final String host, final int port, final HTTPServerLimits limits) {
     ...
     */
    @NonNullByDefault
    public static HttpOverTcp of(final String host, final int port,
            final @Nullable Map<String, String> userCryptHashMap, final HTTPServerLimits limits) {
     ...
     */
    @NonNullByDefault
    static ServerLimits serverLimits(final HTTPServerLimits limits) {
     ...
     */
    @NonNullByDefault
    static OdlServerLimits odlServerLimits(final HTTPServerLimits limits) {
    ...
    static @Nullable ClientAuthentication clientAuthentication(final @Nullable Map<String, String> userCryptHashMap) {
        ...
        final var userMap = userCryptHashMap.entrySet().stream()
            .map(entry -> new org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260204
                .http.server.grouping.client.authentication.users.UserBuilder()
                .setUserId(entry.getKey())
                .setAuthType(
                    new org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260204
