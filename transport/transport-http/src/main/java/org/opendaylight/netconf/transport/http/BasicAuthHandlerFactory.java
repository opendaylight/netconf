...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev240815.http.server.grouping.client.authentication.users.user.auth.type.Basic;
