...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260204.http.server.grouping.client.authentication.users.user.auth.type.Basic;
