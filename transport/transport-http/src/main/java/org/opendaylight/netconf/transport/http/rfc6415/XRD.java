...
public interface XRD {
    /**
     * The XML namespace reference to XRD.
     */
    String NS_URI = "http://docs.oasis-open.org/ns/xri/xrd-1.0";
    /**
     * The <a href="http://docs.oasis-open.org/xri/xrd/v1.0/os/xrd-1.0-os.xsd">XML Schema file for XRD 1.0</a>.
     */
    ByteSource XSD = Resources.asByteSource(Resources.getResource(XRD.class, "/xrd-1.0-os.xsd"));
