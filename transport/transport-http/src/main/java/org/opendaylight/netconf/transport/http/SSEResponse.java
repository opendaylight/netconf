...
public final class SSEResponse implements Response {
    ...
    public SSEResponse(final ChannelHandler sender, final ChannelHandler handler) {
        this.sender = sender;
    ...
    public DefaultFullHttpResponse start(final ChannelHandlerContext ctx, final Integer streamId,
        ...
        // FIXME: if (heartbeatIntervalMillis > 0) {
        schedulePing();
