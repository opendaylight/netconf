...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260204.http.server.listen.stack.grouping.transport.HttpOverTlsBuilder;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260204.http.server.listen.stack.grouping.transport.http.over.tls.http.over.tls.HttpServerParameters;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260204.http.server.listen.stack.grouping.transport.http.over.tls.http.over.tls.HttpServerParametersBuilder;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260204.http.server.listen.stack.grouping.transport.http.over.tls.http.over.tls.TcpServerParameters;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260204.http.server.listen.stack.grouping.transport.http.over.tls.http.over.tls.TcpServerParametersBuilder;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260204.http.server.listen.stack.grouping.transport.http.over.tls.http.over.tls.TlsServerParameters;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260204.http.server.listen.stack.grouping.transport.http.over.tls.http.over.tls.TlsServerParametersBuilder;
...
public final class HTTPServerOverTls {
    ...
    public static @NonNull HttpOverTls of(final @NonNull String host, final int port,
        ...
        return of(host, port, certificate, privateKey, null, HTTPServerLimits.DEFAULT);
    }
     ...
     */
    @NonNullByDefault
    public static HttpOverTls of(final String host, final int port, final Certificate certificate,
            final PrivateKey privateKey, final HTTPServerLimits limits) {
    ...
    @NonNullByDefault
    public static HttpOverTls of(final String host, final int port, final Certificate certificate,
            final PrivateKey privateKey, final @Nullable Map<String, String> userCryptHashMap,
        ...
        return of(
            ...
            new HttpServerParametersBuilder()
                ...
                .addAugmentation(new LimitsUnderHttpTlsBuilder()
                    .setServerLimits(HTTPServerOverTcp.serverLimits(limits))
                    .setOdlServerLimits(HTTPServerOverTcp.odlServerLimits(limits))
                    .build())
                .build());
    }
    ...
    public static @NonNull HttpOverTls of(final @NonNull TcpServerParameters tcpParams,
        ...
        return new HttpOverTlsBuilder()
            .setHttpOverTls(new org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.http.server.rev260204
