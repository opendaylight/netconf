...
public abstract sealed class TCPTransportStack extends AbstractTransportStack {
    private static final class ConnectInitiate extends TCPTransportStack {
        private final @NonNull Future<?> shutdownFuture;

        ConnectInitiate(final Channel channel) {
    ...
    public static @NonNull ListenableFuture<TransportStack> connect(final TransportChannelListener listener,
        ...
        final var ret = SettableFuture.<TransportStack>create();
        bootstrap
            .connect(
            ...
            .addListener((ChannelFutureListener) future -> {
                if (future.isSuccess()) {
                    ...
                    final var stack = new ConnectInitiate(channel);
                    ret.set(stack);
    ...
    public static @NonNull ListenableFuture<TransportStack> listen(final TransportChannelListener listener,
