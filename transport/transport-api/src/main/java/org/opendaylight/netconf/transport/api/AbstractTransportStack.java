 ...
 * {@link #shutdown()}.
 */
public abstract class AbstractTransportStack<T extends TransportChannel> implements TransportStack {
    ...
    protected final void onTransportChannelEstablished(final @NonNull T channel) {
