...
public final class TLSClient extends TLSTransportStack {
    private TLSClient(final TransportChannelListener<T> listener, final SslContext sslContext) {
        super(listener, sslContext);
    }

    private TLSClient(final TransportChannelListener<T> listener, final SslHandlerFactory factory) {
        super(listener, factory);
    }

    public static @NonNull ListenableFuture<TLSClient> connect(final TransportChannelListener<T> listener,
    ...
    public static @NonNull ListenableFuture<TLSClient> listen(final TransportChannelListener<T> listener,
