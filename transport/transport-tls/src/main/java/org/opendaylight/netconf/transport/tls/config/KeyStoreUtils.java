...
public final class KeyStoreUtils {
    ...
    private static final String BC_JSSE = BouncyCastleJsseProvider.PROVIDER_NAME;
    ...
    public static @NonNull KeyManagerFactory buildKeyManagerFactory(final @NonNull KeyStore keyStore)
        ...
        try {
            final KeyManagerFactory kmf = KeyManagerFactory.getInstance(PKIX, BC_JSSE);
            kmf.init(keyStore, EMPTY_SECRET);
            return kmf;
        } catch (NoSuchAlgorithmException | NoSuchProviderException | UnrecoverableKeyException | KeyStoreException e) {
    ...
    public static @NonNull TrustManagerFactory buildTrustManagerFactory(final @NonNull KeyStore keyStore)
            throws UnsupportedConfigurationException {
        try {
            final var tmf = TrustManagerFactory.getInstance(PKIX, BC_JSSE);
            tmf.init(keyStore);
            return tmf;
