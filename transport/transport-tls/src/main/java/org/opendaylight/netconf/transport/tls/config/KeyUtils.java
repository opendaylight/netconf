...
final class KeyUtils {
    ...
    static PublicKey buildPublicKeyFromSshEncoding(final byte[] bytes)
        ...
        try (var in = new DataInputStream(new ByteArrayInputStream(bytes))) {
            ...
            if (type.equals("ssh-rsa")) {
                ...
                final BigInteger p = readBigInteger(in);
                final BigInteger q = readBigInteger(in);
                final BigInteger g = readBigInteger(in);
                final BigInteger y = readBigInteger(in);
    ...
    private static ECPoint buildECPoint(final BigInteger q, final String algName) {
