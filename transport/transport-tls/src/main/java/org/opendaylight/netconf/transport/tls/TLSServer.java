...
public final class TLSServer extends TLSTransportStack {
    private TLSServer(final TransportChannelListener<T> listener, final SslContext sslContext) {
        super(listener, sslContext);
    }

    private TLSServer(final TransportChannelListener<T> listener, final SslHandlerFactory factory) {
        super(listener, factory);
    }

    public static @NonNull ListenableFuture<TLSServer> connect(final TransportChannelListener<T> listener,
    ...
    public static @NonNull ListenableFuture<TLSServer> listen(final TransportChannelListener<T> listener,
