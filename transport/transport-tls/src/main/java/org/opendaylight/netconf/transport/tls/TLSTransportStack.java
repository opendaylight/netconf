...
public abstract sealed class TLSTransportStack extends AbstractTransportStack<TLSTransportChannel>
    ...
    // Should be TransportChannelListener?
    final void onNewChannel(final TransportChannel tcp) {
        final var ch = tcp.channel();
        ...
        sslHandler.handshakeFuture().addListener(future -> {
            ...
            if (cause != null) {
                ...
                onTransportChannelEstablished(new TLSTransportChannel(tcp));
            }
        });
    }
