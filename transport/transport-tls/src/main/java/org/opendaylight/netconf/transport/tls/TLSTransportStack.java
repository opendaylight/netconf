...
public abstract sealed class TLSTransportStack extends AbstractOverlayTransportStack<TLSTransportChannel>
    ...
    static final KeyManagerFactory newKeyManager(
    ...
    static final KeyManagerFactory newKeyManager(final @NonNull LocalOrKeystoreAsymmetricKeyGrouping rawPrivateKey)
            throws UnsupportedConfigurationException {
        final var keyStore = newKeyStore();
    ...
    protected static final @Nullable TrustManagerFactory newTrustManager(
