...
public final class KeyPairParser {
    ...
    public static KeyPair parseKeyPair(final AsymmetricKeyPairGrouping input) throws UnsupportedConfigurationException {
        ...
        // FIXME: NETCONF-1536: check whether the private and public key match
