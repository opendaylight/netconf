...
class SshClientServerTest extends AbstractClientServerTest {
    ...
    void itServerKeyVerify(final String testDesc, final ServerIdentity serverIdentity,
        ...
        integrationTest(
            ...
            () -> FACTORY.connectClient(SUBSYSTEM, clientListener, algListener, tcpClientConfig, sshClientConfig));
    }
    ...
    void callHome() throws Exception {
        ...
        final var client = FACTORY.listenClient(SUBSYSTEM, clientListener, algListener, tcpServerConfig,
    ...
    void handleChannelInactive() throws Exception {
        ...
        try {
            // connect with client
            final var client = FACTORY.connectClient(SUBSYSTEM, clientListener, algListener, tcpClientConfig,
                sshClientConfig, clientConfigurator()).get(2, TimeUnit.SECONDS);
            try {
