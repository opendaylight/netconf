...
class NC1423Test extends AbstractClientServerTest {
    ...
    private final BootstrapFactory factory = new BootstrapFactory("SessionFailure", 0);
    private final ServerBootstrap serverBootstrap = factory.newServerBootstrap();
    private final Bootstrap clientBootstrap = factory.newBootstrap();
