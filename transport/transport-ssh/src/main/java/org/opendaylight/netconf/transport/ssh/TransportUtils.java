    ...
    static final Map<
        ...
        NamedFactory<Cipher>> CIPHERS = ImmutableMap.<
            ...
            NamedFactory<Cipher>>builder()
                ...
                // FIXME: SshEncryptionAlgorithm.Chacha20Poly1305 == cc20p1305_openssh ?
                .build();
    ...
    static {
        final var factories = Maps.filterValues(ImmutableMap.<
            ...
            BuiltinDHFactories>builder()
                ...
                // FIXME: audit from the below and provide solution for remaining (commented out) KEX algorithms missing
                //        in BuiltinDHFactories
                ...
                // FIXME: SshKeyExchangeAlgorithm.Sntrup761x25519Sha512 = sntrup761x25519 or sntrup761x25519_openssh?
                // FIXME: SshKeyExchangeAlgorithm.Mlkem768nistp256Sha256 = mlkem768nistp256 ?
                // FIXME: SshKeyExchangeAlgorithm.Mlkem1024nistp384Sha384 = mlkem1024nistp384 ?
                // FIXME: SshKeyExchangeAlgorithm.Mlkem768x25519Sha256 = mlkem768x25519 ?
    ...
    static final ImmutableMap<
        ...
        NamedFactory<Mac>> MACS = ImmutableMap.<
            ...
            NamedFactory<Mac>>builder()
                ...
                // FIXME: provide a solution for these:
    ...
    static final Map<
        ...
        NamedFactory<Signature>> SIGNATURES = ImmutableMap.<
            ...
            NamedFactory<Signature>>builder()
                ...
                // FIXME: audit from the below and provide solution for remaining (commented out) algorithms missing
                //        in BuiltinSignatures
