    ...
    static final class Builder extends ClientBuilder {
        ...
        private static void setClientIdentity(final TransportSshClient client, final ClientIdentity clientIdentity,
            ...
            if (hostBased != null) {
                ...
                var keyPair = ConfigUtils.extractKeyPair(null, hostBased.getInlineOrKeystore());
            ...
            if (publicKey != null) {
                // FIXME: we need a KeystoreAccess
                final var keyPairs = ConfigUtils.extractKeyPair(null, publicKey.getInlineOrKeystore());
