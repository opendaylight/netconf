...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.ssh.common.rev220718.IetfSshCommonData;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.ssh.common.rev220718.TransportParams;
import org.opendaylight.yangtools.yang.binding.YangFeature;
import org.opendaylight.yangtools.yang.binding.YangFeatureProvider;

/**
 * Features supported by SSH transport.
 */
@MetaInfServices
@NonNullByDefault
public final class IetfSshCommonProvider implements YangFeatureProvider<IetfSshCommonData> {
    ...
    public Set<? extends YangFeature<?, IetfSshCommonData>> supportedFeatures() {
        return Set.of(TransportParams.VALUE);
    }
}
