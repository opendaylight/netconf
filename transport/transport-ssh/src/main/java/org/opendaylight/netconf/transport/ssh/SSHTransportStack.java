...
public abstract sealed class SSHTransportStack extends AbstractOverlayTransportStack<SSHTransportChannel>
    ...
    protected void onUnderlayChannelEstablished(final TransportChannel underlayChannel) {
        ...
        channel.pipeline().addLast(new OdlFlowControlHandler(handler, ioSession));
    ...
    static final <T> @NonNull T checkCast(final Class<T> clazz, final Object obj) throws IOException {
        try {
            return requireNonNull(clazz.cast(obj));
