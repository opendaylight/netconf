...
/**
 * A {@link ClientSession} implementation bound to a backend Netty channel.
 */
final class TransportClientSession extends ClientSessionImpl {
    TransportClientSession(final ClientFactoryManager client, final IoSession ioSession) throws Exception {
