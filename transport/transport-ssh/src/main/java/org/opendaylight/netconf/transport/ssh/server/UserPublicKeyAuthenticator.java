 ...
 */
package org.opendaylight.netconf.transport.ssh.server;
...
public class UserPublicKeyAuthenticator implements HostBasedAuthenticator, PublickeyAuthenticator {

    private final Map<String, List<PublicKey>> userHostPublicKeyMap;

    public UserPublicKeyAuthenticator(Map<String, List<PublicKey>> userHostPublicKeyMap) {
