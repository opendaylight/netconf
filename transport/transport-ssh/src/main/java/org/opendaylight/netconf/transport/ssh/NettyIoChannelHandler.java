...
final class NettyIoChannelHandler extends NettyIoSession {
    ...
    static HandlerAndId createAdapter(final NettyIoService service, final IoHandler handler,
            final SocketAddress acceptanceAddress) {
        final var instance = new NettyIoChannelHandler(service, handler, acceptanceAddress);
