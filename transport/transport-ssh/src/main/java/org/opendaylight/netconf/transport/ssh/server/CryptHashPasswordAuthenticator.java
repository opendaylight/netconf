...
public class CryptHashPasswordAuthenticator implements PasswordAuthenticator {
    ...
    public CryptHashPasswordAuthenticator(final @NonNull Map<String, String> userHashes) {
