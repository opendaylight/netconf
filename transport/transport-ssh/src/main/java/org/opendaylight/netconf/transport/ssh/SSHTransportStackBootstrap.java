...
//            .put(ExtInfoS.VALUE, null)
    ...
    private static void setKeyExchange(final ImmutableMap<KeyExchangeAlgBase, KeyExchangeFactory> kexs,
            final BaseBuilder<?, ?> baseBuilder, final KeyExchange keyExchange)
                throws UnsupportedConfigurationException {
        if (keyExchange != null) {
    ...
    private static List<KeyExchangeFactory> createKexFactories(
            final ImmutableMap<KeyExchangeAlgBase, KeyExchangeFactory> kexs, final List<KeyExchangeAlgBase> kexAlg)
                throws UnsupportedConfigurationException {
        // FIXME: cache these
    ...
    private static @NonNull KeyExchangeFactory kexFactoryOf(
            final ImmutableMap<KeyExchangeAlgBase, KeyExchangeFactory> kexs, final KeyExchangeAlgBase alg)
                throws UnsupportedConfigurationException {
