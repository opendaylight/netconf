...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.crypto.types.rev240316.AsymmetricKeyPairGrouping;
...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.crypto.types.rev240316.SshPublicKeyFormat;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.crypto.types.rev240316.SubjectPublicKeyInfoFormat;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.crypto.types.rev240316._private.key.grouping._private.key.type.CleartextPrivateKey;
...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.ssh.client.rev240316.ssh.client.grouping.server.authentication.SshHostKeys;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.ssh.common.rev240316.TransportParamsGrouping;
...
final class ConfigUtils {
    ...
    static List<KeyPair> extractServerHostKeys(
            final List<org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.ssh.server.rev240316
        ...
        for (var hostKey : serverHostKeys) {
            if (hostKey.getHostKeyType()
                    instanceof org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.ssh.server.rev240316
    ...
    static KeyPair extractKeyPair(
            final org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.keystore.rev240316
                    .inline.or.keystore.asymmetric.key.grouping.InlineOrKeystore input)
            throws UnsupportedConfigurationException {
        final var inline = ofType(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.keystore.rev240316
    ...
    static List<Certificate> extractCertificates(final @Nullable InlineOrTruststoreCertsGrouping input)
        ...
        final var inline = ofType(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.truststore
                        .rev240316.inline.or.truststore.certs.grouping.inline.or.truststore.Inline.class,
    ...
    static List<PublicKey> extractPublicKeys(
            final org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.truststore.rev240316
                    .inline.or.truststore._public.keys.grouping.InlineOrTruststore input)
            throws UnsupportedConfigurationException {
        final var inline = ofType(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.truststore.rev240316
