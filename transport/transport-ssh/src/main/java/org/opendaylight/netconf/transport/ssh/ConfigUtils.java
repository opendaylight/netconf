...
final class ConfigUtils {
    ...
    static KeyPair extractKeyPair(
            ...
            throws UnsupportedConfigurationException {
        final var local = ofType(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.keystore.rev230417
                .inline.or.keystore.asymmetric.key.grouping.inline.or.keystore.Inline.class, input);
        final var localDef = local.getInlineDefinition();
        if (localDef == null) {
    ...
    static List<PublicKey> extractPublicKeys(
            ...
            throws UnsupportedConfigurationException {
        final var local = ofType(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.truststore.rev230417
        ...
        final var publicKey = localDef.getPublicKey();
        if (publicKey == null) {
            return List.of();
        }
