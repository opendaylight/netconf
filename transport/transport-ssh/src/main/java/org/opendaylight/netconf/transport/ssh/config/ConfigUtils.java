...
public final class ConfigUtils {
    ...
    private static final float HEARTBEAT_COEFFICIENT = 0.9f;

    private ConfigUtils() {
        // utility class
    }

    public static void setTransportParams(final @NonNull ClientFactoryManager factoryMgr,
    ...
    public static void setTransportParams(final @NonNull ServerFactoryManager factoryMgr,
            final @Nullable TransportParamsGrouping params) throws UnsupportedConfigurationException {
        setTransportParams(factoryMgr, params, TransportUtils::getServerKexFactories);
    }

    private static void setTransportParams(final @NonNull FactoryManager factoryMgr,
    ...
    public static void setKeepAlives(final @NonNull ServerFactoryManager factoryMgr,
    ...
    public static void setKeepAlives(final @NonNull ClientFactoryManager factoryMgr,
    ...
    private static void setKeepAlives(final @NonNull FactoryManager factoryMgr, final @Nullable Uint16 cfgMaxWait,
        ...
        final var maxAttempts = ofNullable(cfgMaxAttempts).map(Uint8::intValue).orElse(KEEP_ALIVE_DEFAULT_ATTEMPTS);
        // FIXME utilize max attempts
        final var maxWait = ofNullable(cfgMaxWait).map(Uint16::intValue).orElse(KEEP_ALIVE_DEFAULT_MAX_WAIT);
        factoryMgr.setSessionHeartbeat(SessionHeartbeatController.HeartbeatType.RESERVED, Duration.ofSeconds(maxWait));
    }

    public static List<KeyPair> extractServerHostKeys(
    ...
    public static KeyPair extractKeyPair(
    ...
    public static List<Certificate> extractCertificates(@Nullable final LocalOrTruststoreCertsGrouping input)
            throws UnsupportedConfigurationException {
        if (input == null) {
            return List.of();
        }
    ...
    public static List<PublicKey> extractPublicKeys(
        ...
        if (localDef.getPublicKey().entrySet() != null) {
    ...
    public static List<PublicKey> extractPublicKeys(final @Nullable SshHostKeys sshHostKeys)
            throws UnsupportedConfigurationException {
