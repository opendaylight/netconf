...
public final class SSHServer extends SSHTransportStack {
    ...
    @VisibleForTesting
    @NonNull ListenableFuture<SSHServer> connect(final Bootstrap bootstrap,
            final TcpClientGrouping connectParams, TransportChannelListener<TransportChannel> listen)
            throws UnsupportedConfigurationException {
