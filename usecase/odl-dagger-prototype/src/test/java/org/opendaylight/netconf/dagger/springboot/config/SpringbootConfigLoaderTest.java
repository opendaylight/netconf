...
class SpringbootConfigLoaderTest {
    ...
    void loadYamlFileTest() {
        ...
        assertEquals(BIND_ADDRESS, alfaConfig.address);
    ...
    @Test
    void loadFlatMap() {
        final var flatConf = configLoader.getConfigPropertiesMap(DATASTORE_CONFIG);
        assertThat(flatConf)
            .hasSize(4)
    ...
    record Alfa(
        @Name("bindAddress") @DefaultValue("0.0.0.0") String address,
