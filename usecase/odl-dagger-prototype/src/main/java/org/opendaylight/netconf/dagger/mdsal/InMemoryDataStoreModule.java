...
public interface InMemoryDataStoreModule {
    ...
    @Provides
    @Singleton
    static @ConfigDataStore DOMStore configDatastore(final DOMSchemaService domSchemaService,
    ...
    @Provides
    @Singleton
    static @OperationalDataStore DOMStore operationalDatastore(final DOMSchemaService domSchemaService,
            final ConfigLoader configLoader, final ResourceSupport resourceSupport) {
