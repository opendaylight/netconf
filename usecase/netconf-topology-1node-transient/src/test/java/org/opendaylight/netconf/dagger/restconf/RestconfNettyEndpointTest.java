...
class RestconfNettyEndpointTest {
    ...
    /**
     * Verifies the integration between the Netty endpoint and NETCONF topology. This test mounts a NETCONF device
     * via a RESTCONF PUT request and polls the operational data tree to ensure the device connection status updates
     * to "connecting".
     *
     * @throws Exception if an error occurs during the HTTP request execution
     */
