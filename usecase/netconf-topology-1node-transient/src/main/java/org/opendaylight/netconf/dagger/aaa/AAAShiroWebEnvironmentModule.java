...
public interface AAAShiroWebEnvironmentModule {
    ...
    /**
     *  This class represents the <b>main</b> YANG schema list defined in module <b>aaa-app-config</b>.
     *  Configuration representing the main section of shiro.ini.
     *
     * @param pairKey The key.
    ...
    /**
     *  This class represents the <b>urls</b> YANG schema list defined in module <b>aaa-app-config</b>.
     *  Configuration representing the urls section of shiro.ini.
     *
     * @param pairKey The key.
     * @param pairValue The value.
     */
     ...
     * @param cipherSuitesRecords List of cipher suites records.
     */
    ...
    /**
     * This class represents the <b>cipher-suites</b> YANG schema list defined in module <b>aaa-cert</b>.
     *
     * @param suiteName Name.
     */
     ...
     *
     * @param name Keystore name default is truststore.
     * @param storePassword Keystore password.
     */
