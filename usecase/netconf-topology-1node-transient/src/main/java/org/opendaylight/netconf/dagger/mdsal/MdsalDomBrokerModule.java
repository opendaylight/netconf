...
public interface MdsalDomBrokerModule {
    ...
    @Provides
    static DOMSchemaService domSchemaService(@SchemaServiceContext final EffectiveModelContext effectiveModel) {
    ...
    @Provides
    @Singleton
    static DOMActionProviderService domActionProviderService(final DOMRpcRouter router) {
        return new RouterDOMActionProviderService(router);
    }

    @Provides
    @Singleton
    static DOMNotificationService domNotificationService(final DOMNotificationRouter notificationRouter) {
        return new RouterDOMNotificationService(notificationRouter);
    }

    @Provides
    @Singleton
    static DOMNotificationPublishService domNotificationPublishService(final DOMNotificationRouter notificationRouter) {
