...
public interface MdsalBindingDomAdapterModule {
    ...
    static ModuleInfoSnapshot getModuleInfos(@ClassPathYangModules final Set<YangModuleInfo> modelSet,
            final YangTextToIRSourceTransformer textToIR, final YangParserFactory yangParserFactory,
            final ResourceSupport resourceSupport) {
        final var snapshotResolver = new ModuleInfoSnapshotResolver("binding-dom-adapter", textToIR,
            yangParserFactory);
