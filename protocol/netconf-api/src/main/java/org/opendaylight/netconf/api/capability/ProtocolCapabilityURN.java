...
/**
 * String constants holding well-known {@link ProtocolCapability} URNs.
 */
@NonNullByDefault
public final class ProtocolCapabilityURN {
    /**
     ...
     */
    @Deprecated
    public static final String BASE_1_0 = "urn:ietf:params:netconf:base:1.0";
    /**
     * The base NETCONF capability, as defined in
     ...
     */
    public static final String TIME_1_0 = "urn:ietf:params:netconf:capability:time:1.0";
    /**
