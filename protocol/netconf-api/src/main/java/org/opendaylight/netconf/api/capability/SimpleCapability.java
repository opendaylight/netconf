...
public enum SimpleCapability implements Capability {
     ...
     */
    @Deprecated
    BASE_1_0(":base:1.0", CapabilityURN.BASE_1_0),
    /**
     * The base NETCONF capability, as defined in
     ...
     */
    TIME_1_0(":time:1.0", CapabilityURN.TIME_1_0),
    /**
    ...
    public static @Nullable SimpleCapability forURN(final String urn) {
        return switch (urn) {
            case CapabilityURN.BASE_1_0 -> BASE_1_0;
            ...
            case CapabilityURN.TIME_1_0 -> TIME_1_0;
