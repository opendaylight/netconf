...
public enum ProtocolCapability implements Capability {
    ...
    private final @NonNull String capabilityURN;

    ProtocolCapability(final String capabilityName, final String capabilityURN) {
        this.capabilityName = requireNonNull(capabilityName);
        this.capabilityURN = requireNonNull(capabilityURN);
    }
