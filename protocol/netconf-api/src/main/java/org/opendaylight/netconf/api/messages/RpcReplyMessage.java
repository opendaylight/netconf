...
public final class RpcReplyMessage extends NetconfMessage {
    public RpcReplyMessage(final Document document, final int messageId) {
        super(wrapRpcReply(document, messageId));
    }

    private static Document wrapRpcReply(final Document rpcContent, final int messageId) {
