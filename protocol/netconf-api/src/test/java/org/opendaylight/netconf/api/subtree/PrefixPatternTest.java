...
class PrefixPatternTest {
    ...
    void testExamples(final String prefix, final int index) {
        assertEquals(prefix, prefixOf(index));
    }
    ...
    private static List<Arguments> testExamples() {
        ...
        return List.of(Arguments.of("a", 0),
            ...
            // At index 16573 generated prefix will be "xml" - something that should be accounted for because it is
            // one of the reserved words in xml files. Same goes for "xmlns" but number for it is much bigger
