    ...
    private static List<Arguments> testExamples() {
        return List.of(
            ...
            Arguments.of("""
                ...
                .add(SelectionNode.builder(new Exact("http://example.com/schema/1.2/config", "top"))
                    .add(new AttributeMatch(new Exact(XMLNS_ATTRIBUTE_NS_URI, "xmlns"),
                        "http://example.com/schema/1.2/config")).build())
                .build()),
            ...
            Arguments.of("""
                ...
                .add(ContainmentNode.builder(new Exact("http://example.com/schema/1.2/config", "t:top"))
                    .add(new AttributeMatch(new Exact(XMLNS_ATTRIBUTE_NS_URI, "xmlns:t"),
