...
public abstract non-sealed class AbstractRestconfStreamReceiver implements RestconfStream.Receiver {
    private static final Logger LOG = LoggerFactory.getLogger(AbstractRestconfStreamReceiver.class);

    private final String subscriptionId;
    private final String receiverName;
    protected final AtomicLong sentEventCounter = new AtomicLong(0);
    protected final AtomicLong excludedEventCounter = new AtomicLong(0);
