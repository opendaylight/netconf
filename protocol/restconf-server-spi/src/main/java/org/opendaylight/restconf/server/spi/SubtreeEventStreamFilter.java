...
public final class SubtreeEventStreamFilter<T> extends AbstractRestconfStreamRegistry.EventStreamFilter<T> {
    ...
    @Override
    boolean matches(final EffectiveModelContext modelContext, final @NonNull T event) {
