...
abstract sealed class Subscriber<T> extends AbstractRegistration {
    ...
    static final class Rfc8639Subscriber<T> extends Subscriber<T> {
        ...
        public void replaceEventStreamFilter(final EventStreamFilter<T> newEventStreamFilter) {
            swapFilter(newEventStreamFilter);
        }
    ...
    protected final void swapFilter(final EventFilter<T> newFilter) {
