...
abstract sealed class Subscriber<T> extends AbstractRegistration {
    ...
    static final class Rfc8639Subscriber<T> extends Subscriber<T> {
        ...
        /**
         * Method try to send data if Receiver state is Active, otherwise data is not send.
         *
         ...
         *
         * <p>This is used for sending state notifications which are send regardless of state.
         *
         * @param data Data to send.
         */
