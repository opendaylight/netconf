...
abstract sealed class Subscriber<T> extends AbstractRegistration {
    ...
    static final class Rfc8639Subscriber<T> extends Subscriber<T> {
        ...
        public void eventStreamFilter(final EventStreamFilter<T> newEventStreamFilter) {
            setFilter(newEventStreamFilter);
        }
    ...
    void setFilter(final EventFilter<T> newFilter) {
