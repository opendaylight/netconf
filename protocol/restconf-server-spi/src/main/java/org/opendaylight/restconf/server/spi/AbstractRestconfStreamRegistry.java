...
public abstract class AbstractRestconfStreamRegistry implements RestconfStream.Registry {
    ...
    private final class ReceiverImpl extends AbstractSubscriptionReceiver {
        ...
        ReceiverImpl(final String name, final RestconfStream.ReceiverState state) {
            super(name, state);
        }
        ...
        @Override
        public ListenableFuture<Void> updateReceiver(long counter, final RestconfStream.FilteredRecordType recordType,
                final Uint32 id) {
            // TODO
            return null;
        }
