...
public abstract class AbstractRestconfStreamRegistry implements RestconfStream.Registry {
    ...
    @Override
    public void updateSubscriptionState(final Subscription subscription, final SubscriptionState nextState) {
        requireNonNull(subscription);
        subscription.setState(moveState(subscription.state(), nextState));
