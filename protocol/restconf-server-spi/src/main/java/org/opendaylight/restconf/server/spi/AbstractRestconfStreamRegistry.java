...
public abstract class AbstractRestconfStreamRegistry implements RestconfStream.Registry {
    ...
    private final class SubscriptionImpl extends AbstractRestconfStreamSubscription {
        SubscriptionImpl(final Uint32 id, final QName encoding, final String streamName, final RestconfStream.Receiver receiver,
    ...
    private final class ReceiverImpl extends AbstractRestconfStreamReceiver {
        ReceiverImpl(String subscriptionId, String receiverName, RestconfStream.Registry streamRegistry) {
