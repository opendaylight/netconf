...
public abstract class AbstractRestconfStreamRegistry implements RestconfStream.Registry {
    ...
    public final <T> void createStream(final ServerRequest<RestconfStream<T>> request, final URI restconfURI,
        ...
        final URI baseStreamLocation;
        try {
            baseStreamLocation = baseStreamLocation(restconfURI);
     ...
     * @throws URISyntaxException if the result would have been malformed
     */
    protected abstract @NonNull URI baseStreamLocation(URI restconfURI) throws URISyntaxException;
