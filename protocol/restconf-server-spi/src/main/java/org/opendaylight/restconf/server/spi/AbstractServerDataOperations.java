...
public abstract class AbstractServerDataOperations implements ServerDataOperations {
    ...
    /**
     * Get parent path only if existed.
     *
     * @param data {@link Data}
     * @return parent {@link Data}
     * @throws VerifyException  if this parent path is null;
     */
    protected static Data getConceptualParent(final Data data) {
        final var parentPath = data.instance().coerceParent();
        return data.enterPath(parentPath);
    }
}
