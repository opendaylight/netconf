...
public final class RestconfStream<T> {
    ...
    public abstract static class Sink<T> {
        ...
        private ConcurrentMap<Uint32, String> receiverNames = new ConcurrentHashMap<>();
        private ConcurrentMap<Uint32, AtomicLong> sentEventRecords = new ConcurrentHashMap<>();
        private ConcurrentMap<Uint32, AtomicLong> excludedEventRecords = new ConcurrentHashMap<>();
