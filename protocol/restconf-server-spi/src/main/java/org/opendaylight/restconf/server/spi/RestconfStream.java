...
public final class RestconfStream<T> {
    ...
    public interface Registry {
        ...
        /**
         * Updates the counter value for a specific receiver in the operational datastore.
         *
         * <p>This method writes an updated counter (for example, the sent-event-records or excluded-event-records
         * value) for the receiver identified by the provided {@code ReceiverHolder}. The type of counter to update
         * is specified by the {@code recordType} parameter. The update is performed on the operational datastore via
         * a merge operation, and the method returns a {@link ListenableFuture} that completes when the commit
         * succeeds or fails.
         *
         ...
         */
        ListenableFuture<Void> updateReceiver(ReceiverHolder receiver, ReceiverHolder.RecordType recordType);
    }
