...
public final class RestconfStream<T> {
    ...
    public sealed interface Receiver permits AbstractSubscriptionReceiver, ForwardingSubscriptionReceiver {
         ...
         */
        ListenableFuture<Void> updateReceiver(long counter, final FilteredRecordType recordType, final Uint32 id);
