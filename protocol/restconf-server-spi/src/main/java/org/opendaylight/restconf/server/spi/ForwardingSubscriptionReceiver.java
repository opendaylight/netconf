...
public abstract non-sealed class ForwardingSubscriptionReceiver<T extends RestconfStream.Receiver>
        implements RestconfStream.Receiver {
    ...
    public void updateSentEventRecord(Uint32 id) {
        delegate.updateSentEventRecord(id);
    }

    @Override
    public void updateExcludedEventRecord(Uint32 id) {
        delegate.updateExcludedEventRecord(id);
    }
