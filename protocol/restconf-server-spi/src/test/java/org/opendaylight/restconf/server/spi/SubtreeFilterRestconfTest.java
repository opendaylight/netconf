...
class SubtreeFilterRestconfTest {
    ...
    void testFilterNotification() {
        ...
        final var filterQname = QName.create("urn:ietf:params:xml:ns:netconf:notification:1.0", "filter");
        final var typeQname = QName.create(filterQname, "type");
        ...
        final var filterNode = ImmutableNodes.newContainerBuilder()
            ...
            .withChild(ImmutableNodes.leafNode(typeQname, "subtree"))
