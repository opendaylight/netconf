...
class MdsalFieldsParamTest extends AbstractFieldsTranslatorTest {
    ...
    void testSimplePath() throws Exception {
        final var result = NormalizedNodeWriter.translateFieldsParam(JUKEBOX_SCHEMA, jukeboxSchemaNode, assertFields("library"));
    ...
    void testDoublePath() throws Exception {
        final var result = NormalizedNodeWriter.translateFieldsParam(JUKEBOX_SCHEMA, jukeboxSchemaNode, assertFields("library;player"));
        assertNotNull(result);
        assertEquals(1, result.size());
    ...
    void testSubPath() throws Exception {
        final var result = NormalizedNodeWriter.translateFieldsParam(JUKEBOX_SCHEMA, jukeboxSchemaNode, assertFields("library/artist/album/name"));
        assertNotNull(result);
    ...
    void testNamespace() throws Exception {
        final var result = NormalizedNodeWriter.translateFieldsParam(JUKEBOX_SCHEMA, jukeboxSchemaNode, assertFields("augmented-jukebox:augmented-library"));
        assertNotNull(result);
        assertEquals(1, result.size());
    ...
    void testMultipleChildren1() throws Exception {
        final var result = NormalizedNodeWriter.translateFieldsParam(TEST_SERVICES_SCHEMA, testServices, assertFields("services(type-of-service;instance/instance-name;instance/provider)"));
        assertNotNull(result);
    ...
    void testMultipleChildren2() throws Exception {
        final var result = NormalizedNodeWriter.translateFieldsParam(TEST_SERVICES_SCHEMA, testServices, assertFields("services(type-of-service;instance(instance-name;provider))"));
        assertNotNull(result);
        assertEquals(3, result.size());
        assertEquals(Set.of(SERVICES_Q_NAME), result.get(0));
        assertEquals(Set.of(TYPE_OF_SERVICE_Q_NAME, INSTANCE_Q_NAME), result.get(1));
    ...
    void testMultipleChildren3() throws Exception {
        final var result = NormalizedNodeWriter.translateFieldsParam(TEST_SERVICES_SCHEMA, testServices, assertFields("services(instance/instance-name;type-of-service;next-data/next-service)"));
        assertNotNull(result);
        assertEquals(3, result.size());
        assertEquals(Set.of(SERVICES_Q_NAME), result.get(0));
    ...
    void testMultipleChildren4() throws Exception {
        final var result = NormalizedNodeWriter.translateFieldsParam(TEST_SERVICES_SCHEMA, testServices, assertFields("services(type-of-service;instance(instance-name;provider);next-data(next-service))"));
        assertNotNull(result);
        assertEquals(3, result.size());
        assertEquals(Set.of(SERVICES_Q_NAME), result.get(0));
        assertEquals(Set.of(TYPE_OF_SERVICE_Q_NAME, INSTANCE_Q_NAME, NEXT_DATA_Q_NAME), result.get(1));
    ...
    void testAugmentedChild() throws Exception {
        final var result = NormalizedNodeWriter.translateFieldsParam(JUKEBOX_SCHEMA, jukeboxSchemaNode, assertFields("player/augmented-jukebox:speed"));
        assertNotNull(result);
    ...
    void testListFieldUnderList() throws Exception {
        final var result = NormalizedNodeWriter.translateFieldsParam(TEST_SERVICES_SCHEMA, testServices, assertFields("services/instance"));
        assertNotNull(result);
        assertEquals(2, result.size());
        assertEquals(Set.of(SERVICES_Q_NAME), result.get(0));
    ...
    void testLeafList() throws Exception {
        final var result = NormalizedNodeWriter.translateFieldsParam(TEST_SERVICES_SCHEMA, testServices, assertFields("protocols"));
        assertNotNull(result);
        assertEquals(1, result.size());
    ...
    void testKeyedList() throws Exception {
        final var result = NormalizedNodeWriter.translateFieldsParam(JUKEBOX_SCHEMA, jukeboxSchemaNode, assertFields("library/artist(name)"));
        assertNotNull(result);
        assertEquals(3, result.size());
        assertEquals(Set.of(LIBRARY_QNAME), result.get(0));
        assertEquals(Set.of(ARTIST_QNAME), result.get(1));
    ...
    void testDuplicateNodes1() throws Exception {
        final var result = NormalizedNodeWriter.translateFieldsParam(FOO_SCHEMA, foo, assertFields("bar(alpha;beta/gamma);baz(alpha;beta/gamma)"));
        assertNotNull(result);
        assertEquals(3, result.size());
    ...
    void testDuplicateNodes2() throws Exception {
        final var result = NormalizedNodeWriter.translateFieldsParam(FOO_SCHEMA, foo, assertFields("bar(alpha;beta/delta);baz(alpha;beta/epsilon)"));
        assertNotNull(result);
        assertEquals(3, result.size());
        assertEquals(Set.of(BAR_Q_NAME, BAZ_Q_NAME), result.get(0));
        assertEquals(Set.of(ALPHA_Q_NAME, BETA_Q_NAME), result.get(1));
    ...
    void testMissingChildSchema() {
        ...
        final var ex = assertThrows(RequestException.class,
            () -> NormalizedNodeWriter.translateFieldsParam(JUKEBOX_SCHEMA, jukeboxSchemaNode, input));
        // Bad request
