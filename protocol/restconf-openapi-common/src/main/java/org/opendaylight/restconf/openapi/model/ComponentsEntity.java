...
public final class ComponentsEntity extends OpenApiEntity {
    ...
    private static final String OAUTH2_FLOW = "authorizationCode";
    ...
    public ComponentsEntity(final EffectiveModelContext modelContext, final Collection<? extends Module> modules,
        ...
        final var schemes = new HashMap<String, SecuritySchemeObject>();
        schemes.put(BASIC_AUTH_NAME, OPEN_API_BASIC_AUTH);
        if (oauth2Config != null) {
            schemes.put(OAUTH2_NAME, new Oauth2(OAUTH2_FLOW, oauth2Config.authorizationUrl(), oauth2Config.tokenUrl(),
                oauth2Config.refreshUrl()));
        }
