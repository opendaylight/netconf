...
abstract class AbstractDocumentTest {
    ...
    protected static String getDocByModule(final String moduleName, final String revision) throws Exception {
        ...
        return assertOpenApiEntity(openApiService.getDocByModule(moduleName, revision, new URI(uri), 0, 0, null, null));
    }
    ...
    protected static String getMountDocByModule(final String moduleName, final String revision,
            final String forwardedHeader, final String forwardedProtoHeader) throws Exception {
        return assertOpenApiEntity(openApiService.getMountDocByModule(1, moduleName, revision,
            new URI(URI + "mounts/1/" + moduleName), 0, 0, forwardedHeader, forwardedProtoHeader));
    }
