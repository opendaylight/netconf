...
public class NC1438Test extends AbstractRestconfTest {
        ...
        assertFormat("""
            ...
            <errors xmlns="urn:ietf:params:xml:ns:yang:ietf-restconf">
              <error>
                ...
                <error-message>Missing required field (urn:ietf:params:xml:ns:yang:ietf-yang-patch?revision=2017-02-22)edit-id</error-message>
        ...
        assertFormat("""
            {
              "errors": {
                "error": [
                  {
                    "error-tag": "malformed-message",
                    "error-message": "Missing required field (urn:ietf:params:xml:ns:yang:ietf-yang-patch?revision=2017-02-22)edit-id",
                    "error-type": "application"
                  }
                ]
              }
    ...
    void testXmlPatchMissingPatchIdData() {
        ...
        assertFormat("""
            ...
            <errors xmlns="urn:ietf:params:xml:ns:yang:ietf-restconf">
              <error>
                <error-type>application</error-type>
                <error-message>Missing required field (urn:ietf:params:xml:ns:yang:ietf-yang-patch?revision=2017-02-22)patch-id</error-message>
                <error-tag>malformed-message</error-tag>
              </error>
            </errors>
            """, body::formatToXML, true);
        ...
        assertFormat("""
            {
              "errors": {
                "error": [
                  {
                    "error-tag": "malformed-message",
                    "error-message": "Missing required field (urn:ietf:params:xml:ns:yang:ietf-yang-patch?revision=2017-02-22)patch-id",
                    "error-type": "application"
                  }
                ]
              }
    ...
    void testXmlPatchMissingOperation() {
        ...
        assertFormat("""
            ...
            <errors xmlns="urn:ietf:params:xml:ns:yang:ietf-restconf">
              <error>
                <error-type>application</error-type>
                <error-message>Missing required field (urn:ietf:params:xml:ns:yang:ietf-yang-patch?revision=2017-02-22)operation</error-message>
                <error-tag>malformed-message</error-tag>
              </error>
            </errors>
            """, body::formatToXML, true);
        ...
        assertFormat("""
            {
              "errors": {
                "error": [
                  {
                    "error-tag": "malformed-message",
                    "error-message": "Missing required field (urn:ietf:params:xml:ns:yang:ietf-yang-patch?revision=2017-02-22)operation",
                    "error-type": "application"
                  }
                ]
              }
    ...
    void testXmlPatchMissingTarget() {
        ...
        assertFormat("""
            ...
            <errors xmlns="urn:ietf:params:xml:ns:yang:ietf-restconf">
              <error>
                <error-type>application</error-type>
                <error-message>Missing required field (urn:ietf:params:xml:ns:yang:ietf-yang-patch?revision=2017-02-22)target</error-message>
                <error-tag>malformed-message</error-tag>
              </error>
            </errors>
            """, body::formatToXML, true);
        ...
        assertFormat("""
            {
              "errors": {
                "error": [
                  {
                    "error-tag": "malformed-message",
                    "error-message": "Missing required field (urn:ietf:params:xml:ns:yang:ietf-yang-patch?revision=2017-02-22)target",
                    "error-type": "application"
                  }
                ]
              }
    ...
    void tesXmltPatchWithMissingValue() {
        ...
        assertFormat("""
            ...
            <errors xmlns="urn:ietf:params:xml:ns:yang:ietf-restconf">
              <error>
                <error-type>application</error-type>
                <error-message>Provided 'operation' value Create requires (urn:ietf:params:xml:ns:yang:ietf-yang-patch?revision=2017-02-22)value field</error-message>
                <error-tag>malformed-message</error-tag>
              </error>
            </errors>
            """, body::formatToXML, true);
        ...
        assertFormat("""
            {
              "errors": {
                "error": [
                  {
                    "error-tag": "malformed-message",
                    "error-message": "Provided 'operation' value Create requires (urn:ietf:params:xml:ns:yang:ietf-yang-patch?revision=2017-02-22)value field",
                    "error-type": "application"
                  }
                ]
              }
    ...
    void testXmlPatchWithRequiredEmptyValue() {
        ...
        assertFormat("""
            ...
            <errors xmlns="urn:ietf:params:xml:ns:yang:ietf-restconf">
              <error>
                <error-type>application</error-type>
                <error-message>Provided 'operation' value Delete can not have (urn:ietf:params:xml:ns:yang:ietf-yang-patch?revision=2017-02-22)value field</error-message>
                <error-tag>malformed-message</error-tag>
              </error>
            </errors>
            """, body::formatToXML, true);
        ...
        assertFormat("""
            {
              "errors": {
                "error": [
                  {
                    "error-tag": "malformed-message",
                    "error-message": "Provided 'operation' value Delete can not have (urn:ietf:params:xml:ns:yang:ietf-yang-patch?revision=2017-02-22)value field",
                    "error-type": "application"
                  }
                ]
              }
    ...
    void testXmlPatchWrongOperationData() {
        ...
        assertFormat("""
            ...
            <errors xmlns="urn:ietf:params:xml:ns:yang:ietf-restconf">
              <error>
                <error-type>application</error-type>
                <error-message>"WRONG" is not a valid name</error-message>
                <error-tag>malformed-message</error-tag>
              </error>
            </errors>
            """, body::formatToXML, true);
        ...
        assertFormat("""
            {
              "errors": {
                "error": [
                  {
                    "error-tag": "malformed-message",
                    "error-message": "Provided unknown field (urn:ietf:params:xml:ns:yang:ietf-yang-patch?revision=2017-02-22)wrong",
                    "error-type": "application"
                  }
                ]
              }
    ...
    void testPatchEmptyValue() {
        ...
        final var message = body.errors().getFirst().message();
        assertNotNull(message);
        assertThat(message.elementBody(), matchesPattern(expectedStringPattern));
        final var type = body.errors().getFirst().type();
        assertNotNull(type);
    ...
    void testXmlPatchEmptyValue() {
        ...
        assertFormat("""
            ...
            <errors xmlns="urn:ietf:params:xml:ns:yang:ietf-restconf">
              <error>
                <error-type>application</error-type>
                <error-message>Empty 'value' field is not allowed</error-message>
                <error-tag>malformed-message</error-tag>
              </error>
            </errors>
            """, body::formatToXML, true);
        ...
        assertFormat("""
            {
              "errors": {
                "error": [
                  {
                    "error-tag": "malformed-message",
                    "error-message": "Empty 'value' field is not allowed",
                    "error-type": "application"
                  }
                ]
              }
