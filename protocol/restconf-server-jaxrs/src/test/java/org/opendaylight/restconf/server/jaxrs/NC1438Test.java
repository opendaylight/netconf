    ...
    void tesXmltPatchWithMissingValue() {
        ...
        assertFormat("""
            ...
            <errors xmlns="urn:ietf:params:xml:ns:yang:ietf-restconf">
              <error>
                <error-type>application</error-type>
                <error-message>Provided 'operation' value Create requires (urn:ietf:params:xml:ns:yang:ietf-yang-patch?revision=2017-02-22)value element</error-message>
                <error-tag>malformed-message</error-tag>
              </error>
            </errors>
            """, body::formatToXML, true);
        ...
        assertFormat("""
            {
              "errors": {
                "error": [
                  {
                    "error-tag": "malformed-message",
                    "error-message": "Provided 'operation' value Create requires (urn:ietf:params:xml:ns:yang:ietf-yang-patch?revision=2017-02-22)value element",
                    "error-type": "application"
                  }
                ]
              }
    ...
    void testXmlPatchWithRequiredEmptyValue() {
        ...
        assertFormat("""
            ...
            <errors xmlns="urn:ietf:params:xml:ns:yang:ietf-restconf">
              <error>
                <error-type>application</error-type>
                <error-message>Provided 'operation' value Delete can not have (urn:ietf:params:xml:ns:yang:ietf-yang-patch?revision=2017-02-22)value element</error-message>
                <error-tag>malformed-message</error-tag>
              </error>
            </errors>
            """, body::formatToXML, true);
        ...
        assertFormat("""
            {
              "errors": {
                "error": [
                  {
                    "error-tag": "malformed-message",
                    "error-message": "Provided 'operation' value Delete can not have (urn:ietf:params:xml:ns:yang:ietf-yang-patch?revision=2017-02-22)value element",
                    "error-type": "application"
                  }
                ]
              }
        ...
        assertFormat("""
            {
              "errors": {
                "error": [
                  {
                    "error-tag": "malformed-message",
                    "error-message": "Provided unknown element (urn:ietf:params:xml:ns:yang:ietf-yang-patch?revision=2017-02-22)wrong",
                    "error-type": "application"
                  }
                ]
              }
