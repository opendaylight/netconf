...
public final class JaxRsRestconf implements ParamConverterProvider {
    ...
    private static final @NonNull ServerEncoding DEFAULT_REQUEST_ENCODING = JaxRsServerEncoding.JSON;
    ...
    public void dataJsonGET(@Context final UriInfo uriInfo, final @Context SecurityContext sc,
            @Suspended final AsyncResponse ar) {
        server.dataGET(newDataGet(JaxRsServerEncoding.JSON, uriInfo, sc, ar));
    }
    ...
    public void dataJsonGET(@Encoded @PathParam("identifier") final ApiPath identifier, @Context final UriInfo uriInfo,
        ...
        server.dataGET(newDataGet(JaxRsServerEncoding.JSON, uriInfo, sc, ar), identifier);
    }
    ...
    public void dataXmlGET(@Context final UriInfo uriInfo, final @Context SecurityContext sc,
            @Suspended final AsyncResponse ar) {
        server.dataGET(newDataGet(JaxRsServerEncoding.XML, uriInfo, sc, ar));
    }
    ...
    public void dataXmlGET(@Encoded @PathParam("identifier") final ApiPath identifier, @Context final UriInfo uriInfo,
            @Context final SecurityContext sc, @Suspended final AsyncResponse ar) {
        server.dataGET(newDataGet(JaxRsServerEncoding.XML, uriInfo, sc, ar), identifier);
    }

    @NonNullByDefault
    private JaxRsServerRequest<DataGetResult> newDataGet(final ServerEncoding requestEncoding, final UriInfo uriInfo,
    ...
    public void dataXmlPATCH(final InputStream body, final @Context SecurityContext sc,
        ...
        try (var xmlBody = new XmlResourceBody(body)) {
            server.dataPATCH(newDataPATCH(JaxRsServerEncoding.JSON, sc, ar), xmlBody);
        }
    }
    ...
    public void dataXmlPATCH(@Encoded @PathParam("identifier") final ApiPath identifier, final InputStream body,
            final @Context SecurityContext sc, @Suspended final AsyncResponse ar) {
        try (var xmlBody = new XmlResourceBody(body)) {
            server.dataPATCH(newDataPATCH(JaxRsServerEncoding.XML, sc, ar), identifier, xmlBody);
        }
    }
    ...
    public void dataJsonPATCH(final InputStream body, final @Context SecurityContext sc,
        ...
        try (var jsonBody = new JsonResourceBody(body)) {
            server.dataPATCH(newDataPATCH(JaxRsServerEncoding.JSON, sc, ar), jsonBody);
        }
    }
    ...
    public void dataJsonPATCH(@Encoded @PathParam("identifier") final ApiPath identifier, final InputStream body,
            final @Context SecurityContext sc, @Suspended final AsyncResponse ar) {
        try (var jsonBody = new JsonResourceBody(body)) {
            server.dataPATCH(newDataPATCH(JaxRsServerEncoding.JSON, sc, ar), identifier, jsonBody);
        }
    }

    @NonNullByDefault
    private JaxRsServerRequest<DataPatchResult> newDataPATCH(final ServerEncoding requestEncoding,
            final SecurityContext sc, final AsyncResponse ar) {
    ...
    public void dataYangJsonPATCH(final InputStream body, @Context final UriInfo uriInfo,
        ...
        try (var jsonBody = new JsonPatchBody(body)) {
            server.dataPATCH(newDataYangPATCH(JaxRsServerEncoding.JSON, uriInfo, sc, ar), jsonBody);
        }
    }
    ...
    public void dataYangJsonPATCH(@Encoded @PathParam("identifier") final ApiPath identifier, final InputStream body,
        ...
        try (var jsonBody = new JsonPatchBody(body)) {
            server.dataPATCH(newDataYangPATCH(JaxRsServerEncoding.JSON, uriInfo, sc, ar), identifier, jsonBody);
        }
    }
    ...
    public void dataYangXmlPATCH(final InputStream body, @Context final UriInfo uriInfo,
        ...
        try (var xmlBody = new XmlPatchBody(body)) {
            server.dataPATCH(newDataYangPATCH(JaxRsServerEncoding.XML, uriInfo, sc, ar), xmlBody);
        }
    }
    ...
    public void dataYangXmlPATCH(@Encoded @PathParam("identifier") final ApiPath identifier, final InputStream body,
            @Context final UriInfo uriInfo, final @Context SecurityContext sc, @Suspended final AsyncResponse ar) {
        try (var xmlBody = new XmlPatchBody(body)) {
            server.dataPATCH(newDataYangPATCH(JaxRsServerEncoding.XML, uriInfo, sc, ar), identifier, xmlBody);
        }
    }

    @NonNullByDefault
    private JaxRsServerRequest<DataYangPatchResult> newDataYangPATCH(final ServerEncoding requestEncoding,
    ...
    public void postDataJSON(final InputStream body, @Context final UriInfo uriInfo, final @Context SecurityContext sc,
        ...
        try (var jsonBody = new JsonChildBody(body)) {
            server.dataPOST(newDataPOST(JaxRsServerEncoding.JSON, uriInfo, sc, ar), jsonBody);
        }
    }
    ...
    public void postDataJSON(@Encoded @PathParam("identifier") final ApiPath identifier, final InputStream body,
            @Context final UriInfo uriInfo, final @Context SecurityContext sc, @Suspended final AsyncResponse ar) {
        server.dataPOST(newDataPOST(JaxRsServerEncoding.JSON, uriInfo, sc, ar), identifier, new JsonDataPostBody(body));
    }
    ...
    public void postDataXML(final InputStream body, @Context final UriInfo uriInfo, final @Context SecurityContext sc,
        ...
        try (var xmlBody = new XmlChildBody(body)) {
            server.dataPOST(newDataPOST(JaxRsServerEncoding.XML, uriInfo, sc, ar), xmlBody);
        }
    }
    ...
    public void postDataXML(@Encoded @PathParam("identifier") final ApiPath identifier, final InputStream body,
            @Context final UriInfo uriInfo, final @Context SecurityContext sc, @Suspended final AsyncResponse ar) {
        server.dataPOST(newDataPOST(JaxRsServerEncoding.XML, uriInfo, sc, ar), identifier, new XmlDataPostBody(body));
    }

    @NonNullByDefault
    private <T extends DataPostResult> JaxRsServerRequest<T> newDataPOST(final ServerEncoding requestEncoding,
            final UriInfo uriInfo, final SecurityContext sc, final AsyncResponse ar) {
        return new JaxRsServerRequest<>(prettyPrint, errorTagMapping, requestEncoding, sc, ar, uriInfo) {
            @Override
    ...
    public void dataJsonPUT(@Context final UriInfo uriInfo, final @Context SecurityContext sc, final InputStream body,
            @Suspended final AsyncResponse ar) {
        try (var jsonBody = new JsonResourceBody(body)) {
            server.dataPUT(newDataPUT(JaxRsServerEncoding.JSON, uriInfo, sc, ar), jsonBody);
        }
    }
    ...
    public void dataJsonPUT(@Encoded @PathParam("identifier") final ApiPath identifier, @Context final UriInfo uriInfo,
        ...
        try (var jsonBody = new JsonResourceBody(body)) {
            server.dataPUT(newDataPUT(JaxRsServerEncoding.JSON, uriInfo, sc, ar), identifier, jsonBody);
        }
    }
    ...
    public void dataXmlPUT(@Context final UriInfo uriInfo, final @Context SecurityContext sc, final InputStream body,
            @Suspended final AsyncResponse ar) {
        try (var xmlBody = new XmlResourceBody(body)) {
            server.dataPUT(newDataPUT(JaxRsServerEncoding.XML, uriInfo, sc, ar), xmlBody);
        }
    }
    ...
    public void dataXmlPUT(@Encoded @PathParam("identifier") final ApiPath identifier, @Context final UriInfo uriInfo,
            final @Context SecurityContext sc, final InputStream body, @Suspended final AsyncResponse ar) {
        try (var xmlBody = new XmlResourceBody(body)) {
            server.dataPUT(newDataPUT(JaxRsServerEncoding.XML, uriInfo, sc, ar), identifier, xmlBody);
        }
    }

    @NonNullByDefault
    private JaxRsServerRequest<DataPutResult> newDataPUT(final ServerEncoding requestEncoding, final UriInfo uriInfo,
            final SecurityContext sc, final AsyncResponse ar) {
        return new JaxRsServerRequest<>(prettyPrint, errorTagMapping, requestEncoding, sc, ar, uriInfo) {
            @Override
    ...
    public void operationsJsonGET(final @Context SecurityContext sc, @Suspended final AsyncResponse ar) {
        server.operationsGET(new FormattableJaxRsServerRequest(prettyPrint, errorTagMapping, JaxRsServerEncoding.JSON,
            sc, ar));
    }
    ...
    public void operationsJsonGET(@PathParam("operation") final ApiPath operation, final @Context SecurityContext sc,
            @Suspended final AsyncResponse ar) {
        server.operationsGET(
            new FormattableJaxRsServerRequest(prettyPrint, errorTagMapping, JaxRsServerEncoding.JSON, sc, ar),
            operation);
    }
    ...
    public void operationsXmlGET(final @Context SecurityContext sc, @Suspended final AsyncResponse ar) {
        server.operationsGET(
            new FormattableJaxRsServerRequest(prettyPrint, errorTagMapping, JaxRsServerEncoding.XML, sc, ar));
    }
    ...
    public void operationsXmlGET(@PathParam("operation") final ApiPath operation, final @Context SecurityContext sc,
            @Suspended final AsyncResponse ar) {
        server.operationsGET(
            new FormattableJaxRsServerRequest(prettyPrint, errorTagMapping, JaxRsServerEncoding.XML, sc, ar),
            operation);
    ...
    public void operationsXmlPOST(@Encoded @PathParam("identifier") final ApiPath identifier, final InputStream body,
        ...
        try (var xmlBody = new XmlOperationInputBody(body)) {
            operationsPOST(JaxRsServerEncoding.XML, identifier, uriInfo, sc, ar, xmlBody);
        }
    }
    ...
    public void operationsJsonPOST(@Encoded @PathParam("identifier") final ApiPath identifier, final InputStream body,
        ...
        try (var jsonBody = new JsonOperationInputBody(body)) {
            operationsPOST(JaxRsServerEncoding.JSON, identifier, uriInfo, sc, ar, jsonBody);
        }
    }

    @NonNullByDefault
    private void operationsPOST(final ServerEncoding requestEncoding, final ApiPath identifier, final UriInfo uriInfo,
    ...
    public void yangLibraryVersionGETJ(final @Context SecurityContext sc, @Suspended final AsyncResponse ar) {
        server.yangLibraryVersionGET(
            new FormattableJaxRsServerRequest(prettyPrint, errorTagMapping, JaxRsServerEncoding.JSON, sc, ar));
    }
    ...
    public void yangLibraryVersionGETX(final @Context SecurityContext sc, @Suspended final AsyncResponse ar) {
        server.yangLibraryVersionGET(
            new FormattableJaxRsServerRequest(prettyPrint, errorTagMapping, JaxRsServerEncoding.XML, sc, ar));
    }
    ...
    public void modulesYangGET(@PathParam("fileName") final String fileName,
            ...
            @Suspended final AsyncResponse ar) {
        server.modulesYangGET(newModulesGET(JaxRsServerEncoding.JSON, sc, ar), fileName, revision);
    }
    ...
    public void modulesYangGET(@Encoded @PathParam("mountPath") final ApiPath mountPath,
            ...
            final @Context SecurityContext sc, @Suspended final AsyncResponse ar) {
        server.modulesYangGET(newModulesGET(JaxRsServerEncoding.JSON, sc, ar), mountPath, fileName, revision);
    }
    ...
    public void modulesYinGET(@PathParam("fileName") final String fileName,
            @QueryParam("revision") final String revision, final @Context SecurityContext sc,
            @Suspended final AsyncResponse ar) {
        server.modulesYinGET(newModulesGET(JaxRsServerEncoding.XML, sc, ar), fileName, revision);
    }
    ...
    public void modulesYinGET(@Encoded @PathParam("mountPath") final ApiPath mountPath,
            @PathParam("fileName") final String fileName, @QueryParam("revision") final String revision,
            final @Context SecurityContext sc, @Suspended final AsyncResponse ar) {
        server.modulesYinGET(newModulesGET(JaxRsServerEncoding.XML, sc, ar), mountPath, fileName, revision);
    }
    ...
    @NonNullByDefault
    private JaxRsServerRequest<ModulesGetResult> newModulesGET(final ServerEncoding requestEncoding,
            final SecurityContext sc, final AsyncResponse ar) {
        return new JaxRsServerRequest<>(prettyPrint, errorTagMapping, requestEncoding, sc, ar) {
            @Override
