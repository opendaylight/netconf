            ...
            Arguments.of("""
                <filter type="subtree">
                  <top xmlns="http://example.com/schema/1.2/config"/>
                    ...
                    .add(SelectionNode.builder(createSelection(NAMESPACE, "top"))
                        .build()).build()),
            ...
            Arguments.of("""
                <filter type="subtree">
                  <t:top xmlns:t="http://example.com/schema/1.2/config">
                    ...
                    .add(ContainmentNode.builder(createSelection(NAMESPACE, "top"))
                        .add(ContainmentNode.builder(createSelection(NAMESPACE, "interfaces"))
                            .add(SelectionNode.builder(createSelection(NAMESPACE, "interface"))
            ...
            Arguments.of("""
                <filter type="subtree">
                  <top xmlns="http://example.com/schema/1.2/config">
                    ...
                    .add(ContainmentNode.builder(createSelection(NAMESPACE, "top"))
                        .add(SelectionNode.builder(createSelection(NAMESPACE, "users"))
                            .build())
                        .build()).build()),
            ...
            Arguments.of("""
                <filter type="subtree">
                  <top xmlns="http://example.com/schema/1.2/config">
                    ...
                    .add(ContainmentNode.builder(createSelection(NAMESPACE, "top"))
                        .add(ContainmentNode.builder(createSelection(NAMESPACE, "users"))
                            .add(ContainmentNode.builder(createSelection(NAMESPACE, "user"))
                                .add(new ContentMatchNode(createSelection(NAMESPACE, "name"), "fred"))
                                    .build()).build()).build()).build())
...
//                        .build()).build())
    ...
    private static NamespaceSelection createSelection(final String namespace, final String name) {
        if (namespace != null) {
