            ...
            Arguments.of("""
                <filter type="subtree">
                  <top xmlns="http://example.com/schema/1.2/config"/>
                    ...
                    .add(SelectionNode.builder(new Exact(QName.create(NAMESPACE, "top")))
                        .build()).build()),
            ...
            Arguments.of("""
                <filter type="subtree">
                  <t:top xmlns:t="http://example.com/schema/1.2/config">
                    ...
                    .add(ContainmentNode.builder(new Exact(QName.create(NAMESPACE, "top")))
                        .add(ContainmentNode.builder(new Exact(QName.create(NAMESPACE, "interfaces")))
                            .add(SelectionNode.builder(new Exact(QName.create(NAMESPACE, "interface")))
            ...
            Arguments.of("""
                <filter type="subtree">
                  <top xmlns="http://example.com/schema/1.2/config">
                    ...
                    .add(ContainmentNode.builder(new Exact(QName.create(NAMESPACE, "top")))
                        .add(SelectionNode.builder(new Exact(QName.create(NAMESPACE, "users")))
                            .build())
                        .build()).build()),
            ...
            Arguments.of("""
                <filter type="subtree">
                  <top xmlns="http://example.com/schema/1.2/config">
                    ...
                    .add(ContainmentNode.builder(new Exact(QName.create(NAMESPACE, "top")))
                        .add(ContainmentNode.builder(new Exact(QName.create(NAMESPACE, "users")))
                            .add(ContainmentNode.builder(new Exact(QName.create(NAMESPACE, "user")))
                                .add(new ContentMatchNode(new Exact(QName.create(NAMESPACE, "name")), "fred"))
                                    .build()).build()).build()).build())
