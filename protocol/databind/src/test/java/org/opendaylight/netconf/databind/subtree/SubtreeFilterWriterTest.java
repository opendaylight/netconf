...
class SubtreeFilterWriterTest {
    ...
    private static final NodeIdentifier COMPANY_INFO_ID = NodeIdentifier.create(
        QName.create(NAMESPACE, "company-info"));
        ...
        return List.of(
                ...
                .add(ContainmentNode.builder(new Exact(TOP_ID))
                    .add(ContainmentNode.builder(new Exact(INTERFACES_ID))
                        .add(SelectionNode.builder(new Exact(INTERFACE_ID))
                            .add(new AttributeMatch(new Exact(IFNAME_ID), "eth0")).build())
                        .build())
                    .build())
                .build()),
                ...
                .add(ContainmentNode.builder(new Exact(TOP_ID))
                    .add(ContainmentNode.builder(new Exact(USERS_ID))
                        .add(ContainmentNode.builder(new Exact(USER_ID))
                            .add(new ContentMatchNode(new Exact(NAME_ID), "fred"))
                            .build())
                        .build())
                    .build())
                .build()),
            ...
            Arguments.of("""
                ...
                .add(ContainmentNode.builder(new Exact(TOP_ID))
                    .add(ContainmentNode.builder(new Exact(USERS_ID))
                        .add(ContainmentNode.builder(new Exact(USER_ID))
                            .add(new ContentMatchNode(new Exact(NAME_ID), "root"))
                            .add(SelectionNode.builder(new Exact(COMPANY_INFO_ID))
                                .build())
                            .build())
                        .add(ContainmentNode.builder(new Exact(USER_ID))
                            .add(new ContentMatchNode(new Exact(NAME_ID), "fred"))
                            .add(ContainmentNode.builder(new Exact(COMPANY_INFO_ID))
                                .add(SelectionNode.builder(
                                        new Exact(NodeIdentifier.create(QName.create(NAMESPACE, "id"))))
                                    .build())
                                .build())
                            .build())
                        .add(ContainmentNode.builder(new Exact(USER_ID))
                            .add(new ContentMatchNode(new Exact(NAME_ID), "barney"))
                            .add(new ContentMatchNode(new Exact(NodeIdentifier.create(QName.create(NAMESPACE, "type"))),
                                "superuser"))
                            .add(ContainmentNode.builder(new Exact(COMPANY_INFO_ID))
                                .add(
                                    SelectionNode.builder(
                                            new Exact(NodeIdentifier.create(QName.create(NAMESPACE, "dept"))))
                                        .build())
                                .build())
                            .build())
                        .build())
