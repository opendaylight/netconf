...
public record RequestError(
    ...
    public static RequestError ofRpcError(final RpcError rpcError, @Nullable final ErrorPath path) {
        ...
        return new RequestError(rpcError.getErrorType(), errorTag, errorMessage != null ?
            new ErrorMessage(errorMessage) : null, rpcError.getApplicationTag(), path, extractErrorInfo(rpcError));
    }
