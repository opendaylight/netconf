...
public final class JsonPatchBody extends PatchBody {
    ...
    private static void readEditDefinition(final @NonNull PatchEdit edit, final @NonNull JsonReader in,
        ...
        while (in.hasNext()) {
            ...
            switch (editDefinition) {
                ...
                default -> throw new ServerException(ErrorType.APPLICATION, ErrorTag.UNKNOWN_ELEMENT,
     ...
     */
    private static String readValueNode(final @NonNull JsonReader in) throws IOException, ServerException {
        in.beginObject();
     ...
     * @throws ServerException if parsing of {@link JsonReader} fails due to invalid data.
     */
    private static NormalizedNode readEditData(final @NonNull JsonReader in, final @NonNull Inference targetSchemaNode,
            final @NonNull JSONCodecFactory codecs) throws ServerException {
        ...
        try {
            ...
            throw new ServerException(ErrorType.APPLICATION, ErrorTag.MALFORMED_MESSAGE, e);
        }
        try {
    ...
    private static PatchEntity prepareEditOperation(final @NonNull PatchEdit edit) throws ServerException {
        ...
        if (requiresValue(operation)) {
            throw new ServerException(ErrorType.APPLICATION, ErrorTag.MISSING_ELEMENT, operation
                + " operation requires 'value' element");
        }
        throw new ServerException(ErrorType.APPLICATION, ErrorTag.UNKNOWN_ELEMENT, operation
