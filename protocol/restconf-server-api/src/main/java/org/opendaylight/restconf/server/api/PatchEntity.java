...
public class PatchEntity {
    private static final QName QN_EDIT_ID = QName.create(Edit.QNAME, "edit-id").intern();
    private static final QName QN_OPERATION = QName.create(Edit.QNAME, "operation").intern();
    private static final QName QN_TARGET = QName.create(Edit.QNAME, "target").intern();
    private static final QName QN_VALUE = QName.create(Edit.QNAME, "value").intern();
