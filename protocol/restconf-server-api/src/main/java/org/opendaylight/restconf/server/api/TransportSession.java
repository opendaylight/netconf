...
public interface TransportSession {
     ...
     *
     * @apiNote This type uses strings on purpose. We could have used {@link SocketAddress}
     *          for {@link #transportPeer()}, but explicitly do not. This interface's sole purpose is to provide
     *          a description of the details, not the details themselves.
     */
    interface Description extends Immutable {
        ...
        default String toFriendlyString() {
            return messageLayer() + " over " + transportLayer() + " from " + transportPeer();
        }
    }
