...
class NetconfClientFactoryImplTest {
    ...
    static void beforeAll() {
        ...
        sshTransportStackFactory = new SSHTransportStackFactory("ssh-test-server", 0);
    }
    ...
    void beforeEach() throws Exception {
        factory = new NetconfClientFactoryImpl(new HashedWheelTimer());
    ...
    void sshClient() throws Exception {
        ...
        final var server = sshTransportStackFactory.listenServer(serverTransportListener,
