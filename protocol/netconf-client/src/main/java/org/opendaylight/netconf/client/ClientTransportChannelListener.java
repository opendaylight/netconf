...
final class ClientTransportChannelListener implements TransportChannelListener<TransportChannel>,
        FutureListener<NetconfClientSession>, FutureCallback<TransportStack> {
