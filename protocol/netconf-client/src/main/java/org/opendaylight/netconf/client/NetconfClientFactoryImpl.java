...
import org.opendaylight.netconf.transport.ssh.ClientSubsystem.Initializer;
...
public class NetconfClientFactoryImpl implements NetconfClientFactory {
    ...
    public Future<NetconfClientSession> createClient(final NetconfClientConfiguration configuration)
        ...
        if (TCP.equals(protocol)) {
            ...
            factory.connectClient(createTransportChannelListener(promise, null), configuration.getTcpParameters(),
                configuration.getSshParameters(), new ClientSubsystemFactory("netconf", new Initializer() {
                    @Override
                    public void onSuccess(final Channel channel) {
                        channelInitializer.initialize(channel, promise);
                    }
