...
public final class NetconfClientFactoryImpl implements NetconfClientFactory {
    ...
    public ListenableFuture<NetconfClientSession> createClient(final NetconfClientConfiguration configuration,
            final @Nullable SSHNegotiatedAlgListener algListener) throws UnsupportedConfigurationException {
    ...
    @Override
    public ListenableFuture<NetconfClientSession> createClient(NetconfClientConfiguration clientConfiguration)
