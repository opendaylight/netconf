...
import static org.opendaylight.restconf.server.impl.ContentTypes.APPLICATION_JSON;
import static org.opendaylight.restconf.server.impl.PathParameters.DATA;
import static org.opendaylight.restconf.server.impl.ProcessorTestUtils.API_PATH;
import static org.opendaylight.restconf.server.impl.ProcessorTestUtils.ID_PATH;
import static org.opendaylight.restconf.server.impl.ProcessorTestUtils.NEW_API_PATH;
import static org.opendaylight.restconf.server.impl.ProcessorTestUtils.NEW_ID_PATH;
import static org.opendaylight.restconf.server.impl.ProcessorTestUtils.answerCompleteWith;
import static org.opendaylight.restconf.server.impl.ProcessorTestUtils.assertInputContent;
import static org.opendaylight.restconf.server.impl.ProcessorTestUtils.assertResponse;
import static org.opendaylight.restconf.server.impl.ProcessorTestUtils.assertResponseHeaders;
import static org.opendaylight.restconf.server.impl.ProcessorTestUtils.buildRequest;
import static org.opendaylight.restconf.server.impl.ProcessorTestUtils.formattableBody;
...
import org.opendaylight.restconf.server.impl.ProcessorTestUtils.TestEncoding;
...
public class DataRequestProcessorTest {
    ...
    @BeforeEach
    void beforeEach() {
        dispatcher = new RestconfRequestDispatcher(service, RESTS, APPLICATION_JSON, PRETTY_PRINT);
    }
    ...
    void getDataRoot(final TestEncoding encoding, final String content) {
        ...
        doAnswer(answerCompleteWith(result)).when(service).dataGET(any(ServerRequest.class));
    ...
    void getDataById(final TestEncoding encoding, final String content) {
        ...
        doAnswer(answerCompleteWith(result)).when(service).dataGET(any(ServerRequest.class), any(ApiPath.class));
    ...
    void postDataRoot(final TestEncoding encoding, final String content) throws Exception {
        ...
        doAnswer(answerCompleteWith(result)).when(service).dataPOST(any(ServerRequest.class), any(ChildBody.class));
