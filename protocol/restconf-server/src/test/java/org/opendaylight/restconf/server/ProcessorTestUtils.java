...
final class ProcessorTestUtils {
    ...
    static void assertErrorResponse(final FullHttpResponse response, final ErrorTag errorTag,
            final CharSequence expectedContentType, final ErrorTagMapping mapping) {
        // TBD
    }
    ...
    enum TestEncoding {
        ...
        YANG(APPLICATION_YANG, APPLICATION_YANG, APPLICATION_YANG),
        YIN(APPLICATION_YIN_XML, APPLICATION_YIN_XML, APPLICATION_YIN_XML);
        ...
        boolean isJson() {
            return JSON_TYPES.contains(acceptType);
        }

        boolean isYin() {
            return APPLICATION_YIN_XML.equals(acceptType);
        }
    }
}
