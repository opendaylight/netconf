...
class RestconfStreamServiceTest {
    private static final String RESTCONF = "/rests";
    private static final String URI_PREFIX = RESTCONF + STREAMS;
    ...
    @BeforeEach
    void beforeEach() {
        streamService = new RestconfStreamService(registry, RESTCONF, ERROR_TAG_MAPPING, APPLICATION_JSON,
