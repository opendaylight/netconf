...
class RestconfSessionTest {
    ...
    @ParameterizedTest
    @MethodSource
    void asteriskRequestUnimplemented(final HttpMethod method) {
        final var response = RestconfSession.asteriskRequest(HttpVersion.HTTP_1_1, method);
    ...
    private static List<Arguments> asteriskRequestUnimplemented() {
        return List.of(
            Arguments.of(HttpMethod.CONNECT),
            Arguments.of(HttpMethod.TRACE),
            Arguments.of(new HttpMethod("WHATEVER")));
    }
