...
final class RestconfSession extends PipelinedHTTPServerSession {
     ...
     * {@inheritDoc}
     *
     * <p>For purpose of pipelining, we need to know when previous request has
     * been finished, for that we override {@link #respond(ChannelHandlerContext, Integer, HttpResponse)},
     * which is not called in chunked response, so this method provides a way
     * to notify this session after request was finished.
     */
    @Override
