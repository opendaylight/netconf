...
public class RequestParameters {
     ...
     *
     * <p>
     * Example: if {@code basePath = "/rests"} then
     * <ul>
     *     <li>for {@code uri="/rests/data?insert=after"} calculated {@code contextPath="/data"}</li>
     *     <li>for {@code uri="/other/data?insert=after"} calculated {@code contextPath=""}</li>
     * </ul>
     *
