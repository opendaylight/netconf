...
abstract class AbstractPendingOptions extends PendingRequest<OptionsResult> {
    ...
    static final HttpHeaders HEADERS_DATASTORE = withPatch("GET, HEAD, OPTIONS, PATCH, POST, PUT");
    static final HttpHeaders HEADERS_READ_ONLY = headers("GET, HEAD, OPTIONS");
    static final HttpHeaders HEADERS_RESOURCE = withPatch("DELETE, GET, HEAD, OPTIONS, PATCH, POST, PUT");
    static final HttpHeaders HEADERS_RPC = headers("GET, HEAD, OPTIONS, POST");

    static final CompletedRequest ACTION = new CompletedRequest(HttpResponseStatus.OK, HEADERS_ACTION);
    static final CompletedRequest DATASTORE = new CompletedRequest(HttpResponseStatus.OK, HEADERS_DATASTORE);
    static final CompletedRequest READ_ONLY = new CompletedRequest(HttpResponseStatus.OK, HEADERS_READ_ONLY);
    static final CompletedRequest RESOURCE = new CompletedRequest(HttpResponseStatus.OK, HEADERS_RESOURCE);
    static final CompletedRequest RPC = new CompletedRequest(HttpResponseStatus.OK, HEADERS_RPC);
    ...
    private static HttpHeaders withPatch(final String allow) {
        return headers(allow).add(HttpHeaderNames.ACCEPT_PATCH, NettyMediaTypes.ACCEPT_PATCH_HEADER_VALUE);
    }
