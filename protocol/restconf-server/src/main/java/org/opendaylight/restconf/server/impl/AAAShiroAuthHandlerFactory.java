...
public final class AAAShiroAuthHandlerFactory implements AuthHandlerFactory {
    ...
    private static final String RESTCONF_AUTHN_HEADER = "x-restconf-authn";
    ...
    @Inject
    public AAAShiroAuthHandlerFactory(final SecurityManager securityManager) {
    ...
    public AuthHandler<?> create() {
        return new AbstractBasicAuthHandler<Subject>() {
            ...
            public Subject authenticate(final HttpRequest request) {
                ...
                request.headers().add(RESTCONF_AUTHN_HEADER, subject);
                return subject;
            }
