...
final class PendingDataPatchPlain extends PendingRequestWithResource<DataPatchResult> {
    ...
    @Override
    protected void execute(final NettyServerRequest<DataPatchResult> request, final ResourceBody body) {
        if (apiPath.isEmpty()) {
    ...
    @Override
    protected Response transformResult(final NettyServerRequest<?> request, final DataPatchResult result) {
