 ...
 */
public abstract sealed class AbstractChannelSender extends SimpleChannelInboundHandler<FullHttpRequest>
        implements Sender permits ChannelSender, ChannelSenderSubscription {
    ...
    public AbstractChannelSender(final int sseMaximumFragmentLength) {
