...
final class RestconfSessionBootstrap extends HTTPServerSessionBootstrap {
    ...
    @Override
    protected RestconfSession createHttp1Session(final HttpScheme scheme) {
        return new RestconfSession(scheme, root);
    }

    @Override
    protected HTTPServerSession createHttp2Session(final HttpScheme scheme, final Http2Settings settings) {
