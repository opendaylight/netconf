...
abstract sealed class AbstractResource permits AbstractLeafResource, APIResource {
     ...
     * {@code OPTIONS} method.
     */
    static final HeadersResponse OPTIONS_ONLY_METHOD_NOT_ALLOWED = HeadersResponse.ofTrusted(
    ...
    static final HeadersResponse NOT_ACCEPTABLE_DATA = HeadersResponse.ofTrusted(HttpResponseStatus.NOT_ACCEPTABLE,
    ...
    static final HeadersResponse UNSUPPORTED_MEDIA_TYPE_DATA =
        new HeadersResponse(HttpResponseStatus.NOT_ACCEPTABLE, NOT_ACCEPTABLE_DATA.headers());
    static final HeadersResponse UNSUPPORTED_MEDIA_TYPE_PATCH =
        HeadersResponse.ofTrusted(HttpResponseStatus.UNSUPPORTED_MEDIA_TYPE,
