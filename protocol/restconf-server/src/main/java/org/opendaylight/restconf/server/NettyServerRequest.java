...
abstract class NettyServerRequest<T> extends MappingServerRequest<T> {
    private final @NonNull RequestParameters requestParameters;
    private final @NonNull FutureCallback<FullHttpResponse> callback;
    ...
    abstract FullHttpResponse transform(T result) throws ServerException;
}
