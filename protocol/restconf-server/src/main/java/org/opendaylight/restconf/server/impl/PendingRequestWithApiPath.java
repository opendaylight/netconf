 ...
 */
@NonNullByDefault
public abstract class PendingRequestWithApiPath<T> extends PendingRequestWithoutBody<T> {
    protected final ApiPath apiPath;

    protected PendingRequestWithApiPath(final EndpointInvariants invariants, final TransportSession session,
