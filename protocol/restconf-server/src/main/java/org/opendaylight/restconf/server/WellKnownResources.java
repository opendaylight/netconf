...
final class WellKnownResources implements XRD {
    ...
    private static final HeadersResponse XRD_HEAD = HeadersResponse.of(HttpResponseStatus.OK,
        HttpHeaderNames.CONTENT_TYPE, HostMeta.MEDIA_TYPE);
    private static final HeadersResponse JRD_HEAD = HeadersResponse.of(HttpResponseStatus.OK,
