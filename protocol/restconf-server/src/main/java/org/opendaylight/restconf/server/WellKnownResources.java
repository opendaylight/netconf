...
final class WellKnownResources {
    ...
    private static ByteBuf newBuffer(final String content) {
        return Unpooled.unreleasableBuffer(
            ByteBufUtil.writeUtf8(UnpooledByteBufAllocator.DEFAULT, content).asReadOnly());
    }
    ...
    private static FullHttpResponse notAllowed(final HttpVersion version) {
