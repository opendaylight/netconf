...
final class Http3ServerBootstrap implements AutoCloseable {
    ...
    private final @NonNull EventLoopGroup quicGroup;
    ...
    static @Nullable Http3ServerBootstrap start(final String bindAddress, final int bindPort,
            ...
            final Uint32 chunkSize, final int maxContentLength, final long initialMaxData,
            final long initialMaxStreamDataBidirectionalRemote, final long initialMaxStreamsBidirectional)
            throws SSLException {
