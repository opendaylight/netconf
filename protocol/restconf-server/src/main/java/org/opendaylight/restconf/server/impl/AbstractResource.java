 ...
 */
@NonNullByDefault
public abstract sealed class AbstractResource permits AbstractLeafResource, APIResource {
    ...
    protected static final CompletedRequest METHOD_NOT_ALLOWED_READ_ONLY =
        new DefaultCompletedRequest(HttpResponseStatus.METHOD_NOT_ALLOWED, AbstractPendingOptions.HEADERS_READ_ONLY);
    protected static final CompletedRequest NOT_FOUND = new DefaultCompletedRequest(HttpResponseStatus.NOT_FOUND);
    ...
    protected final EndpointInvariants invariants;
    ...
    protected static final PreparedRequest optionalApiPath(final String path,
            final Function<ApiPath, PreparedRequest> func) {
        return path.isEmpty() ? func.apply(ApiPath.empty()) : requiredApiPath(path, func);
    }

    protected static final PreparedRequest requiredApiPath(final String path,
            final Function<ApiPath, PreparedRequest> func) {
    ...
    protected static final CompletedRequest badApiPath(final String path, final ParseException cause) {
    ...
    protected static final RequestBodyHandling chooseInputEncoding(final HttpHeaders headers) {
    ...
    protected final @Nullable MessageEncoding chooseOutputEncoding(final HttpHeaders headers) {
