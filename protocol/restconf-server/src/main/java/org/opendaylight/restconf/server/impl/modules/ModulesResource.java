...
import org.opendaylight.restconf.server.impl.AbstractLeafResource;
import org.opendaylight.restconf.server.impl.AbstractPendingOptions;
 ...
 */
@NonNullByDefault
public final class ModulesResource extends AbstractLeafResource {
    public ModulesResource(final EndpointInvariants invariants) {
        super(invariants);
    }

    @Override
    protected PreparedRequest prepare(final TransportSession session, final ImplementedMethod method,
            final URI targetUri, final HttpHeaders headers, final @Nullable Principal principal, final String path) {
