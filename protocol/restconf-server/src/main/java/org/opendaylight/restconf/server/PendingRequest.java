...
abstract non-sealed class PendingRequest<T> implements PreparedRequest {
    ...
    PendingRequest(final EndpointInvariants invariants, final URI targetUri) {
    ...
    final void onFailure(final RequestCompleter completer, final NettyServerRequest<T> request,
        ...
        completer.completeRequest(this, new FormattableDataResponse(HttpResponseStatus.valueOf(status.code()), null,
