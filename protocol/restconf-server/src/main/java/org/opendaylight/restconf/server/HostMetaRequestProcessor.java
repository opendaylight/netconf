...
import static org.opendaylight.restconf.server.RequestParameters.Method.GET;
...
final class HostMetaRequestProcessor {
    ...
    static void processHostMetaRequest(final RequestParameters params,
        ...
        if (params.method() == GET) {
            ...
            getHostMeta(params, callback, XRD_TEMPLATE, NettyMediaTypes.APPLICATION_XRD_XML);
        } else {
    ...
    static void processHostMetaJsonRequest(final RequestParameters params,
        ...
        if (params.method() == GET) {
            ...
            getHostMeta(params, callback, JRD_TEMPLATE, NettyMediaTypes.APPLICATION_JSON);
        } else {
            callback.onSuccess(unmappedRequestErrorResponse(params));
        }
    }
