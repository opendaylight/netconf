...
public class RestconfStreamService implements EventStreamService {
    ...
    public RestconfStreamService(final RestconfStream.Registry registry, final String topLevelResource,
