...
final class ResponseUtils {
    ...
    static void handleException(final RequestParameters params, final ErrorTagMapping errorTagMapping,
            final FutureCallback<FullHttpResponse> callback, final RuntimeException thrown) {
