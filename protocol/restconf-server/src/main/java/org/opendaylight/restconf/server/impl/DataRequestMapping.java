...
/**
 * Implementation of {@link RequestMapping} serving {@code /data} path requests.
 */
final class DataRequestMapping implements RequestMapping {
    ...
    private static final List<RequestProcessor> PROCESSORS = List.of(
    ...
    @Override
    public @NonNull Collection<RequestProcessor> processors() {
        return PROCESSORS;
    }
}
