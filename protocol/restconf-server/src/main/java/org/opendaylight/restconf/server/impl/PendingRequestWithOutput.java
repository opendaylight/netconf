 ...
 */
@NonNullByDefault
public abstract class PendingRequestWithOutput<T, B extends ConsumableBody> extends PendingRequestWithBody<T, B> {
    // Note naming: derived from 'Accept'
    protected final MessageEncoding acceptEncoding;
    protected final ApiPath apiPath;

    protected PendingRequestWithOutput(final EndpointInvariants invariants, final TransportSession session,
