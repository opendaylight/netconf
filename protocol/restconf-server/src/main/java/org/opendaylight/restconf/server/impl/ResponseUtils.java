...
final class ResponseUtils {
    ...
    static void setResponse(final RequestContext context, final Object resultObj, final HttpResponseStatus status) {
        context.callback().onSuccess(buildResponse(context, resultObj, status));
    }
    ...
    static <T> void setResponse(final RequestContext context, final T resultObj,
        ...
        context.callback().onSuccess(buildResponse(context, resultObj, bodyExtractor, prettyPrint));
    }
    ...
    static FullHttpResponse buildResponse(final RequestContext context, final Object resultObj,
        ...
        setHeaders(context, response, resultObj);
        return response;
    }
    ...
    private static void setHeaders(final RequestContext context, final FullHttpResponse response,
            final Object resultObj) {
        if (resultObj instanceof DataGetResult) {
