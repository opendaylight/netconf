...
public abstract class AbstractServerDataOperationsTest extends AbstractJukeboxTest {
    ...
    protected static final Data PATH_DATA = modulesPath(PATH, MODULES_DATABIND);
    protected static final Data PATH_2_DATA = modulesPath(PATH_2, MODULES_DATABIND);
    protected static final Data PATH_3_DATA = modulesPath(PATH_3, MODULES_DATABIND);
    protected static final Data LEAF_SET_NODE_DATA = modulesPath(LEAF_SET_NODE_PATH, MODULES_DATABIND);

    protected static Data modulesPath(final YangInstanceIdentifier path, final DatabindContext modules) {
    ...
    protected static void assertPatchStatus(final CompletingServerRequest<DataYangPatchResult> request,
            final boolean failed) {
        final PatchStatusContext patchStatusContext;
        try {
            patchStatusContext = request.getResult().status();
