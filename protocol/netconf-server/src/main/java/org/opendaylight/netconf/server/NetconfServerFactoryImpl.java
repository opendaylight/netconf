...
public class NetconfServerFactoryImpl implements NetconfServerFactory {
    ...
    public ListenableFuture<TLSServer> createTlsServer(final TcpServerGrouping tcpParams,
        ...
        return TLSServer.listen(transportChannelListener, createBootstrap(), tcpParams, tlsParams);
    }
    ...
    public ListenableFuture<SSHServer> createSshServer(final TcpServerGrouping tcpParams,
        final SshServerGrouping sshParams, final Consumer<ServerFactoryManager> factoryInitializer)
            throws UnsupportedConfigurationException {
        return SSHServer.listen(EMPTY_LISTENER, createBootstrap(), tcpParams, sshParams,
            new FactoryManagerInitializer(channelInitializer, factoryInitializer));
    }
    ...
    private record FactoryManagerInitializer(@NonNull ServerChannelInitializer channelInitializer,
            @Nullable Consumer<ServerFactoryManager> factoryInitializer) implements Consumer<ServerFactoryManager> {
