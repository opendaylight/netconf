...
public final class NetconfServerFactoryImpl implements NetconfServerFactory {
    ...
    private record ChannelInitializerListener(
        ...
        @Override
        public void onTransportChannelEstablished(@NonNull
        ...
        @Override
        public void onTransportChannelFailed(@NonNull
        final Throwable cause) {
            LOG.error("Transport channel failed", cause);
        }
    }

    private record FactoryManagerConfigurator(@NonNull ServerChannelInitializer channelInitializer,
