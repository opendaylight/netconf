...
public class PropertyEntity {
    ...
    private void processRef(final String name, final SchemaNode schemaNode, final String discriminator,
        ...
        if (schemaNode instanceof ListSchemaNode listNode) {
            ...
            final var minElements = stmt.minElementsStatement();
            if (minElements != null) {
                final var minArg = minElements.argument();
                final var lowerInt = minArg.lowerInt();
                ...
                writeMinItems(minArg);
            }
            final var maxElements = stmt.maxElementsStatement();
            if (maxElements != null) {
                writeMaxItems(maxElements.argument());
            }
        } else {
             /*
