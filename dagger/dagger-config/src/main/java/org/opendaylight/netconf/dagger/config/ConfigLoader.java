...
public interface ConfigLoader {
    ...
    /**
     * Loads configuration properties from an external file in the 'config' folder or classpath resource and maps them
     * to a target class.
     *
     ...
     * @param fileName      Name of the configuration file (e.g., "netconf.yaml" or "app.properties")
     ...
     */
    <T> T getConfig(Class<T> expectedClass, String prefix, String fileName);
}
