...
class SecurityHelperTest {
    ...
    @Test
    void testPrivateKeyWrongInput() {
        final var ex = assertThrows(IOException.class, () -> helper.decodePrivateKey("wrong", null));
    ...
    @Test
    void testCertificateWrongInput2() {
        final var ex = assertThrows(IOException.class, () -> helper.decodeCertificate("wrong"));
        assertEquals("Invalid input.", ex.getMessage());
    }
