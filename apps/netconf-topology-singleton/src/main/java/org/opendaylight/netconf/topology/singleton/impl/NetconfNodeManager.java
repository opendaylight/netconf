...
<<<<<<< HEAD   (02d080 Add SSH transport config to netconf topology)
<<<<<<< HEAD   (5e160a Make node SSH transport configurable)
...
>>>>>>> CHANGE (cffd88 Add SSH transport config to netconf topology)
=======
import org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.node.topology.rev251103.NetconfNodeAugment;
>>>>>>> CHANGE (b9c2cd Fix misplaced ssh parameters container)
