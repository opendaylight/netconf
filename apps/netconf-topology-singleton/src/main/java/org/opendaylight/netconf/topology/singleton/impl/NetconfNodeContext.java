...
final class NetconfNodeContext implements AutoCloseable {
    ...
    private void connectNode() {
        ...
        masterSalFacade = createSalFacade(netconfNode);
    ...
    @VisibleForTesting
    MasterSalFacade createSalFacade(final NetconfNode node) {
        return new MasterSalFacade(remoteDeviceId, node.getCredentials(), setup.getActorSystem(), masterActorRef,
            actorResponseWaitTime, mountPointService, setup.getDataBroker(), node.getLockDatastore());
    }
}
