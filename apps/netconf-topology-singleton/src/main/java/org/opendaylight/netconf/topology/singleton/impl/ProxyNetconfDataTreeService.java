...
public class ProxyNetconfDataTreeService implements DataStoreService {
    ...
    public ListenableFuture<Optional<NormalizedNode>> read(LogicalDatastoreType store,
            YangInstanceIdentifier path) {
        return proxyNetconfService.read(store, path);
    }
}
