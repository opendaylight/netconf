...
public final class NetconfTopologyUtils {
    ...
    public static DataObjectIdentifier.@NonNull WithKey<Topology, TopologyKey> createTopologyListPath(
    ...
    public static DataObjectIdentifier.@NonNull WithKey<Node, NodeKey> createTopologyNodeListPath(final NodeKey key,
            final String topologyId) {
    ...
    public static @NonNull DataObjectReference<Node> createTopologyNodePath(final String topologyId) {
        return createTopologyListPath(topologyId).toLegacy().child(Node.class).toReference();
    }
