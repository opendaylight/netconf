...
//    }
    ...
    protected MasterSalFacade newSalFacade() {
        masterSalFacade = new MasterSalFacade(remoteDeviceId, setup.getActorSystem(), masterActorRef, actorResponseWaitTime,
                mountPointService, dataBroker, setup.getNode().augmentation(NetconfNode.class).getLockDatastore());
        return masterSalFacade;
    }
}
