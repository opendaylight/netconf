    ...
    private void onDataTreeChangedParams(
        ...
        for (var change : changes) {
            switch (change.getRootNode()) {
                case DataObjectWritten<SshTransportTopologyParameters> written -> updateSshParams(written.dataAfter());
                ...
                case DataObjectModified<SshTransportTopologyParameters> modified ->
                    LOG.debug("Unsupported modification type: {}.", modified);
            }
        }
    }
