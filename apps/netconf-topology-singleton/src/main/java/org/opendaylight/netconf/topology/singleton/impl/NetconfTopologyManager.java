...
public class NetconfTopologyManager implements DataTreeChangeListener<Node>, AutoCloseable {
    ...
    private final Map<DataObjectIdentifier<Node>, NetconfTopologyContext> contexts = new ConcurrentHashMap<>();
    private final Map<DataObjectIdentifier<Node>, Registration> clusterRegistrations = new ConcurrentHashMap<>();
    ...
    private Registration registerDataTreeChangeListener() {
        ...
        wtx.merge(LogicalDatastoreType.OPERATIONAL, NetconfTopologyUtils.createTopologyListPath(topologyId),
            new TopologyBuilder().setTopologyId(new TopologyId(topologyId)).build());
        ...
        return dataBroker.registerTreeChangeListener(LogicalDatastoreType.CONFIGURATION,
            NetconfTopologyUtils.createTopologyNodePath(topologyId), this);
    }
