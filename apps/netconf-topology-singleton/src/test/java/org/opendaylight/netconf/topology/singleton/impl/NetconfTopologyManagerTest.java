...
class NetconfTopologyManagerTest extends AbstractBaseSchemasTest {
    ...
    void testOnDataTreeChanged() {
        ...
        final NetconfNodeAugment netconfNode1 = new NetconfNodeAugmentBuilder().setNetconfNode(new NetconfNodeBuilder()
        ...
        final NetconfNodeAugment netconfNode2 = new NetconfNodeAugmentBuilder().setNetconfNode(new NetconfNodeBuilder()
                .setHost(new Host(new IpAddress(new Ipv4Address("127.0.0.1"))))
        ...
        final NetconfNodeAugment updatedNetconfNode1 = new NetconfNodeAugmentBuilder()
            .setNetconfNode(new NetconfNodeBuilder(netconfNode1.getNetconfNode())
                .setPort(new PortNumber(Uint16.valueOf(33333))).build()).build();
