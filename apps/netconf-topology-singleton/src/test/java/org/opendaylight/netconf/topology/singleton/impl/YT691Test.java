...
class YT691Test {
    ...
    void testGetAllModuleIdentifiers() {
        ...
        final var allModuleIdentifiers = MasterSalFacade.getConstituentModuleIdentifiers(context);
        assertEquals(6, allModuleIdentifiers.size());
        final var allModuleIdentifiersResolved = MasterSalFacade.getConstituentModuleIdentifiers(
