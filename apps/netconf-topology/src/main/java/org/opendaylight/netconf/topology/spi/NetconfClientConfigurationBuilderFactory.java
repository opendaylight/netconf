...
public interface NetconfClientConfigurationBuilderFactory {
     ...
     * @throws NetconfClientConfigurationBuilderException Thrown when the provided client configuration is invalid
     */
    @NonNull NetconfClientConfigurationBuilder createClientConfigurationBuilder(@NonNull NodeId nodeId,
        @NonNull NetconfNode node) throws NetconfClientConfigurationBuilderException;
}
