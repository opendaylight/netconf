 ...
 */
final class NetconfNodeHandler implements RemoteDeviceHandler, AutoCloseable {
    ...
    NetconfNodeHandler(final EventExecutor eventExecutor, final ScheduledExecutorService keepaliveExecutor,
            final BaseNetconfSchemas baseSchemas, final SchemaResourceManager schemaManager,
            final ListeningExecutorService processingExecutor, final DeviceActionFactory deviceActionFactory,
            final RemoteDeviceHandler delegate, final RemoteDeviceId deviceId, final NodeId nodeId,
            final NetconfNode node, final NetconfNodeAugmentedOptional nodeOptional) {
