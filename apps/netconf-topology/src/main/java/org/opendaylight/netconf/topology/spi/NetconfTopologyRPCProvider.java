...
import org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.node.optional.rev231121.NetconfNodeAugmentedOptionalBuilder;
//import org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.node.topology.rev231121.Credentials;
        ...
        if (credentialsRpc instanceof LoginPwRpc loginPw) {
            ...
            return new LoginPwUnencryptedBuilder()
                .setLoginPasswordUnencrypted(new LoginPasswordUnencryptedBuilder()
                    ...
                    .build())
                .build();
        } else if (credentialsRpc instanceof KeyAuthRpc keyAuthRpc) {
            final var loginPassword = keyAuthRpc.getKeyBased();
