...
import org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.device.rev251205.connection.oper.ClusteredConnectionStatusBuilder;
...
public final class NetconfDeviceTopologyAdapter implements FutureCallback<Empty> {
    ...
    private static NegotiatedSshTransportParameters buildNegotiatedParameters(final NegotiatedSshAlg negotiatedSshAlg) {
        final var params = new NegotiatedSshTransportParametersBuilder();
            Optional.ofNullable(negotiatedSshAlg.negotiatedKexAlg())
                .ifPresent(params::setKeyExchangeAlg);
            Optional.ofNullable(negotiatedSshAlg.negotiatedHostKeyAlg())
                .ifPresent(params::setHostKeyAlg);
            Optional.ofNullable(negotiatedSshAlg.negotiatedEncryptionAlg())
                .ifPresent(params::setEncryptionAlg);
            Optional.ofNullable(negotiatedSshAlg.negotiatedMacAlg())
                .ifPresent(params::setMacAlg);
        return params.build();
    }
