 ...
 *
 * @deprecated as outdated. Should be replaced with {@link DefaultNetconfClientConfigurationBuilderFactory} once
...
public final class LegacyNetconfClientConfigurationBuilderFactory implements NetconfClientConfigurationBuilderFactory {
    ...
    @Inject
    @Activate
    public LegacyNetconfClientConfigurationBuilderFactory(
