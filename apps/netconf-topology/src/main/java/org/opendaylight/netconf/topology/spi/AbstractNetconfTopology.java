...
public abstract class AbstractNetconfTopology {
    ...
    protected final Map<NodeId, RemoteDeviceHandler> remoteDeviceHandlers = new HashMap<>();
    ...
    final Map<NodeId, RemoteDeviceHandler> getRemoteDeviceHandlers() {
        return remoteDeviceHandlers;
    }
}
