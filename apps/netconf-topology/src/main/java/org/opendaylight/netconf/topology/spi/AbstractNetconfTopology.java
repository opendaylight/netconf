...
import org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.node.topology.rev251103.network.topology.topology.topology.types.topology.netconf.SshTransportTopologyParametersBuilder;
...
public abstract class AbstractNetconfTopology {
    ...
    private synchronized void connectNode(final NetconfNode netconfNode, final NodeId nodeId,
        ...
        if (LOG.isInfoEnabled()) {
            LOG.info("Reconnecting RemoteDevice{{}}, with config {}", nodeId, configMsg);
        }
