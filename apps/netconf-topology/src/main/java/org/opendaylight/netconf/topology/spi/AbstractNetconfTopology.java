...
public abstract class AbstractNetconfTopology {
    ...
    protected final void setupConnection(final NodeId nodeId, final Node configNode) {
        ...
        final var nodeHandler = new NetconfNodeHandler(eventExecutor, keepaliveExecutor.getExecutor(),
        ...
        final NetconfClientSessionListener netconfClientSessionListener = nodeHandler.getSessionListener();
        ...
        final ListenableFuture<Empty> future =
            nodeHandler.getCommunicator().initializeRemoteConnection(clientDispatcher, clientConfig);
