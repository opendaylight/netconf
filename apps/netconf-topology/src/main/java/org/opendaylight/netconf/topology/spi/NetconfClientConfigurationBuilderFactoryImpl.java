...
import org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.device.rev240319.credentials.Credentials;
import org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.device.rev240319.credentials.credentials.KeyAuth;
import org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.device.rev240319.credentials.credentials.LoginPw;
import org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.device.rev240319.credentials.credentials.LoginPwUnencrypted;
...
public final class NetconfClientConfigurationBuilderFactoryImpl implements NetconfClientConfigurationBuilderFactory {
    ...
    public NetconfClientConfigurationBuilder createClientConfigurationBuilder(final NodeId nodeId,
        ...
        if (node.requireTcpOnly()) {
            ...
            final var sslContext = contextFactory.createSslContext(protocol.getKeyId());
