...
import org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.device.rev231025.credentials.credentials.KeyAuthBuilder;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.device.rev231025.credentials.credentials.key.auth.KeyBasedBuilder;
...
class NetconfClientConfigurationBuilderFactoryImplTest {
    ...
    void testTlsWithKeyId() {
        ...
        assertSame(sslHandler, config.getTransportSslHandlerFactory().createSslHandler(null));
