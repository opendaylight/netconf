...
public class NetconfNodeHandlerTest {
    ...
    public void setUp() throws YangParserException {
        //builderFactory clientDispatcher and baseSchemas init
...
//        handler.connect();
    ...
    public void testDeviceConnecting() {
        handler.connect();
        //expected node to have some connection status after handler.connect, not sure if that even be changed on this instance
