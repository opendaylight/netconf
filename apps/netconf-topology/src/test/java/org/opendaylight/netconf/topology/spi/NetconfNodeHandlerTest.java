...
import org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.device.rev230430.connection.parameters.Protocol;
...
public class NetconfNodeHandlerTest {
    ...
    public void setUp() throws YangParserException {
        ...
        NioEventLoopGroup nettyGroup = new NioEventLoopGroup(
            1, new DefaultThreadFactory(NetconfClientDispatcher.class));
        ...
        final var nodeBuilder = new NetconfNodeBuilder()
            ...
            .setDefaultRequestTimeoutMillis(Uint32.valueOf(1001))
            .setBetweenAttemptsTimeoutMillis(Uint16.valueOf(101))
            .setKeepaliveDelay(Uint32.valueOf(1000))
            .setConnectionTimeoutMillis(Uint32.valueOf(1000))
            .setProtocol(new ProtocolBuilder().setName(Protocol.Name.SSH).build())
