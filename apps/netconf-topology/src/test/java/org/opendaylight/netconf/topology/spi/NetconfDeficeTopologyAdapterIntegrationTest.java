...
class NetconfDeficeTopologyAdapterIntegrationTest {
    ...
    void testDeviceAugmentedNodePresence() throws Exception {
        ...
        final var pathToAugmentedLeaf = YangInstanceIdentifier.builder().node(NetworkTopology.QNAME)
            .node(Topology.QNAME)
        ...
        wtx.merge(LogicalDatastoreType.OPERATIONAL, pathToAugmentedLeaf, augmentNode);
