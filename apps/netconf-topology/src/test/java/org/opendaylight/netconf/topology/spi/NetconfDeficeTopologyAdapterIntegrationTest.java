...
class NetconfDeficeTopologyAdapterIntegrationTest {
    ...
    void testDeviceAugmentedNodePresence() throws Exception {
        ...
        final var nodeConnectionStatus = ImmutableNodes.leafNode(QName.create(
                "urn:opendaylight:netconf-node-topology", "2023-11-21", "connection-status"),
            "unable-to-connect");
        final var connectedMessage = ImmutableNodes.leafNode(QName.create(
                "urn:opendaylight:netconf-node-topology", "2023-11-21", "connected-message"),
            "Unknown reason");

        final var expectedDataFailedDevice = new ArrayList<NormalizedNode>();
        expectedDataFailedDevice.add(nodePortLeaf);
        expectedDataFailedDevice.add(nodeConnectionStatus);
        ...
        expectedDataFailedDevice.add(connectedMessage);
