...
public final class OSGiNorthbound {
    ...
    public @interface Configuration {
        ...
        @AttributeDefinition(
            ...
            description = """
                Maximum HTTP/2 frame payload size (SETTINGS_MAX_FRAME_SIZE) this server is willing to
                accept from clients. A larger frame is a FRAME_SIZE_ERROR. The default is 16384.
