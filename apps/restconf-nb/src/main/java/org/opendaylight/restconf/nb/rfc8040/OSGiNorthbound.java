...
public final class OSGiNorthbound {
    ...
    private static Map<String, ?> newNettyEndpointProps(final BootstrapFactory bootstrapFactory,
        ...
        return OSGiNettyEndpoint.props(bootstrapFactory, new NettyEndpointConfiguration(
            ...
            buildAltSvcHeader(configuration.bind$_$port(),
                Uint32.valueOf(configuration.http3$_$alt$_$svc$_$max$_$age()), tlsCertKey != null),
            ...
            Uint64.valueOf(configuration.http3$_$initial$_$max$_$streams$_$bidirectional()))
        );
    }
    ...
    private static @Nullable String buildAltSvcHeader(final int bindPort, final Uint32 maxAgeSeconds,
        ...
        if (!tlsEnabled || maxAgeSeconds.intValue() == 0) {
            return null;
        }
