...
abstract class AbstractE2ETest extends AbstractDataBrokerTest {
    ...
    void setUp() throws Exception {
        ...
        final var serverTransport = ConfigUtils.serverTransportTcp("0.0.0.0", 8182);
        ...
        final var clientransport = ConfigUtils.clientTransportTcp("127.0.0.1", 8182);
        ...
        final var negotiatorFactory = new NetconfClientSessionNegotiatorFactory(new DefaultNetconfTimer(),
            Optional.empty(), 0, NetconfClientSessionNegotiatorFactory.DEFAULT_CLIENT_CAPABILITIES);
        final var channelInitializer = new ClientChannelInitializer(negotiatorFactory,
            new SimpleNetconfClientSessionListener());
        final var transportChannelListener = new TestClientTransportChannelListener(channelInitializer);
