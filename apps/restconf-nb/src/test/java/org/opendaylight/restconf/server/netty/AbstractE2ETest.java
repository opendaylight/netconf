...
abstract class AbstractE2ETest extends AbstractDataBrokerTest {
    ...
    void beforeEach() throws Exception {
        ...
        final var clientransport = ConfigUtils.clientTransportTcp(localAddress, port);
    ...
    void invokeRequest(final FullHttpRequest request, final FutureCallback<FullHttpResponse> callback)
        ...
        final var client =  HTTPClient.connect(channelListener, bootstrapFactory.newBootstrap(),
            clientStackGrouping, false).get(10, TimeUnit.SECONDS);
    ...
    private record TestTransportListener(Consumer<Channel> initializer) implements TransportChannelListener {
        @Override
