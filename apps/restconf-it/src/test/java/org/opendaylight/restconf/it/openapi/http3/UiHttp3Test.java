...
class UiHttp3Test extends AbstractOpenApiHttp3Test {
    @Test
    void uiAvailableTest() throws Exception {
        ...
        final var location = Optional.ofNullable(response.headers().get("location").getFirst()).orElseThrow();
        ...
        assertEquals("""
            ...
            </html>""".trim(), response.content().trim());
    }
}
