...
public abstract class AbstractE2ETest extends AbstractDataBrokerTest {
    ...
    void beforeEach() throws Exception {
        ...
        // OpenApi
        openApiService = new OpenApiServiceImpl(new MountPointOpenApiGeneratorRFC8040(schemaService,
            domMountPointService, RESTS), new OpenApiGeneratorRFC8040(schemaService, RESTS));
