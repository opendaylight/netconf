 ...
 * This client establishes a single QUIC connection to a remote server and
 ...
 *
 * The implementation is designed for testing purposes and does not aim to
 * provide a full-featured HTTP/3 client.
