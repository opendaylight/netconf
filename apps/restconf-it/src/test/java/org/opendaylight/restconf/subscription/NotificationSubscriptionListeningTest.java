...
import org.opendaylight.yang.svc.v1.urn.ietf.params.xml.ns.yang.ietf.subscribed.notifications.rev190909.YangModuleInfoImpl;
...
class NotificationSubscriptionListeningTest extends AbstractNotificationSubscriptionTest {
    ...
    public void beforeEach() throws Exception {
        ...
        final var response = invokeRequest(HttpMethod.POST, ESTABLISH_SUBSCRIPTION_URL, APPLICATION_JSON, input,
            APPLICATION_JSON);
