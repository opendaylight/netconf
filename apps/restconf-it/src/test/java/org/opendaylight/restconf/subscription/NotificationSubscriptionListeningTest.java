...
class NotificationSubscriptionListeningTest extends AbstractNotificationSubscriptionTest {
    ...
    void testPutNotification() throws Exception {
        ...
        getPublishService().putNotification(
            new DOMNotificationEvent.Rfc6020(notificationNode, Instant.ofEpochSecond(1738413500)));
        ...
        JSONAssert.assertEquals("""
            ...
            }""", eventListener.readNext(), JSONCompareMode.STRICT);
    }

    /**
     * Tests receiving subscription modified notification.
     */
    @Disabled("This will be enabled after filtering is implemented and modifySubscription will work")
    @Test
