...
class StreamsHttp3E2ETest extends AbstractHttp3E2ETest {
    private static final String BASE_PATH = "/rests/data/example-jukebox:jukebox";
    ...
    void dataChangeEventStreamJsonTest() throws Exception {
        ...
        var response = client().send(HttpRequest.newBuilder()
            .uri(createUri(BASE_PATH + "/library/artist=artist"))
        ...
        response = client().send(HttpRequest.newBuilder()
            .uri(createUri(BASE_PATH +"/library/artist=artist/album=album"))
            .PUT(HttpRequest.BodyPublishers.ofString("""
                 {
                    "example-jukebox:album": [{
                        "name": "album",
