...
public abstract class AbstractNotificationSubscriptionTest extends AbstractIT {
    ...
    protected FullHttpResponse invokeRequestKeepClient(final @NonNull HttpMethod method, final @NonNull String uri,
            final @NonNull String mediaType, @Nullable final String acceptType, final @Nullable String content) {
