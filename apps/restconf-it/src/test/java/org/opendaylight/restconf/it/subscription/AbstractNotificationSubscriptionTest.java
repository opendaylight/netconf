...
abstract class AbstractNotificationSubscriptionTest extends AbstractDataBrokerTest {
    ...
    void beforeEach() throws Exception {
        ...
        final var rpcImplementations = List.of(
            ...
            new ModifySubscriptionRpc(streamRegistry, dataBindProvider),
            new DeleteSubscriptionRpc(streamRegistry, dataBindProvider),
            new KillSubscriptionRpc(streamRegistry, dataBindProvider));
