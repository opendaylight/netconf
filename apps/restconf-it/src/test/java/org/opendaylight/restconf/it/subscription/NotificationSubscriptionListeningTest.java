...
class NotificationSubscriptionListeningTest extends AbstractNotificationSubscriptionTest {
    ...
    protected void beforeEach() throws Exception {
        super.beforeEach();
        subscriptionId = startSubscription();
    }
     ...
     *
     * <p>NB: not parameterized over HTTP_1_1 -- listening on multiple concurrent streams over a single client
    ...
    void listenMultipleStreams(final ProtocolVersion version) throws Exception {
        // create second subscription (first was already established in beforeEach())
        final var subscription2Id = startSubscription();

        // create listeners on same client
        final var eventListener1 = startSubscriptionStream(subscriptionId, version);
