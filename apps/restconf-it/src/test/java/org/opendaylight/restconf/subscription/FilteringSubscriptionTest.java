...
import org.opendaylight.yang.gen.v1.test.notification.rev250303.TestNotification;
import org.opendaylight.yang.gen.v1.test.notification.rev250303.test.notification.Properties;
...
public class FilteringSubscriptionTest extends AbstractNotificationSubscriptionTest {
    ...
    private static final QName QNAME_PROPERTY_ID = QName.create(Properties.QNAME, "id");
    private static final QName QNAME_PROPERTY_NAME = QName.create(Properties.QNAME, "name");
    ...
    void filterNotificationPartialTest() throws Exception {
        ...
        final var toasterRestockedNotification = ImmutableNodes.newContainerBuilder()
            .withNodeIdentifier(NodeIdentifier.create(TestNotification.QNAME))
            .withChild(ImmutableNodes.newSystemMapBuilder()
                .withNodeIdentifier(NodeIdentifier.create(Properties.QNAME))
                .withChild(ImmutableNodes.newMapEntryBuilder()
                    .withNodeIdentifier(YangInstanceIdentifier.NodeIdentifierWithPredicates.of(Properties.QNAME,
