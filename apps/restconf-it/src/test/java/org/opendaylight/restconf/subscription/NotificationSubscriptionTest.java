...
public class NotificationSubscriptionTest extends AbstractNotificationSubscriptionTest {
    ...
    void listenToNotificationsTest() throws Exception {
        ...
        final var response = invokeRequest(HttpMethod.GET, "/restconf/subscriptions/" + subscriptionId, null,
            "text/event-stream");
    ...
    void listenToNonExistentSubscriptionTest() throws Exception {
        final var response = invokeRequest(HttpMethod.GET, "/restconf/subscriptions/99999", null,
            "text/event-stream");
