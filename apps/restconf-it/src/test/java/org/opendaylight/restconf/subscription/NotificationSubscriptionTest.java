...
class NotificationSubscriptionTest extends AbstractNotificationSubscriptionTest {
    ...
    void modifySubscriptionTest() throws Exception {
        ...
        final var request2 = buildRequest(HttpMethod.POST, KILL_SUBSCRIPTION_URI, APPLICATION_JSON, modifyInput,
            APPLICATION_JSON);
    ...
    void listenToNotificationsTest() throws Exception {
        ...
        final var request2 = buildRequest(HttpMethod.GET, "/restconf/subscriptions/2147483648", APPLICATION_JSON, null,
            "text/event-stream");
        final var response = invokeTwoRequests(request1, request2);
    ...
    private FullHttpRequest prepareEstablishRPCRequest() {
        ...
        final var request1 = buildRequest(HttpMethod.POST, ESTABLISH_SUBSCRIPTION_URL, APPLICATION_JSON, input,
            APPLICATION_JSON);
        return request1;
    }
}
