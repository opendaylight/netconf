...
public class SubscriptionSuspensionTest extends AbstractNotificationSubscriptionTest {
    private static final YangInstanceIdentifier.NodeIdentifier BREAD_NODEID =
        YangInstanceIdentifier.NodeIdentifier.create(QName.create(ToasterRestocked.QNAME, "amountOfBread").intern());
    ...
    void testSubscriptionSuspension() throws Exception {
        ...
        JSONAssert.assertEquals(String.format("""
            ...
            }""", FORMATTED_EVENT_TIME), listener.readNext(), JSONCompareMode.LENIENT);
