...
public abstract class AbstractTest extends AbstractDataBrokerTest {
    ...
    private String host;
    public HttpClientStackGrouping clientStackGrouping;
    public DOMRpcRouter domRpcRouter;
    public SimpleNettyEndpoint endpoint;
    public DOMNotificationRouter domNotificationRouter;
    public MdsalRestconfStreamRegistry streamRegistry;
    public MdsalDatabindProvider dataBindProvider;

    public ConstantAdapterContext adapterContext;
    ...
    protected void beforeEach() throws Exception {
        ...
        final FixedDOMSchemaService schemaService = new FixedDOMSchemaService(schemaContext);
        dataBindProvider = new MdsalDatabindProvider(schemaService);
        ...
        final var server = new MdsalRestconfServer(dataBindProvider, domDataBroker,
            ...
            rpcImplementations(domDataBroker));
