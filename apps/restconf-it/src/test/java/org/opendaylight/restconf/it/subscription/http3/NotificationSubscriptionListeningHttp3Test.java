...
/**
 * Subscriptions are established and maintained using HTTP/1 requests.
 * Using HTTP/3 for subscription creation results in the subscription being
 * immediately terminated, because the underlying request stream is closed once
 * the response is completed.
 * HTTP/1 uses a persistent connection and subscription is not closed.
 */
