...
class NotificationSubscriptionTest extends AbstractNotificationSubscriptionTest {
    ...
    private FullHttpResponse establishSubscription(final String stream) throws Exception {
        ...
        return invokeRequestHttp1(HttpMethod.POST, ESTABLISH_SUBSCRIPTION_URI, APPLICATION_JSON, APPLICATION_JSON,
            input);
    }
    ...
    private FullHttpResponse establishSubscriptionWithFilter(final String stream, final String filter)
        ...
        return invokeRequestHttp1(HttpMethod.POST, ESTABLISH_SUBSCRIPTION_URI, APPLICATION_XML, APPLICATION_JSON,
            input);
    }
