...
public class AbstractOpenApiTest extends AbstractDataBrokerTest {
    protected static final JSONParserConfiguration JSON_PARSER_CONFIGURATION = new JSONParserConfiguration()
        .withStrictMode();

    protected static final ErrorTagMapping ERROR_TAG_MAPPING = ErrorTagMapping.RFC8040;
    protected static final String TOPOLOGY_URI =
        "/rests/data/network-topology:network-topology/topology=topology-netconf";
    protected static final String DEVICE_NODE_URI = TOPOLOGY_URI + "/node=device-sim";
    protected static final String DEVICE_STATUS_URI =
