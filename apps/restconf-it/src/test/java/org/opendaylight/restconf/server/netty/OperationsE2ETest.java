...
class OperationsE2ETest extends AbstractE2ETest {
    ...
    @Test
    void invalidOperationErrorXML() throws Exception {
    ...
    @Test
    void missingDataErrorXml() throws Exception {
        final var response = invokeRequest(HttpMethod.POST,
            ADD_KEYSTORE_ENTRY,
            APPLICATION_XML,
            """
        ...
        assertErrorResponseXml(response, ErrorType.PROTOCOL, ErrorTag.OPERATION_FAILED);
    }

    @Test
    void invalidDataErrorXml() throws Exception {
        final var response = invokeRequest(HttpMethod.POST,
            ADD_KEYSTORE_ENTRY,
            APPLICATION_XML,
            """
