...
public class MountPointDocumentTest extends MountPointE2ETest {
    ...
    void beforeEach() {
        ...
        final var reg = domMountPointService
            .createMountPoint(YangInstanceIdentifier.of(QName.create("mount:point:1", "2024-11-21", "cont")))
            .addService(DOMSchemaService.class, schemaService)
            .addService(DOMDataBroker.class, domDataBroker)
            .register();
