...
abstract class AbstractNotificationSubscriptionTest extends AbstractDataBrokerTest {
    ...
    protected BindingRuntimeContext getRuntimeContext() throws Exception {
        // TODO see {@link ModuleInfoSnapshotResolver} and {@link ModuleInfoSnapshotBuilder}
        //  how to select supported features
        return BindingRuntimeHelpers.createRuntimeContext(getModuleInfos());
    }
