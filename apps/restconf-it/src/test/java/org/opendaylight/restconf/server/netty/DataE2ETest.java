...
class DataE2ETest extends AbstractE2ETest {
    ...
    @Test
    void invokeActionWithBadInputs() throws Exception {
        // invoke action
        final var response = invokeRequest(HttpMethod.POST, ACTIONS_URI + "/example-action", APPLICATION_JSON,
            """
            {
        ...
        assertErrorResponseJson(response, ErrorType.PROTOCOL, ErrorTag.OPERATION_FAILED);
    }

    @Test
    void invokeNotImplementedAction() throws Exception {
    ...
    @Test
    void yangPatch() throws Exception {
        // CRUD
    ...
    @Test
    void yangPatchDataMissingError() throws Exception {
    ...
    @Test
    void yangPatchDataExistsError() throws Exception {
        // One correct edit, one - not
        var response = invokeRequest(HttpMethod.PATCH, ITEM_URI, MediaTypes.APPLICATION_YANG_PATCH_JSON, """
            {
                "ietf-yang-patch:yang-patch" : {
