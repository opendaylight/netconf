...
class DataE2ETest extends AbstractE2ETest {
    private static final String ROOT_URI = "/rests/data";
    private static final String TOPOLOGY_URI = ROOT_URI
    ...
    void dataOptions() throws Exception {
        ...
        // root
        var response = invokeRequest(HttpMethod.OPTIONS, ROOT_URI);
