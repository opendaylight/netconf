...
class YangLibraryWriterTest {
    ...
    void noUpdate() {
        writer = new YangLibraryWriter(schemaService, dataBroker, (YangLibrarySchemaSourceUrlProvider) null);
    ...
    void clearOnClose(final boolean writeLegacy) throws Exception {
        ...
        try (var writer = new YangLibraryWriter(schemaService, dataBroker, config)) {
            // nothing else
        }
