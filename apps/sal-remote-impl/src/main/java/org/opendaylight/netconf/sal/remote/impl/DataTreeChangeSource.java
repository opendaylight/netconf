...
public final class DataTreeChangeSource extends Source<List<DataTreeCandidate>> {
    private static final ImmutableMap<StreamEncoding, DataTreeCandidateFormatterFactory> ENCODINGS = ImmutableMap.of(
        StreamEncoding.Rfc8040Encoding.JSON, JSONDataTreeCandidateFormatter.FACTORY,
        StreamEncoding.Rfc8040Encoding.XML, XMLDataTreeCandidateFormatter.FACTORY);
