...
public class CallHomeMountStatusReporterTest {
    ...
    /**
     * Tests if device is disconnected when device is removed from allowed devices.
     */
    @Test
    ...
    /**
     * Tests if multiple devices are disconnected when devices are removed from allowed devices.
     */
    @Test
    void testDeviceDeletion2() {
        var reporter = new CallHomeMountStatusReporter(dataBroker, mountService);
