...
public final class CallHomeMountService implements AutoCloseable {
    ...
    public CallHomeMountService(
        ...
        this(NetconfNodeUtils.DEFAULT_TOPOLOGY_NAME, scheduledThreadPool.getExecutor(),
            processingThreadPool.getExecutor(), schemaRepositoryProvider, baseSchemas,
            dataBroker, mountService, deviceActionFactory);
    }

    public CallHomeMountService(final String topologyId,
        ...
        topology = new CallHomeTopology(topologyId, clientFactory, scheduledExecutor, processingExecutor,
