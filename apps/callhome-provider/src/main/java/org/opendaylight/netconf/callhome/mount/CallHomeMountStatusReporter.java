...
public final class CallHomeMountStatusReporter implements CallHomeStatusRecorder, AutoCloseable {
    ...
    @Override
    public void reportFailedAuth(String id) {
        updateCallHomeDeviceStatus(id, DeviceStatus.FAILEDAUTHFAILURE);
    }

    @Override
    public void reportNetconfFailure(String id) {
        updateCallHomeDeviceStatus(id, DeviceStatus.FAILED);
    }

    @Override
    public void reportUnknown(SocketAddress address, PublicKey publicKey) {
    ...
    private void writeDevice(InstanceIdentifier<Device> instanceIdentifier, final Device device) {
