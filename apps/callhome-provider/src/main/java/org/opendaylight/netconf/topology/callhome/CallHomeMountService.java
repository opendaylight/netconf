...
public final class CallHomeMountService implements AutoCloseable {
    ...
    public CallHomeMountService(final String topologyId, final NetconfTimer timer,
        ...
        this.config = config;
        allowedDevicesReg = dataBroker.registerTreeChangeListener(DataTreeIdentifier.of(
            LogicalDatastoreType.CONFIGURATION, DEVICE_IDENTIFIER), this::onAllowedDevicesChanged);
    ...
    CallHomeMountService(final CallHomeTopology topology, final Configuration config,
            final Registration allowedDevicesReg) {
        this.topology = topology;
        this.config = config;
        this.allowedDevicesReg = allowedDevicesReg;
    }
