...
public class SubscribedEventStreamServiceTest {
    ...
    @BeforeEach
    void setUp() {
        service = new SubscribedEventStreamService(machine, SUBSCRIPTIONS_BASE_URI, ErrorTagMapping.RFC8040, PrettyPrintParam.FALSE);
    }

    @Test
    void testStartEventStreamInvalidStreamUri() {
        final var invalidUri = "/invalid/path";
        service = new SubscribedEventStreamService(machine, invalidUri, ErrorTagMapping.RFC8040, PrettyPrintParam.FALSE);
