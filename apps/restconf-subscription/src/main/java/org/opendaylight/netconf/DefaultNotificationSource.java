...
final class DefaultNotificationSource extends AbstractNotificationSource implements Closeable {
    ...
    DefaultNotificationSource(@Reference final DOMSchemaService schemaService,
            @Reference final DOMNotificationService notificationService, EffectiveModelContext context) {
    ...
    @Override
    protected Registration start(final Sink<DOMNotification> domNotificationSink) {
        this.sink = domNotificationSink;
