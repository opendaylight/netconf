...
public class EstablishSubscriptionRpc extends RpcImplementation {
    ...
    public void invoke(final ServerRequest<ContainerNode> request, final URI restconfURI, final OperationInput input) {
        ...
        try {
            if (!mdsalService.read(SubscriptionUtil.STREAMS.node(NodeIdentifierWithPredicates.of(Stream.QNAME,
        ...
        if (streamFilter != null) {
            ...
            if (streamFilterName != null) {
                try {
                    if (!mdsalService.read(SubscriptionUtil.FILTERS.node(NodeIdentifierWithPredicates.of(
        ...
        return ImmutableNodes.newContainerBuilder().withNodeIdentifier(NodeIdentifier
            .create(Receivers.QNAME))
                .withChild(ImmutableNodes.newSystemMapBuilder()
                    ...
                    .withChild(ImmutableNodes.leafNode(SubscriptionUtil.QNAME_RECEIVER_STATE, Receiver.State.Active))
                    .build())
                .build())
            .build();
    }
