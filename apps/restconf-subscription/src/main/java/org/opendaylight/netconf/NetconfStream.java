...
public final class NetconfStream {
    ...
    private final ServerRequest<ContainerNode> request;
    private final DOMSchemaService schemaService;
    private final DOMNotificationService notificationService;

    @Inject
    @Activate
    public NetconfStream(@Reference final DOMDataBroker dataBroker, @Reference ServerRequest<ContainerNode> request, DOMSchemaService schemaService, DOMNotificationService notificationService){
    ...
    public void startStream() {
        ...
        restconfSubscriptionsStreamRegistry.createStream(null, restconfURI,
            new DefaultNotificationSource(null,null,null), "stream description");
