...
public class SubscriptionStateMachine {
    ...
    private Map<Uint32, SessionStatePair> subscriptionStateMap = new HashMap<>();
    ...
    public TransportSession getSubscriptionSession(final Uint32 subscriptionId) {
        ...
        return currentState.getSession();
    }
     ...
     */
    class SessionStatePair {
        private TransportSession session;
        private SubscriptionState state;

        SessionStatePair(final TransportSession session, final SubscriptionState state) {
            this.session = session;
            this.state = state;
        }

        TransportSession getSession() {
            return session;
        }
