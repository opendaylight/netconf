...
/**
 * A utility responsible for creating the default {@link RestconfStream} named "NETCONF".
 * This stream provides all controller's YANG notifications as described in
 * <a href="https://www.rfc-editor.org/rfc/rfc8040#section-6.3.1">RFC 8040</a> for the purposes of subscribed
 * notifications defined in <a href="https://www.rfc-editor.org/rfc/rfc8639">RFC 8639</a>.
 *
...
public final class NetconfStream implements Closeable {
    ...
    public NetconfStream(@Reference final DOMSchemaService schemaService,
        ...
        DefaultNotificationSource notificationSource = new DefaultNotificationSource(notificationService,
        ...
        contextListenerReg = new ContextListener(notificationService, notificationSource, schemaService);
    }
