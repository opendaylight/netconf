...
public class NetconfTopologyImpl extends AbstractNetconfTopology
    ...
    @Override
    protected RemoteDeviceHandler createSalFacade(RemoteDeviceId id, boolean lockDatastore) {
        return new NetconfDeviceSalFacade(id, mountPointService, NetconfNodeUtils.defaultTopologyMountPath(id),
                lockDatastore);
    }
}
