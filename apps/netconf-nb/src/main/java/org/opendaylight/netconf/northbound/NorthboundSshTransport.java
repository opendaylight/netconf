...
@Designate(ocd = NorthboundSshTransport.Configuration.class)
public final class NorthboundSshTransport extends AbstractServerTransport implements AutoCloseable {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(NorthboundSshTransport.class);

    private final SSHServer sshServer;

    @Activate
    public NorthboundSshTransport(@Reference final NettyFootprint netty, @Reference final OSGiNetconfServer backend,
    ...
    public NorthboundSshTransport(final NettyFootprint netty, final OSGiNetconfServer backend,
