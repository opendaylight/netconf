...
public final class TcpServerTransport extends AbstractServerTransport implements AutoCloseable {
    ...
    @Activate
    public TcpServerTransport(@Reference final NettyFootprint netty, @Reference final OSGiNetconfServer backend,
    ...
    public TcpServerTransport(final NettyFootprint netty, final OSGiNetconfServer backend,
        ...
        try {
            tcpServer = TCPServer.listen(this, netty.newServerBootstrap(), listenParams).get();
