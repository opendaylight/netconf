...
public final class TcpServerTransport extends BaseServerTransport implements AutoCloseable {
    ...
    public TcpServerTransport(@Reference final NettyThreads threads, @Reference final OSGiNetconfServer backend,
        ...
        this(threads, backend, new TcpServerParametersBuilder()
    ...
    public TcpServerTransport(final NettyThreads threads, final OSGiNetconfServer backend,
        ...
        try {
            tcpServer = TCPServer.listen(this, threads.newServerBootstrap(), listenParams).get();
