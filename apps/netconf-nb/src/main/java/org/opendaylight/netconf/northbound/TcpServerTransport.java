...
public final class TcpServerTransport extends BaseServerTransport implements AutoCloseable {
    ...
    @Activate
    public TcpServerTransport(@Reference final NettyThreads threads, @Reference final OSGiNetconfServer backend,
            final Configuration configuration) {
        // FIXME: create an instantiation and do not use TLS
        this(threads, backend.serverChannelInitializer(), new TcpServerParametersBuilder()
    ...
    public TcpServerTransport(final NettyThreads threads, final ServerChannelInitializer initializer,
        ...
        try {
            tcpServer = TCPServer.listen(this, threads.factory().newServerBootstrap(), listenParams).get();
