...
public final class DefaultNetconfServerFactory implements NetconfServerFactory {
    ...
    @Override
    public ListenableFuture<SSHServer> createSshServer(final TcpServerGrouping tcpParams,
            final SshServerGrouping sshParams, final Consumer<ServerFactoryManager> extFactoryConfiguration)
            throws UnsupportedConfigurationException {
        return delegate.createSshServer(tcpParams, sshParams, extFactoryConfiguration);
    }
}
