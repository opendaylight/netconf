...
public class NetconfTopologyImpl implements NetconfTopology, AutoCloseable {
    ...
    public NetconfTopologyImpl(final NetconfClientDispatcher clientDispatcher, final BindingAwareBroker bindingAwareBroker,
                               final Broker domBroker, final EventExecutor eventExecutor, final ScheduledThreadPool keepaliveExecutor,
