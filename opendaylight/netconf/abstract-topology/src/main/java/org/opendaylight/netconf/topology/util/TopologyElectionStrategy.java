...
public class TopologyElectionStrategy implements ElectionStrategy, DataTreeChangeListener<Node> {

    private static final Logger LOG = LoggerFactory.getLogger(TopologyElectionStrategy.class);
    ...
    public TopologyElectionStrategy(final DataBroker dataBroker,
