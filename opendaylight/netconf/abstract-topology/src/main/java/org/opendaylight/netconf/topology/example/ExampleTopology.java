...
public class ExampleTopology implements NodeAdministratorCallback<Node, ExampleTopology.CustomMessage> {

    private final BaseTopologyAdmin<Node, CustomMessage> netconfNodeBaseTopologyAdmin;
    ...
    public ExampleTopology(final DataBroker dataBroker) {
        netconfNodeBaseTopologyAdmin = new BaseTopologyAdmin<>(dataBroker, "topology-netconf", this,
            new ConnectionAggregator.SingleConnectionAggregator<Node>());
    }
