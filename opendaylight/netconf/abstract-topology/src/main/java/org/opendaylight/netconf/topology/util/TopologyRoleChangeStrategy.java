...
public class TopologyRoleChangeStrategy implements RoleChangeStrategy, DataTreeChangeListener<Node>, EntityOwnershipListener {
    ...
    public void onRoleChanged(RoleChangeDTO roleChangeDTO) {
        if (roleChangeDTO.isOwner()) {
            LOG.trace("Gained ownership of entity, registering datastore listener");
