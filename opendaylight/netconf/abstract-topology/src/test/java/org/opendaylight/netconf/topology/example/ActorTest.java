...
import org.opendaylight.netconf.topology.Peer.PeerContext;
...
//        final TopologyManagerCallbackFactory<UserDefinedMessage> topologyManagerCallbackFactory = createRealTopoCallbackFactory();
    ...
    public TopologyManager createNode(final ActorSystem actorSystem, final String topologyId, final List<String> remotePaths, final boolean isMaster,
                                      final TopologyManagerCallbackFactory<UserDefinedMessage> topologyManagerCallbackFactory) {
...
//        final TopologyManagerCallbackFactory<UserDefinedMessage> topologyManagerCallbackFactory = createRealTopoCallbackFactory();
    ...
    private TopologyManagerCallbackFactory<UserDefinedMessage> createRealTopoTestingNodeCallbackFactory() {
    ...
    public static class LoggingNodeManagerCallback implements NodeManagerCallback<UserDefinedMessage> {
