...
public final class KeepaliveSalFacade implements RemoteDeviceHandler<NetconfSessionPreferences> {
    ...
    private static final ContainerNode KEEPALIVE_PAYLOAD =
            NetconfMessageTransformUtil.wrap(NetconfMessageTransformUtil.NETCONF_GET_CONFIG_QNAME, NetconfBaseOps.getSourceNode(NetconfMessageTransformUtil.NETCONF_RUNNING_QNAME), NetconfMessageTransformUtil.EMPTY_FILTER);
