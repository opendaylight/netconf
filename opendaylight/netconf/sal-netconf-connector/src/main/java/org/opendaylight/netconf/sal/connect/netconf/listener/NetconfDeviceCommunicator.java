...
public class NetconfDeviceCommunicator implements NetconfClientSessionListener, RemoteDeviceCommunicator<NetconfMessage> {
    ...
    private SettableFuture<Void> firstConnectionFuture;
    ...
    public void onSessionUp(final NetconfClientSession session) {
        ...
        try {
            ...
            if (!firstConnectionFuture.isDone()) {
                firstConnectionFuture.set(null);
            }
        }
        finally {
            sessionLock.unlock();
     ...
     */
    public ListenableFuture<Void> initializeRemoteConnection(final NetconfClientDispatcher dispatcher, final NetconfClientConfiguration config) {
