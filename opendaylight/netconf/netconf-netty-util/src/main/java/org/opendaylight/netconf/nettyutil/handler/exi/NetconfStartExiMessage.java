...
public final class NetconfStartExiMessage extends NetconfMessage {
    private static final String START_EXI = "start-exi";
    ...
    private static void addAlignment(final EXIParameters exiOptions, final Document doc, final Element startExiElement) {
