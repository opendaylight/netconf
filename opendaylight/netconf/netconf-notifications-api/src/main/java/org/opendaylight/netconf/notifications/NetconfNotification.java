...
public final class NetconfNotification extends NetconfMessage {
     ...
     */
    public static final String RFC3339DateFormatWithMillisBlueprint(int digits) {
        // The format with milliseconds is a bit fragile.
        // It cannot be used for timestamps without millis (thats why its a separate format)
