...
public class JsonToPATCHBodyReader extends AbstractIdentifierAwareJaxRsProvider implements MessageBodyReader<PATCHContext> {
     ...
     * @throws IOException
     */
    private void readEditDefinition(PatchEdit edit, JsonReader in, InstanceIdentifierContext path,
                                         StringModuleInstanceIdentifierCodec codec) throws IOException {
        in.beginObject();
