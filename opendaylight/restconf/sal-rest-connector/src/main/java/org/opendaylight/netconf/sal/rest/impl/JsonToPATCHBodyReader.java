...
public class JsonToPATCHBodyReader extends AbstractIdentifierAwareJaxRsProvider implements MessageBodyReader<PATCHContext> {
    ...
    public static List<PATCHEntity> read(final JsonReader in, InstanceIdentifierContext path) throws
            IOException {
...
//                            final InstanceIdentifierContext targetPath = new InstanceIdentifierContext(targetII,
//                                    targetNode, path.getMountPoint(), path.getSchemaContext());


                            resultCollection.add(new PATCHEntity(operation, targetII, resultHolder.getResult()));
                            inValue = false;
