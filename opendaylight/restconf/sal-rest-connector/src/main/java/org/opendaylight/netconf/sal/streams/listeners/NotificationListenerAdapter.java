...
public class NotificationListenerAdapter implements DOMNotificationListener {
    ...
    private Object prepareValueByType(final DataContainerChild<? extends PathArgument, ?> innerChild,
        ...
        // final Module moduleOfLeaf =
        // this.schemaContext.findModuleByNamespaceAndRevision(
        // innerChild.getNodeType().getNamespace(),
        // innerChild.getNodeType().getRevision());

        // DataSchemaNode dataSchemaNode =
        // moduleOfLeaf.getDataChildByName(innerChild.getNodeType());
        // if (dataSchemaNode == null) {
        // for (final GroupingDefinition groupingDefinition :
        // moduleOfLeaf.getGroupings()) {
        // dataSchemaNode =
        // groupingDefinition.getDataChildByName(innerChild.getNodeType());
        // if (dataSchemaNode != null) {
        // break;
        // }
        // }
        // for (final NotificationDefinition notificationDefinition :
        // moduleOfLeaf.getNotifications()) {
        // dataSchemaNode =
        // notificationDefinition.getDataChildByName(innerChild.getNodeType());
        // if (dataSchemaNode != null) {
        // break;
        // }
        // }
        // for(final AugmentationSchema augmenrDef :
        // moduleOfLeaf.getAugmentations()){
        // augmenrDef.getDataChildByName(name)
        // }
        // }
