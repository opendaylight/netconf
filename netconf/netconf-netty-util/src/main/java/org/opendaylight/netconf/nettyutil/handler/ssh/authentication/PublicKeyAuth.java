...
public class PublicKeyAuth extends LoginPassword {
    ...
    public PublicKeyAuth(String username, String password, String keyPath, String passPhrase,
        ...
        try {
            Preconditions.checkState(keyPath!=null && !keyPath.equals(""),"Private key path not specified");
            Preconditions.checkNotNull(passPhrase!=null, "Private key passphrase not specified");
