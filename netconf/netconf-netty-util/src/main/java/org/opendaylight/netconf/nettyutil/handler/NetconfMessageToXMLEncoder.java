...
public class NetconfMessageToXMLEncoder extends MessageToByteEncoder<NetconfMessage> {
    ...
    @Override
    @VisibleForTesting
    public void encode(final ChannelHandlerContext ctx, final NetconfMessage msg, final ByteBuf out) throws
        ...
        try (OutputStream os = new ByteBufOutputStream(out)) {
            ...
            StreamResult result = new StreamResult(new BufferedWriter(new OutputStreamWriter(os, StandardCharsets
                    .UTF_8)));
