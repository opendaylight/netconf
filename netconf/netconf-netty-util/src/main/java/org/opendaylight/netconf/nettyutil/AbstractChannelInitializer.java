...
import org.opendaylight.netconf.nettyutil.handler.HelloXMLMessageWriter;
...
public abstract class AbstractChannelInitializer<S extends NetconfSession> {
    ...
    public void initialize(final Channel ch, final Promise<S> promise) {
        ...
        ch.pipeline().addLast("netconfMessageEncoder", new MessageEncoder(new HelloXMLMessageWriter()));
