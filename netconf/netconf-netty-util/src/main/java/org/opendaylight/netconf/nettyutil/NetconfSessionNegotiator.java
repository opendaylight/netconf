...
public abstract class NetconfSessionNegotiator<S extends AbstractNetconfSession<S, L>,
    ...
    private void start() {
        ...
        channel.pipeline().get(MessageEncoder.class).setWriter(new XMLMessageWriter());
    ...
    private void insertChunkFramingToPipeline() {
        replaceChannelHandler(channel, FrameEncoder.HANDLER_NAME, new ChunkedFrameEncoder());
