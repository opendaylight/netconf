...
public class NetconfClientSessionImpl extends ClientSessionImpl implements NetconfClientSession {
    ...
    @Override
    public NetconfChannelSubsystem createNetconfSubsystemChannel(final ChannelHandlerContext ctx,
            final PooledByteBufAllocator byteBufAllocator) throws IOException {
        final NetconfChannelSubsystem channel = new NetconfChannelSubsystem(ctx, byteBufAllocator);
