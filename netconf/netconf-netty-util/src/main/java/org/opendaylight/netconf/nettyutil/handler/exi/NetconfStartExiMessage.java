...
public final class NetconfStartExiMessage extends NetconfMessage {
    ...
    private static void addAlignment(final EXIOptions exiOptions, final Document doc, final Element startExiElement) {
        ...
        switch (exiOptions.getAlignmentType()) {
            ...
            default:
                LOG.warn("Unexpected value in EXI alignment type: {} , using default value", exiOptions
                        .getAlignmentType());
            case bitPacked: {
    ...
    private static void createFidelityElement(final Document doc, final List<Element> fidelityElements, final boolean
            fidelity, final String fidelityName) {
