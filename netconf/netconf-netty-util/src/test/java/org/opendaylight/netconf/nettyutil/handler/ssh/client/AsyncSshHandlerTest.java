...
public class AsyncSshHandlerTest {
    ...
    public void testConnectSuccess() throws Exception {
        ...
        final NetconfChannelSubsystem subsystemChannel = getMockedSubsystemChannel(asyncOut, asyncIn);
    ...
    private NetconfClientSession getMockedSshSession(final NetconfChannelSubsystem subsystemChannel)
            throws IOException {
        final NetconfClientSession sshSession = mock(NetconfClientSession.class);
        ...
        doReturn(subsystemChannel).when(sshSession).createNetconfSubsystemChannel(any(), this.pooledByteBufAllocator);

        return sshSession;
    }

    private NetconfChannelSubsystem getMockedSubsystemChannel(final IoInputStream asyncOut,
                                                       final IoOutputStream asyncIn) throws IOException {
        final NetconfChannelSubsystem subsystemChannel = mock(NetconfChannelSubsystem.class);
