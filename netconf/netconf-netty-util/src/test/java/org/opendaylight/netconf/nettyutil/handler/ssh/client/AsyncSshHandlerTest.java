...
public class AsyncSshHandlerTest {
    ...
    private static NetconfClientSession getMockedSshSession(final NetconfChannelSubsystem subsystemChannel)
            throws IOException {
        ...
        doReturn(subsystemChannel).when(sshSession).createNetconfSubsystemChannel(any());
