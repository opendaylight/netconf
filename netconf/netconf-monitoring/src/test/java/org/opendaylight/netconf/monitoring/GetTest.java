...
public class GetTest {
    ...
    public void testHandleNoSubsequent() throws Exception {
        try {
            ...
            assertNetconfDocumentedEx(e, DocumentedException.ErrorSeverity.ERROR, DocumentedException.ErrorTag
                    .OPERATION_FAILED, DocumentedException.ErrorType.APPLICATION);
            return;
        }
    ...
    public void testHandleWrongPlaceholder() throws Exception {
        ...
        try {
            ...
            assertNetconfDocumentedEx(e, DocumentedException.ErrorSeverity.ERROR, DocumentedException.ErrorTag
                    .INVALID_VALUE, DocumentedException.ErrorType.APPLICATION);
            return;
        }
