...
import static org.opendaylight.yangtools.yang.test.util.YangParserTestUtils.parseYangSource;
...
public class CopyConfigTest {
    ...
    public void setUp() throws Exception {
        ...
        final SchemaContext schemaContext = parseYangSource("/yang/mdsal-netconf-mapping-test.yang");
