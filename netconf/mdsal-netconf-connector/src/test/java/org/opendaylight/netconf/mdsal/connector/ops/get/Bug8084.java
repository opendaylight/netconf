...
public class Bug8084 {
    ...
    public void testValidateTypes() throws Exception {
        ...
        final Document document = XmlUtil.readXmlToDocument(FilterContentValidatorTest.class.getResourceAsStream("/filter/f14.xml"));
        ...
        inputs.put(QName.create(base, "id6"), Byte.valueOf("9"));
        inputs.put(QName.create(base, "id7"), Short.valueOf("30000"));
