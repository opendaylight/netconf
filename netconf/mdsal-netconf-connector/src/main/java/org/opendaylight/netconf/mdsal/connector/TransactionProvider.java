...
import static org.opendaylight.netconf.mdsal.connector.DOMDataTransactionValidator.DataValidationFailedException;
...
public class TransactionProvider implements AutoCloseable {
    ...
    public synchronized boolean validateTransaction() throws DocumentedException {
        ...
        try {
            ...
            LOG.debug("Candidate transaction validation {} failed on", candidateTransaction, e);
