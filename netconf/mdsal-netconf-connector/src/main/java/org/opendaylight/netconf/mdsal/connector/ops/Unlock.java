...
// netconf/netconf/config-netconf-connector/src/main/java/org/opendaylight/netconf/confignetconfconnector/operations
// /UnLock.java
public class Unlock extends AbstractSingletonNetconfOperation {
    ...
    protected Element handleWithNoSubsequentOperations(final Document document, final XmlElement operationElement)
        ...
        throw new DocumentedException("Unable to unlock " + targetDatastore + " datastore", DocumentedException
