...
public class MdsalNetconfOperationServiceFactory implements NetconfOperationServiceFactory, AutoCloseable {
    ...
    public MdsalNetconfOperationServiceFactory(final SchemaService schemaService,
                                               final SchemaSourceProvider<YangTextSchemaSource>
    ...
    static Set<Capability> transformCapabilities(final SchemaContext currentContext, final
        SchemaSourceProvider<YangTextSchemaSource> rootSchemaSourceProviderDependency) {
