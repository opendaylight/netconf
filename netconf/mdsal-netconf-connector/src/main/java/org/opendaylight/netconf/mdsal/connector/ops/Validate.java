...
public class Validate extends AbstractSingletonNetconfOperation {
    ...
    protected Element handleWithNoSubsequentOperations(final Document document, final XmlElement operationElement)
        ...
        final NetconfReadWriteTransaction rwTx = transactionProvider.getOrCreateTransaction();
        try {
            rwTx.validate().checkedGet();
        } catch (OperationFailedException e) {
            LOG.warn("Unable to validate <candidate>: {}", e);
            // TODO: throw DocumentedException
            throw new IllegalStateException("Unable to validate <candidate>", e);
        }
