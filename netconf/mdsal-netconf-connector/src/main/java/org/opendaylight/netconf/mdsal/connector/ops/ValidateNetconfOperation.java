...
public abstract class ValidateNetconfOperation extends MdsalNetconfOperation {
    private static final Logger LOG = LoggerFactory.getLogger(ValidateNetconfOperation.class);

    private final CurrentSchemaContext schemaContext;

    protected ValidateNetconfOperation(String netconfSessionIdForReporting, CurrentSchemaContext schemaContext, final NetconfFileService netconfFileService) {
