...
class EditOperationStrategyProvider extends DomToNormalizedNodeParserFactory.BuildingStrategyProvider {
    ...
    private static class NetconfOperationCollectionStrategy<N extends NormalizedNode<YangInstanceIdentifier
        ...
        @Override
        public void prepareAttributes(final Map<QName, String> attributes, final
            NormalizedNodeBuilder<YangInstanceIdentifier.NodeIdentifier, ?, N> containerBuilder) {
    ...
    public static final class NetconfOperationLeafStrategy implements ExtensibleParser
        ...
        @Nullable
        @Override
        public LeafNode<?> build(final NormalizedNodeBuilder<YangInstanceIdentifier.NodeIdentifier, ?, LeafNode<?>>
                                                 builder) {
    ...
    public static final class NetconfOperationLeafSetEntryStrategy implements ExtensibleParser
        ...
        @Nullable
        @Override
        public LeafSetEntryNode<?> build(final NormalizedNodeBuilder<YangInstanceIdentifier.NodeWithValue, ?,
                LeafSetEntryNode<?>> builder) {
