...
public class EditConfig extends AbstractSingletonNetconfOperation {
    ...
    Datastore extractTargetParameter(final XmlElement operationElement) throws DocumentedException {
        final NodeList elementsByTagName = getElementsByTagName(operationElement);
    ...
    private NodeList getElementsByTagName(final XmlElement operationElement) throws DocumentedException {
