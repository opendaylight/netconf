...
public class EditConfig extends AbstractSingletonNetconfOperation {
    ...
    private void executeChange(final DOMDataReadWriteTransaction rwtx, final DataTreeChange change) throws DocumentedException {
        ...
        case NONE:
            return;
        case MERGE:
            createMixinNodeIfNonExistent(rwtx, path, changeData);
    ...
    private void createMixinNodeIfNonExistent(final DOMDataReadWriteTransaction rwtx, final YangInstanceIdentifier path,
