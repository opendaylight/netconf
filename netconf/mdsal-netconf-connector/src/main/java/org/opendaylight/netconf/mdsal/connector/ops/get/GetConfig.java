...
public class GetConfig extends AbstractGet {
    ...
    public GetConfig(String netconfSessionIdForReporting, CurrentSchemaContext schemaContext,
                     TransactionProvider transactionProvider) {
        super(netconfSessionIdForReporting, schemaContext, transactionProvider, LogicalDatastoreType.CONFIGURATION);
    }

    @Override
    Datastore getNetconfDatastore(XmlElement operationElement) throws DocumentedException {
    ...
    private static final class GetConfigExecution {
        ...
        private static GetConfigExecution fromXml(XmlElement xml, String operationName)
        ...
        private static Datastore parseSource(XmlElement xml) throws DocumentedException {
        ...
        private static void validateInputRpc(XmlElement xml, String operationName) throws
                DocumentedException {
