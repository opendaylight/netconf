...
public class IetfZeroTouchCallHomeServerProvider implements AutoCloseable, DataChangeListener
{
    ...
    private ListenerRegistration<IetfZeroTouchCallHomeServerProvider> listenerReg;
    ...
    public void onDataChanged(AsyncDataChangeEvent<InstanceIdentifier<?>, DataObject> change) {
        ...
        // As of now, no way to add a new callhome client key to the CallHomeAuthorization instance since its created under CallHomeAuthorizationProvider.
    ...
    private List<Device> getReadDevices(CheckedFuture<Optional<AllowedDevices>, ReadFailedException> devicesFuture) throws ReadFailedException
    {
