...
class CallHomeMountSessionContext {
    ...
    public CallHomeMountSessionContext(String nodeId, CallHomeProtocolSessionContext protocol,
    ...
    public <V> Promise<V> activateNetconfChannel(NetconfClientSessionListener sessionListener) {
