 ...
 */
public class NetconfTcpModule implements AutoCloseable {

    private static final Logger LOG = LoggerFactory.getLogger(NetconfTcpModule.class);

    private final ChannelFuture tcpServer;

    public NetconfTcpModule(final NetconfServerDispatcher netconfServerDispatcher,
