 ...
 */
class ReadTransactionActor extends UntypedActor {
    ...
    private void read(final YangInstanceIdentifier path, final LogicalDatastoreType store, final ActorRef sender, final ActorRef self) {
    ...
    private void exists(final YangInstanceIdentifier path, final LogicalDatastoreType store, final ActorRef sender, final ActorRef self) {
