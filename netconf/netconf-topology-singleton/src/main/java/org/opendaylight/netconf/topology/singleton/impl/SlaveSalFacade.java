...
import org.opendaylight.netconf.topology.singleton.impl.tx.NetconfProxyDOMTransactions;
...
public class SlaveSalFacade {
    ...
    public void registerSlaveMountPoint(final SchemaContext remoteSchemaContext, final DOMRpcService deviceRpc,
        ...
        final NetconfDOMTransactions proxyDOMTransactions =
                new NetconfProxyDOMTransactions(actorSystem, masterActorRef);
