...
public final class NetconfTopologyUtils {
    ...
    public static @NonNull NodeId getNodeId(final InstanceIdentifier.PathArgument pathArgument) {
        if (pathArgument instanceof InstanceIdentifier.IdentifiableItem<?, ?> identifiableItem
