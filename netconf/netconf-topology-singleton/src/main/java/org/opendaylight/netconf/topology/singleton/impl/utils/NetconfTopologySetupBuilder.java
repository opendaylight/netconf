...
public class NetconfTopologySetupBuilder {

    private ClusterSingletonServiceProvider clusterSingletonServiceProvider;
    private RpcProviderRegistry rpcProviderRegistry;
    private DataBroker dataBroker;
    private InstanceIdentifier<Node> ident;
    private Node node;
    ...
    private InstanceIdentifier<Node> getIdent() {
        return ident;
    }

    public void setIdent(final InstanceIdentifier<Node> ident) {
        this.ident = ident;
    }
    ...
    public class NetconfTopologySetup {
        ...
        private final InstanceIdentifier<Node> ident;
        ...
        public InstanceIdentifier<Node> getIdent() {
            return ident;
        }
