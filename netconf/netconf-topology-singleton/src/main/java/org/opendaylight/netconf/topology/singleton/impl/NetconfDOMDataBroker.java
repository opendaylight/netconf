...
class NetconfDOMDataBroker implements DOMDataBroker {

    private final RemoteDeviceId id;
    private final NetconfDOMTransactions masterDataBroker;
    private final ActorSystem actorSystem;

    NetconfDOMDataBroker(final ActorSystem actorSystem, final RemoteDeviceId id,
                         final NetconfDOMTransactions masterDataBroker) {
        this.id = id;
