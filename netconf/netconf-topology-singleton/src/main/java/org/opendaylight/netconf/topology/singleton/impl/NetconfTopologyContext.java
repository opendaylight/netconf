...
class NetconfTopologyContext implements ClusterSingletonService {
    ...
    NetconfTopologyContext(final NetconfTopologySetupBuilder.NetconfTopologySetup netconfTopologyDeviceSetup) {
        this.netconfTopologyDeviceSetup = Preconditions.checkNotNull(netconfTopologyDeviceSetup);
        serviceGroupIdent = ServiceGroupIdentifier.create(netconfTopologyDeviceSetup.getIdent().toString());
