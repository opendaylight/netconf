...
import org.opendaylight.netconf.topology.singleton.api.NetconfDOMTransactions;
...
public class NetconfProxyDOMTransactions implements NetconfDOMTransactions {

    private final ActorSystem actorSystem;
    private final ActorRef masterContextRef;

    public NetconfProxyDOMTransactions(final ActorSystem actorSystem, final ActorRef masterContextRef) {
    ...
    public Future<Optional<NormalizedNodeMessage>> read(final LogicalDatastoreType store,
        ...
        scala.concurrent.Future<Object> readScalaFuture =
    ...
    public Future<Boolean> exists(final LogicalDatastoreType store, final YangInstanceIdentifier path) {
        scala.concurrent.Future<Object> existsScalaFuture =
    ...
    public boolean cancel() {
        scala.concurrent.Future<Object> cancelScalaFuture =
    ...
    public Future<Void> submit() {
        scala.concurrent.Future<Object> submitScalaFuture =
