...
class FailedProxyTransactionFacade implements ProxyTransactionFacade {
    ...
    public CheckedFuture<Void, TransactionCommitFailedException> submit() {
        LOG.debug("{}: Submit {} {} - failure {}", id, failure);
        return Futures.immediateFailedCheckedFuture(failure instanceof TransactionCommitFailedException
                ? (TransactionCommitFailedException)failure :
                    new TransactionCommitFailedException("submit", failure));
    }
