...
public class NetconfNodeMasterActor extends UntypedActor {
    ...
    private Duration writeTxIdleTimeout;
    ...
    public static Props props(final NetconfTopologySetup setup,
        ...
        return Props.create(NetconfNodeMasterActor.class, () ->
                new NetconfNodeMasterActor(setup, id, schemaRepository));
    }

    private NetconfNodeMasterActor(final NetconfTopologySetup setup,
                                   final RemoteDeviceId id,
                                   final SchemaRepository schemaRepository) {
        this.setup = setup;
        this.id = id;
