...
public class NetconfNodeActor extends AbstractUntypedActor {
    ...
    public void handleReceive(final Object message) {
        ...
        if (message instanceof CreateInitialMasterActorData) { // master
            ...
            if (deviceDataBroker != null) {
                ...
                askForMasterMountPoint.getSlaveActorRef()
                    .tell(new RegisterMountPoint(sourceIdentifiers, self()), sender());
            } else {
    ...
    private void invokeSlaveAction(final SchemaPath schemaPath, final ContainerNodeMessage containerNodeMessage,
        ...
        final ListenableFuture<? extends DOMActionResult> actionResult = deviceAction
            .invokeAction(schemaPath, domDataTreeIdentifier,
                containerNodeMessage != null ? containerNodeMessage.getNode() : null);
