...
class ActorProxyTransactionFacade implements ProxyTransactionFacade {
    ...
    public CheckedFuture<Void, TransactionCommitFailedException> submit() {
        ...
        return Futures.makeChecked(settableFuture, failure -> failure instanceof TransactionCommitFailedException
                ? (TransactionCommitFailedException)failure : newTransactionCommitFailedException(failure));
    }
    ...
    private TransactionCommitFailedException newTransactionCommitFailedException(final Throwable failure) {
        return new TransactionCommitFailedException(String.format("%s: Submit of transaction failed", getIdentifier()),
                failure);
    }
