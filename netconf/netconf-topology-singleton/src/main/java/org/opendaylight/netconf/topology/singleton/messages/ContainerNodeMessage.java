...
/**
 * Message container which holds node data in {@link YangInstanceIdentifier} and {@link ContainerNode}, prepared to
 * send between remote hosts with serialization when remote action is invoked.
 */
