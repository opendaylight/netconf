...
public class NetconfNodeActorTest {
    ...
    public void testProxyDOMRpcService() throws Exception {
        ...
        final ProxyDOMRpcService slaveDomRPCService = new ProxyDOMRpcService(system, masterRef);
        ...
        doReturn(Futures.immediateFailedCheckedFuture(new RpcErrorsException("", Lists.newArrayList(rpcError))))
                .when(domRpcService).invokeRpc(any(), any());
