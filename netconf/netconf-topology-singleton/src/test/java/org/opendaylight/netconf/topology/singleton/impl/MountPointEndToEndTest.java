...
public class MountPointEndToEndTest {
    ...
    private void testRpc(final DOMRpcService domRpcService, final SchemaPath schemaPath, final NormalizedNode<?, ?> input,
    ...
    private void testFailedRpc(final DOMRpcService domRpcService, final SchemaPath schemaPath, final NormalizedNode<?, ?> input)
    ...
    private DOMRpcResult invokeRpc(final DOMRpcService domRpcService, final SchemaPath schemaPath, final NormalizedNode<?, ?> input,
            final CheckedFuture<DOMRpcResult, DOMRpcException> returnFuture)
                    throws InterruptedException, ExecutionException, TimeoutException {
    ...
    private static <T extends DOMService> T getMountPointService(final DOMMountPoint mountPoint, final Class<T> serviceClass) {
