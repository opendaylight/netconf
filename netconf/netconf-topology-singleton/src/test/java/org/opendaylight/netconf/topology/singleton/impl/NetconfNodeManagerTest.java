...
public class NetconfNodeManagerTest {
    ...
    public void setup() {
        ...
        ActorRef realMasterActorRef = masterSystem.actorOf(NetconfNodeActor.props(masterSetup, DEVICE_ID,
                masterSchemaRepository, masterSchemaRepository, responseTimeout, mockMountPointService));

        testMasterActorRef = TestActorRef.create(masterSystem, Props.create(TestMasterActor.class, realMasterActorRef)
    ...
    public void testSlaveMountPointRegistrationFailuresAndRetries()
        ...
        // Now initialize the master and drop the initial AskForMasterMountPoint message sent to the master so
        // it retries.
    ...
    private static class TestMasterActor extends UntypedAbstractActor {
        final ActorRef realMasterActorRef;
        final Map<Class<?>, CompletableFuture<? extends Object>> messagesToDrop = new ConcurrentHashMap<>();

        @SuppressWarnings("unused")
        TestMasterActor(ActorRef realMasterActorRef) {
            this.realMasterActorRef = realMasterActorRef;
        }
        ...
        public void onReceive(Object message) {
            ...
            if (dropFuture != null) {
                ...
                realMasterActorRef.forward(message, context());
            }
        }
    }
}
