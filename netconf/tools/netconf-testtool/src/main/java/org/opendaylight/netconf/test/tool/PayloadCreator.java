...
final class PayloadCreator {
    ...
    private static List<NormalizedNode> createBatchedPayloads(final String topologyId,
            final List<List<Integer>> portsInBatches, final List<List<String>> nodeIdsInBatches,
    ...
    private static List<NormalizedNode> createSingleNodePayloads(final String topologyId, final List<Integer> ports,
            final List<String> nodeIds, final String host, final String username, final String password,
        ...
        for (final Integer port : ports) {
            ...
            nodeListBuilder.addChild(Builders.mapEntryBuilder()
                    .withNodeIdentifier(NodeIdentifierWithPredicates.of(Node.QNAME,
                            ImmutableMap.of(NODE_ID_QNAME, nodeId)))
    ...
    private static NormalizedNode createSingleNodeTopology(final String topologyId, final int port, final String nodeId,
            final String host, final String username, final String password, final boolean tcpOnly,
            final int keepaliveDelay, final boolean schemaless) {
