...
public class TesttoolParameters {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(TesttoolParameters.class);

    private static final String HOST_KEY = "{HOST}";
    private static final String PORT_KEY = "{PORT}";
    private static final String ADDRESS_PORT = "{ADDRESS:PORT}";
    private static final String dest = "http://{ADDRESS:PORT}/restconf/config/network-topology:network-topology/topology/topology-netconf/node/sim-device{PORT}";
    ...
    static ArgumentParser getParser() {
        ...
        parser.addArgument("--edit-content")
                .type(File.class)
                .setDefault(new File(TesttoolParameters.class.getResource("/config-template.xml").getFile()))
                .dest("edit-content");
    ...
    void validate() {
        ...
        if (!controllerDestination.isEmpty()) {
