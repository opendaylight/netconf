    ...
    public static void main(final String[] args) {
        ...
        try {
            ...
            if (params.getControllerIp() != null) {
                ...
                final List<List<DestToPayload>> allThreadsPayloads = payloadCreator.getThreadsPayloads(openDevices);
                final List<Execution> executions = new ArrayList<>();
                for (final List<DestToPayload> payloads : allThreadsPayloads) {
