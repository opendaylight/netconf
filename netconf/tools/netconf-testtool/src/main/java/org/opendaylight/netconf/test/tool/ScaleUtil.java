...
public final class ScaleUtil {
    ...
    private static class ScaleVerifyCallable implements Callable<Void> {
        ...
        ScaleVerifyCallable(final NetconfDeviceSimulator simulator, final TesttoolParameters params) {
            ...
            this.params = params;
            this.controllerAuthUsername = params.controllerAuthUsername != null ? params.controllerAuthUsername : "admin";
            this.controllerAuthPassword = params.controllerAuthPassword != null ? params.controllerAuthPassword : "admin";
