...
public final class ScaleUtil {
    ...
    private static void generateConnectors(final TesttoolParameters params, final List<Integer> openDevices)
        ...
        List<Future<Void>> futures = executor.invokeAll(executions, params.generateConfigsTimeout, TimeUnit.SECONDS);
        int threadNum = 0;
