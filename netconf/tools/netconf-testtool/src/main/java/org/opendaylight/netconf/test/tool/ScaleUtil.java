...
public final class ScaleUtil {
    ...
    public static void main(final String[] args) {
        ...
        params.controllerIp = params.controllerIp != null ? params.controllerIp : "127.0.0.1";
        params.controllerPort = params.controllerPort != null ? params.controllerPort : 8181;
        ...
        while (true) {
            ...
            try {
                ...
                do {
                    ...
                    root.warn(status);
                } while (status.startsWith("Failed to get the session"));//!status.startsWith("Name"));
    ...
    private static class ScaleVerifyCallable implements Callable<Void> {
        ...
        private final String controllerAuthUsername;
        private final String controllerAuthPassword;
        ...
        ScaleVerifyCallable(final NetconfDeviceSimulator simulator, final TesttoolParameters params) {
            ...
            this.params = params;
            this.controllerAuthUsername = params.controllerAuthUsername != null ?
                params.controllerAuthUsername : "admin";
            this.controllerAuthPassword = params.controllerAuthPassword != null ?
                params.controllerAuthPassword : "admin";
            this.httpClient = HttpClient.newBuilder()
                    .authenticator(new Authenticator() {
                        @Override
                        protected PasswordAuthentication getPasswordAuthentication() {
                            return new PasswordAuthentication(controllerAuthUsername,
                                controllerAuthPassword.toCharArray());
                        }
                    })
                    .build();
            ...
            try {
                ...
                if (response.statusCode() != 200 && response.statusCode() != 204) {
                    ...
                    resultsLog.info("Currently connected devices : {} out of {}, time elapsed: {}",
                        count, params.deviceCount, STOPWATCH);
                    if (count != params.deviceCount) {
                        EXECUTOR.schedule(
