...
public class TestToolTest {
    ...
    private NetconfDeviceSimulator tcpDeviceSimulator;
    private NetconfDeviceSimulator sshDeviceSimulator;
    private int tcpDevicePort;
    private int sshDevicePort;
    ...
    private Document sendRequest(final NetconfClientProtocol protocol, final String xml)
        throws Exception {
        ...
        final NetconfMessage response;
        try (var client = clientFactory.createClient(clientConfig).get(RESPONSE_TIMEOUT_MS, TimeUnit.MILLISECONDS)) {
    ...
    private static NetconfClientConfiguration getClientConfig(final int port, final NetconfClientProtocol protocol,
