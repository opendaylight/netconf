...
public class NetconfMdsalNotificationMapperModule extends org.opendaylight.controller.config.yang.netconf.mdsal.notification.AbstractNetconfMdsalNotificationMapperModule {
    ...
    public java.lang.AutoCloseable createInstance() {
        ...
        final BaseNotificationPublisher capabilityPublisher = new BaseCapabilityChangeNotificationPublisher(notificationCollector.registerBaseNotificationPublisher());
        final ListenerRegistration capabilityChangeListenerRegistration = capabilityPublisher.registerOnChanges(dataBroker);

        final BaseNotificationPublisher sessionPublisher = new BaseSessionNotificationPublisher(notificationCollector.registerBaseNotificationPublisher());
        final ListenerRegistration sessionListenerRegistration = sessionPublisher.registerOnChanges(dataBroker);
