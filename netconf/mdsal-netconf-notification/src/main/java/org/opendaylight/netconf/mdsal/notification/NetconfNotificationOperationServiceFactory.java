...
public class NetconfNotificationOperationServiceFactory implements NetconfOperationServiceFactory, AutoCloseable {
    ...
    public Set<Capability> getCapabilities() {
        // TODO
        // No capabilities exposed to prevent clashes with schemas from config-netconf-connector (it exposes all the
        // schemas)
        // If the schemas exposed by config-netconf-connector are filtered, this class would expose monitoring
        // related models
