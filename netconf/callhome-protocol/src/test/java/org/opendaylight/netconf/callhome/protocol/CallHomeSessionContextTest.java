...
public class CallHomeSessionContextTest {
    ClientSessionImpl mockSession;
    CallHomeAuthorization mockAuth;
    ClientChannel mockChannel;
    InetSocketAddress address;

    ReverseSshChannelInitializer.Factory mockChannelInitializerFactory;
    ReverseSshChannelInitializer mockChannelInitializer;
    CallHomeNetconfSubsystemListener subListener;
    EventLoopGroup mockNettyGroup;
    CallHomeSessionContext.Factory realFactory;
    CallHomeSessionContext instance;
    ...
    public void setup() {
        ...
        mockChannelInitializerFactory = mock(ReverseSshChannelInitializer.Factory.class);
        subListener = mock(CallHomeNetconfSubsystemListener.class);
        mockNettyGroup = mock(EventLoopGroup.class);

        realFactory = new CallHomeSessionContext.Factory(mockNettyGroup, mockChannelInitializerFactory, subListener);
        ...
        instance = realFactory.create(mockSession, mockAuth, address);
    }
