...
public class NetconfCallHomeServer implements AutoCloseable, ServerKeyVerifier {
    ...
    NetconfCallHomeServer(final SshClient sshClient, final CallHomeAuthorizationProvider authProvider, final Factory factory,
                          final InetSocketAddress socketAddress, final StatusRecorder recorder) {
