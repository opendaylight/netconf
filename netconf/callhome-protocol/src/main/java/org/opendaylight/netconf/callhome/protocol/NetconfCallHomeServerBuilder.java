...
public class NetconfCallHomeServerBuilder implements Builder<NetconfCallHomeServer> {
    ...
    public NetconfCallHomeServerBuilder(CallHomeAuthorizationProvider authProvider,
        ...
        this(authProvider, new SingleListenerChannelActivator(sessionListener));
    ...
    public NetconfCallHomeServer build() {
        Factory factory =
                new CallHomeSessionContext.Factory(nettyGroup(), netconfChannelInitializer(), subsystemListener());
    ...
    private ReverseSshChannelInitializer.Factory netconfChannelInitializer() {
        return new ReverseSshChannelInitializer.Factory(negotiatorFactory());
    }
