...
public interface NetconfDataTreeService extends DOMService {
     ...
     * @return result of &lt;get&gt; operation
     */
    ListenableFuture<Optional<NormalizedNode<?, ?>>> get(NetconfXPathContext xpathContext);
     ...
     * @return result of &lt;get-config&gt; operation
     */
    ListenableFuture<Optional<NormalizedNode<?, ?>>> getConfig(NetconfXPathContext xpathContext);
