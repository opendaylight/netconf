...
public class ConcurrentClientsTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{{4, TestingNetconfClientRunnable.class,
            ...
            {1, TestingNetconfClientRunnable.class, NetconfServerSessionNegotiatorFactory
    ...
    private static class TestingNetconfOperation implements NetconfOperation {
        ...
        @Override
        public Document handle(Document requestMessage, NetconfOperationChainedExecution subsequentOperation) throws
                DocumentedException {
            try {
