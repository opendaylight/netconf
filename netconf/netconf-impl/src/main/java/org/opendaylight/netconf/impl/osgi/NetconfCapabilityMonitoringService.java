...
class NetconfCapabilityMonitoringService implements CapabilityListener, AutoCloseable {
    ...
    public NetconfCapabilityMonitoringService(final NetconfOperationServiceFactory netconfOperationProvider) {
    ...
    public synchronized AutoCloseable registerListener(final NetconfMonitoringService.CapabilitiesListener listener) {
    ...
    static Set<Capability> setupCapabilities(final Set<Capability> caps) {
    ...
    private void onCapabilitiesRemoved(final Set<Capability> addedCaps) {
