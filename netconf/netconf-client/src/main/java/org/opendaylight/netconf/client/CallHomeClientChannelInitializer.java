...
import org.opendaylight.netconf.nettyutil.handler.ssh.client.CallHomeAsyncSshHandler;

final class CallHomeClientChannelInitializer extends SshClientChannelInitializer {

    private final IoSession tcpSession;

    public CallHomeClientChannelInitializer(final AuthenticationHandler authHandler,
    ...
    protected ChannelHandler getSshHandler() throws IOException {
        return CallHomeAsyncSshHandler.createForNetconfSubsystem(getAuthenticationHandler(), new org.apache.sshd.common.io.IoSession() {
            @Override
            public long getId() {
