...
public class NetconfCallHomeClientConfiguration extends NetconfClientConfiguration {

    private final IoSession tcpSession;

    public NetconfCallHomeClientConfiguration(final Long connectionTimeoutMillis,
