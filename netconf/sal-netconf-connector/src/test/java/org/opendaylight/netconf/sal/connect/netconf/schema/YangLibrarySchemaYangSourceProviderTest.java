...
//        final URL url = new URL("http://localhost:8181/yanglib/schemas/opendaylight-pingpong-broker/2014-11-07");
    ...
    public void testGetSource() throws Exception {
        CheckedFuture<? extends YangTextSchemaSource, SchemaSourceException> source = yangLibrarySchemaYangSourceProvider.getSource(workingSid);
    ...
    public void testGetSourceFailure() throws Exception {
        ...
        CheckedFuture<? extends YangTextSchemaSource, SchemaSourceException> source = failingYangLibrarySchemaYangSourceProvider.getSource(workingSid);
        source.checkedGet();
    }
