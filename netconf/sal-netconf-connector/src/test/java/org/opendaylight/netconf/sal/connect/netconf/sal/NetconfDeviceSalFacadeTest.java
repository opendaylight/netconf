...
public class NetconfDeviceSalFacadeTest {
    ...
    public void setUp() throws Exception{
        ...
        Broker domRegistry = mock(Broker.class);
        BindingAwareBroker bindingRegistry = mock(BindingAwareBroker.class);
        deviceFacade = new NetconfDeviceSalFacade(remoteDeviceId, domRegistry, bindingRegistry);

        Field f = NetconfDeviceSalFacade.class.getDeclaredField("salProvider");
