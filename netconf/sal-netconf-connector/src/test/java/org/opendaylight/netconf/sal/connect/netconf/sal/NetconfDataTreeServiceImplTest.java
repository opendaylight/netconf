...
public class NetconfDataTreeServiceImplTest extends AbstractTestModelTest {
    ...
    public void getXPathTest() {
        netconService.getExtensions().get(NetconfDataTreeExtensionService.class).get(NetconfXPathContext.empty());
        verify(rpcService).invokeRpc(eq(toPath(NETCONF_GET_QNAME)), any(ContainerNode.class));
    }
    ...
    public void getConfigXPathTest() {
        netconService.getExtensions().get(NetconfDataTreeExtensionService.class).getConfig(NetconfXPathContext.empty());
        verify(rpcService).invokeRpc(eq(toPath(NETCONF_GET_CONFIG_QNAME)), any(ContainerNode.class));
    }
