...
public class NetconfDeviceTopologyAdapterTest {
    ...
    public void testDeviceAugmentedNodePresence() throws Exception {
        ...
        assertEquals("Augmented node data should be inserted after device update.", true, testNode.isPresent());
        ...
        assertEquals("Augmented node data should be inserted after device failed.", true, testNode.isPresent());
