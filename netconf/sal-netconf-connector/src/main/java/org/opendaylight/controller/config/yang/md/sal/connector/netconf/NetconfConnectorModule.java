...
public final class NetconfConnectorModule extends org.opendaylight.controller.config.yang.md.sal.connector.netconf.AbstractNetconfConnectorModule implements BindingAwareConsumer {
    ...
    private static final InstanceIdentifier<Topology> topologyId = InstanceIdentifier.create(NetworkTopology.class)
    ...
    public void onSessionInitialized(final BindingAwareBroker.ConsumerContext session) {
        ...
        nodePath = topologyId.child(Node.class, nodeKey);
        ...
        Futures.addCallback(submitFuture, new FutureCallback<Void>() {
            ...
            public void onSuccess(@Nullable final Void result) {
                LOG.info("Node {} was successfully added to the topology", instanceName);
            }
    ...
    private void deleteNode() {
        if (dataBroker != null) {
            ...
            Futures.addCallback(submitFuture, new FutureCallback<Void>() {
                @Override
                public void onSuccess(@Nullable final Void result) {
                    LOG.info("Node {} was successfully deleted from the topology", instanceName);
                }
