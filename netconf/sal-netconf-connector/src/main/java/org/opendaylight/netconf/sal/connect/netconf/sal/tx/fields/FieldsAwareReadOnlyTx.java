...
public final class FieldsAwareReadOnlyTx extends ReadOnlyTx implements NetconfDOMFieldsReadTransaction {
    ...
    private FluentFuture<Optional<NormalizedNode<?, ?>>> readConfigurationData(final YangInstanceIdentifier path,
    ...
    private FluentFuture<Optional<NormalizedNode<?, ?>>> readOperationalData(final YangInstanceIdentifier path,
            final List<YangInstanceIdentifier> fields) {
