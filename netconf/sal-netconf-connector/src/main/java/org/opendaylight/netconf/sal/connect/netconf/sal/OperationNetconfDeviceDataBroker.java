...
public final class OperationNetconfDeviceDataBroker extends NetconfDeviceDataBroker
    ...
    @Override
    public NetconfOperationDOMTransactionChain createTransactionChain(final DOMTransactionChainListener listener) {
        return createNetconfTransactionChain(listener);
    }
