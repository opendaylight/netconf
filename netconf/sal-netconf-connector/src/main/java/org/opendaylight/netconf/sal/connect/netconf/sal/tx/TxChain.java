...
public class TxChain implements DOMTransactionChain, TxListener {
    ...
    /**
     * Last write transaction status. Transaction is finished, if it is submitted or cancelled.
     */
    ...
    @Override
    public void onTransactionSubmitted(final AbstractWriteTx transaction) {
