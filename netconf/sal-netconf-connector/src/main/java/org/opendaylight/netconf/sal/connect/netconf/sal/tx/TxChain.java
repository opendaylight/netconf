...
public class TxChain implements DOMTransactionChain, TxListener {
    ...
    private ListenerRegistration<TxListener> txListenerRegistration;
    /**
    ...
    private void setLastFinishedTxStatus(final boolean txStatus) {
        this.lastTxFinished.set(true);
        this.lastTxSuccessful.set(txStatus);
        this.txListenerRegistration.close();
    }
