...
public class CreateOperationWriteRunningTx extends WriteRunningTx {
    private static final Logger LOG = LoggerFactory.getLogger(CreateOperationWriteRunningTx.class);

    public CreateOperationWriteRunningTx(RemoteDeviceId id, NetconfBaseOps netOps, boolean rollbackSupport) {
        super(id, netOps, rollbackSupport);
    }

    public CreateOperationWriteRunningTx(RemoteDeviceId id, NetconfBaseOps netconfOps, boolean rollbackSupport,
