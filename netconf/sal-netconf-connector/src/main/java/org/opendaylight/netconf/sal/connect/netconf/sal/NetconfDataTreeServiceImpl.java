...
public class NetconfDataTreeServiceImpl implements NetconfDataTreeService {
    ...
    @Override
    public ListenableFuture<? extends DOMRpcResult> editConfigMerge(final LogicalDatastoreType store,
                                                                    final YangInstanceIdentifier path,
    ...
    @Override
    public ListenableFuture<? extends DOMRpcResult> editConfigReplace(final LogicalDatastoreType store,
                                                                      final YangInstanceIdentifier path,
                                                                      final NormalizedNode<?, ?> data,
                                                                      final Optional<ModifyAction> defaultOperation) {
        final DataContainerChild<?, ?> editStructure = netconfOps.createEditConfigStrcture(Optional.ofNullable(data),
    ...
    @Override
    public ListenableFuture<? extends DOMRpcResult> editConfigCreate(final LogicalDatastoreType store,
                                                                     final YangInstanceIdentifier path,
                                                                     final NormalizedNode<?, ?> data,
                                                                     final Optional<ModifyAction> defaultOperation) {
        final DataContainerChild<?, ?> editStructure = netconfOps.createEditConfigStrcture(Optional.ofNullable(data),
    ...
    @Override
    public ListenableFuture<? extends DOMRpcResult> editConfigDelete(final LogicalDatastoreType store,
                                                                     final YangInstanceIdentifier path,
                                                                     final NormalizedNode<?, ?> data,
                                                                     final Optional<ModifyAction> defaultOperation) {
        final DataContainerChild<?, ?> editStructure = netconfOps.createEditConfigStrcture(Optional.ofNullable(data),
    ...
    @Override
    public ListenableFuture<? extends DOMRpcResult> editConfigRemove(final LogicalDatastoreType store,
                                                                     final YangInstanceIdentifier path,
                                                                     final NormalizedNode<?, ?> data,
                                                                     final Optional<ModifyAction> defaultOperation) {
        final DataContainerChild<?, ?> editStructure = netconfOps.createEditConfigStrcture(Optional.ofNullable(data),
