...
import org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.device.rev221225.DatastoreAccess;
...
public abstract sealed class AbstractNetconfDataTreeService implements NetconfDataTreeService {
    ...
    public static @NonNull AbstractNetconfDataTreeService of(final RemoteDeviceId id,
            ...
            final NetconfSessionPreferences sessionPreferences, final @Nullable DatastoreAccess dsAccess) {
        ...
        final boolean lockDatastore = dsAccess == null || dsAccess.requireLockDatastore();
