...
public abstract class AbstractNetconfDataTreeService implements NetconfDataTreeService {
    ...
    public synchronized ListenableFuture<DOMRpcResult> unlock() {
        ...
        if (!isLockAllowed) {
            ...
            LOG.error("{}: Skip unlock operation, as device wasn't locked by this transcation", id);
            return RPC_SUCCESS;
        }
    ...
    // Transform list of futures relatedo to RPC operation into a single Future
