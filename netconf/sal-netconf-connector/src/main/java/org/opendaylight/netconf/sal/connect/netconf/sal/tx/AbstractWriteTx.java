                ...
                domRpcResults.forEach(domRpcResult -> {
                    if (!domRpcResult.getErrors().isEmpty() && !transformed.isDone()) {
                        ...
                        if (domRpcResult.getErrors().iterator().hasNext()) {
                            ...
                            final RpcError.ErrorSeverity eSeverity = error.getSeverity();
                            final DocumentedException.ErrorSeverity severity;
                            switch (eSeverity) {
                                case ERROR:
                                    severity = DocumentedException.ErrorSeverity.ERROR;
                                    break;
                                case WARNING:
                                    severity = DocumentedException.ErrorSeverity.WARNING;
                                    break;
                                default:
                                    severity = DocumentedException.ErrorSeverity.ERROR;
                                    break;
                            ...
                            exception = new NetconfDocumentedException(id + ":RPC during tx failed with message:\n" +
                                    error.getMessage(),
                                    eType,
