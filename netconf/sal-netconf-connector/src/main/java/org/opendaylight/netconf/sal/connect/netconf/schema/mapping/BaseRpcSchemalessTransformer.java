...
public class BaseRpcSchemalessTransformer implements MessageTransformer<NetconfMessage> {
    ...
    public NetconfMessage toRpcRequest(SchemaPath rpc, NormalizedNode<?, ?> payload) {
        ...
        final DOMResult domResult = NetconfMessageTransformer.prepareDomResultForRpcRequest(rpcQName, counter);
        ...
        try {
            NetconfMessageTransformer.writeNormalizedRpc(((ContainerNode) payload), result, rpc, schemaContext);
