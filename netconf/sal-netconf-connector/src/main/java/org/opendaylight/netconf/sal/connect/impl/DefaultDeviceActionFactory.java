...
@Singleton
public final class DefaultDeviceActionFactory implements DeviceActionFactory {
    private static final Logger LOG = LoggerFactory.getLogger(DefaultDeviceActionFactory.class);
