...
public class NetconfDeviceTopologyAdapter implements AutoCloseable {
    ...
    public void updateDeviceDataToConnecting(final NetconfDeviceCapabilities capabilities) {
        updateDeviceData(ConnectionStatus.Connecting, capabilities, LogicalDatastoreType.OPERATIONAL, null,
                Uint32.ZERO);
    }

    public void updateDeviceDataToConnected(final NetconfDeviceCapabilities capabilities, final Uint32 sessionId) {
