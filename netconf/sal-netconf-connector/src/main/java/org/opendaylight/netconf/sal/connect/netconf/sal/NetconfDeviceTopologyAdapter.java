...
import org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.node.topology.rev180703.netconf.node.connection.status.AvailableCapabilitiesBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.node.topology.rev180703.netconf.node.connection.status.ClusteredConnectionStatusBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.node.topology.rev180703.netconf.node.connection.status.UnavailableCapabilities;
import org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.node.topology.rev180703.netconf.node.connection.status.UnavailableCapabilitiesBuilder;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.node.topology.rev180703.netconf.node.connection.status.unavailable.capabilities.UnavailableCapabilityBuilder;
...
public final class NetconfDeviceTopologyAdapter implements AutoCloseable {
    ...
    private void createNetworkTopologyIfNotPresent(final WriteTransaction writeTx) {
        ...
        final Network topology =
                new NetworkBuilder().setNetworkId(new NetworkId(NetconfNetwork.QNAME.getLocalName())).build();
