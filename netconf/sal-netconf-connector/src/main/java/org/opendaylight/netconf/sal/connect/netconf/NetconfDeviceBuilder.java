...
public class NetconfDeviceBuilder {
    ...
    private NetconfNodeOptional nodeOptional;
    ...
    public NetconfDeviceBuilder setNode(NetconfNode node) {
        this.node = node;
        return this;
    }

    public NetconfDeviceBuilder setEventExecutor(EventExecutor eventExecutor) {
        this.eventExecutor = eventExecutor;
        return this;
    }

    public NetconfDeviceBuilder setNodeOptional(NetconfNodeOptional nodeOptional) {
