...
public class NetconfKeystoreAdapter implements ClusteredDataTreeChangeListener<Keystore> {
    ...
    public java.security.KeyStore getJavaKeyStore() throws GeneralSecurityException, IOException {
        ...
        synchronized (this.trustedCertificates) {
            for (Map.Entry<String, TrustedCertificate> entry : this.trustedCertificates.entrySet()) {
    ...
    java.security.PrivateKey getJavaPrivateKey(String base64PrivateKey) throws GeneralSecurityException {
    ...
    List<X509Certificate> getCertificateChain(String[] base64Certificates) throws GeneralSecurityException {
    ...
    byte[] base64Decode(String base64) {
    ...
    void processChild(DataObjectModification<? extends DataObject> objectMod) {
