...
public class NetconfDevice implements RemoteDevice<NetconfSessionPreferences, NetconfMessage, NetconfDeviceCommunicator> {
    ...
    private final class SchemaSetup implements Runnable {
            ...
            while (!requiredSources.isEmpty()) {
                ...
                try {
                    ...
                    if (t instanceof MissingSchemaSourceException){
                        ...
                        requiredSources = handleSchemaMissingSourceException(requiredSources, (SchemaResolutionException) t);
                    } else {
                        // unknown error, fail
                        handleSalInitializationFailure(t, listener);
                        return;
        ...
        private Collection<SourceIdentifier> handleSchemaMissingSourceException(Collection<SourceIdentifier> requiredSources, final SchemaResolutionException resolutionException) {
