...
import org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.node.optional.rev190621.NetconfNodeAugmentedOptional;
    ...
    private final class SchemaSetup implements Runnable {
        ...
        private void setUpSchema(Collection<SourceIdentifier> requiredSources) {
            ...
            if (nodeOptional != null && nodeOptional.getIgnoreMissingSchemaSources().isAllowed()) {
                ...
                }, nodeOptional.getIgnoreMissingSchemaSources().getRecconectTime(), TimeUnit.MILLISECONDS);
            } else {
