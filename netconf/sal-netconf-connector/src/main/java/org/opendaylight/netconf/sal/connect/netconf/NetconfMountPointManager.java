...
public class NetconfMountPointManager
        implements RemoteDeviceHandler<NetconfSessionPreferences>, MountPointManager<NetconfSessionPreferences> {
    ...
    @VisibleForTesting
    public int getCountMountPointInstance() {
        return capabilityMountPointContextMap.size();
    }
