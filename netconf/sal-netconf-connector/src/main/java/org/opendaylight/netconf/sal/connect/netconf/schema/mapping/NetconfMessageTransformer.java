...
public class NetconfMessageTransformer implements MessageTransformer<NetconfMessage> {
    ...
    private SchemaPath removeRevisions(SchemaPath originalSchemaPath) {
        ...
        return SchemaPath.create(schemaPaths, originalSchemaPath.isAbsolute());
    }
    ...
    private Map.Entry<Node, SchemaNode> findXmlContainerChildPair(final Node xmlNode,
            final ContainerSchemaNode dataContainerNode) {
    ...
    private Map<QName, Object> findXmlListKeys(final Node xmlNode, final ListSchemaNode listSchemaNode) {
    ...
    private Map.Entry<Node, SchemaNode> findXmlListChildPair(final Node xmlNode, final ListSchemaNode listSchemaNode) {
        NodeList nodeList = xmlNode.getChildNodes();
