...
public interface SchemalessRpcService extends DOMService {
    ...
    //                     the transformers.
    //
    //        One notable thing is KeepaliveSalFacade which guarantees it is invoking a base rpc -- i.e. should be able
    //        to operate in terms of normal DOMRpcResult terms -- and so should NetconfBaseOps -- we already have
    //        BaseRpcSchemalessTransformer and some magic in NetconfMessageTransformUtil
    //
    //        Hence we perhaps want to keep this method for the real generic stuff and introduce invokeBaseRpc() with
    //        DOMRpcService.invokeRpc() signature and semantics
