...
public interface RemoteDeviceManagerHandler<PREF>  {
    ...
    default void onDeviceReconnected(String nodeId, NetconfSessionPreferences netconfSessionPreferences,
            NetconfNode node) {

    }

    default void onDeviceConnected(final String nodeId, final NetconfSessionPreferences netconfSessionPreferences,
