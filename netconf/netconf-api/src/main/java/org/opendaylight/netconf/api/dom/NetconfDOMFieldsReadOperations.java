...
public interface NetconfDOMFieldsReadOperations {
     ...
     * @param path   Path which uniquely identifies subtree from which client want to read selected fields.
     * @param fields List of relative paths under parent path which client want to read.
