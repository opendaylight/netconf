...
//        yangLibProvider = new YangLibProvider(null, "www.example.com", "300");
...
//                .setSchema(new Uri("http://www.example.com:300/yanglib/schemas/no-revision/"))
//                .build();
//
...
//                .setSchema(new Uri("http://www.example.com:300/yanglib/schemas/with-revision/2016-04-28"))
//                .build();
//
//        newModulesList.add(newModule);
//
