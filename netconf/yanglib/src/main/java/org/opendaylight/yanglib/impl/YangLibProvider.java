...
public class YangLibProvider implements AutoCloseable, SchemaSourceListener, YangLibService {
    ...
    private String getYangModel(final String name, final String revision) {
        ...
        try {
            ...
            if (e.getCause() instanceof MissingSchemaSourceException missingSchemaCause) {
                throw new WebApplicationException(e,
                        Response.status(404, missingSchemaCause.getMessage()).build());
            }
            throw new IllegalArgumentException("Unable to get schema " + sourceId, e);
