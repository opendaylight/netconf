...
public class CallHomeSshServerTest {
    ...
    void integrationTest() throws Exception {
        ...
        try {
            ...
            verify(statusRecorder, timeout(TIMEOUT).times(1)).reportUnknown(eq(client1Keys.getPublic()));
            ...
            // verify auth failure reported for known id and public key
            verify(statusRecorder, timeout(TIMEOUT).times(1))
                .reportFailedAuth(eq("client2-id"), eq(client2Keys.getPublic()));
