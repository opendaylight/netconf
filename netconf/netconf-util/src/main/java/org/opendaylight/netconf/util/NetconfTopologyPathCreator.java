...
public class NetconfTopologyPathCreator {
    ...
    public static final String CLUSTEREDDEVICESOURCESRESOLVER = "clusteredDeviceSourcesResolver";
    public static final String MASTERSOURCEPROVIDER = "masterSourceProvider";
