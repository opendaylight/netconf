...
public class NetconfConfigurationTest {
    ...
    @Test
    public void testGetConnectionTimeoutMillis() throws Exception {
        Assert.assertEquals(30000, NetconfConfiguration.getConnectionTimeoutMillis());
    }

    @Test
    public void testGetNetconfLocalAddress() throws Exception {
        Assert.assertEquals(new LocalAddress("netconf"), NetconfConfiguration.getNetconfLocalAddress());
    }
