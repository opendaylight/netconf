...
public class ActivatorTest {
    ...
    public void testActivator() throws Exception {
        ...
        final Field field = activator.getClass().getDeclaredField("netconfNotificationManager");
        field.setAccessible(true);
        final NetconfNotificationManager netconfNotificationManager = (NetconfNotificationManager) field.get(activator);

        final CreateSubscription createSubscription = new CreateSubscription("id", netconfNotificationManager);
