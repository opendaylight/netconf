...
public class NetconfNotificationManagerModule extends AbstractNetconfNotificationManagerModule {
    ...
    public java.lang.AutoCloseable createInstance() {
        final WaitingServiceTracker<NetconfNotificationRegistry> tracker =
                WaitingServiceTracker.create(NetconfNotificationRegistry.class, bundleContext);
        final NetconfNotificationRegistry service = tracker.waitForService(WaitingServiceTracker.FIVE_MINUTES);
