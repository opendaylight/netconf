...
public abstract class AbstractNetconfTopology implements NetconfTopology {
    ...
    private static final class SslHandlerFactoryImpl implements SslHandlerFactory {
        ...
        private final Optional<org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.node.topology.rev150114
            .protocol.grouping.protocol.Specification> specOptional;

        SslHandlerFactoryImpl(final NetconfKeystoreAdapter keystoreAdapter, final org.opendaylight.yang.gen.v1.urn
                .opendaylight.netconf.node.topology.rev150114.protocol.grouping.protocol.Specification specification) {
            ...
            try {
                ...
                if (specOptional.isPresent()) {
                    final org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.node.topology.rev150114
                        .protocol.grouping.protocol.Specification specification = specOptional.get();

                    assert specification instanceof org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.node
                        .topology.rev150114.protocol.grouping.protocol.specification.TlsCase;

                    final org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.node.topology.rev150114.protocol
                        .grouping.protocol.specification.TlsCase tlsCase =
                            (org.opendaylight.yang.gen.v1.urn.opendaylight.netconf.node.topology.rev150114.protocol
                                    .grouping.protocol.specification.TlsCase)specification;
