...
public abstract class AbstractNetconfTopology implements NetconfTopology {
    ...
    private Optional<UserPreferences> getUserCapabilities(final NetconfNode node) {
        ...
        Preconditions.checkState(netconfSessionPreferences.getNonModuleCaps().isEmpty(), "Capabilities to override can " +
                "only contain module based capabilities, non-module capabilities will be retrieved from the device, or" +
                " use non-module-capabilities to configure non-module capabilities. Used non-module capabilities: " +
