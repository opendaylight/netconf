...
public abstract class AbstractNetconfTopology implements NetconfTopology {
    ...
    protected NetconfDevice.SchemaResourcesDTO setupSchemaCacheDTO(final NodeId nodeId, final NetconfNode node) {
        ...
        addDefaultSchemas((SharedSchemaRepository) schemaRepository);
        if (schemaResourcesDTO == null) {
    ...
    synchronized private void addDefaultSchemas(final SharedSchemaRepository consumer) {
        SourceIdentifier sId = RevisionSourceIdentifier.create("notifications", "2008-07-14");
        registerSource(consumer, "/META-INF/yang/notifications@2008-07-14.yang", sId);
        sId = RevisionSourceIdentifier.create("ietf-netconf", "2011-06-02");
        registerSource(consumer, "/META-INF/yang/ietf-netconf-notifications@2012-02-06.yang", sId);
    }

    synchronized private void registerSource(final SharedSchemaRepository consumer, final String resource, final SourceIdentifier sourceId) {
