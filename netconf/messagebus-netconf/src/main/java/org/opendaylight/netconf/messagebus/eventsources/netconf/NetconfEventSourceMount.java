...
class NetconfEventSourceMount {
    ...
    static {
        CODEC_REGISTRY = new BindingNormalizedNodeCodecRegistry(BindingRuntimeHelpers.createRuntimeContext(
            new DefaultBindingRuntimeGenerator(), CreateSubscriptionInput.class));
    }
