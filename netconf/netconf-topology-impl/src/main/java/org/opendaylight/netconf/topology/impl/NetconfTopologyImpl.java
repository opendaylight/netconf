...
public class NetconfTopologyImpl extends AbstractNetconfTopology
    ...
    public NetconfTopologyImpl(final String topologyId, final NetconfClientDispatcher dispatcher,
        ...
        this(topologyId, dispatcher, netconfDeviceCommunicatorFactory, eventExecutor, keepaliveExecutor,
                processingExecutor, schemaRepositoryProvider, dataBroker, mountPointService, baseSchemas, null);
    }
