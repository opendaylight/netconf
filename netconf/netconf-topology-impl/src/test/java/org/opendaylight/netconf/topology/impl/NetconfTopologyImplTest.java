...
public class NetconfTopologyImplTest {
    ...
    public static class TestingNetconfTopologyImpl extends NetconfTopologyImpl {
        ...
        @Override
        public NetconfConnectorDTO createDeviceCommunicator(NodeId nodeId, NetconfNode node,
                                                            NetconfNodeAugmentedOptional nodeOptional) {
            return super.createDeviceCommunicator(nodeId, node, nodeOptional);
        }

        public void testNetconfConnectorDTO() {
