...
public class NetconfProvider implements BindingAwareProvider, AutoCloseable {
    ...
    public void onSessionInitiated(ProviderContext session) {
        ...
        context.registerService(MountPointService.class.getName(), mountService, null);
    ...
    private void initializeNetconfConsoleProvider(DataBroker dataBroker, BundleContext context, MountPointService mountService) {
        ...
        final NetconfConsoleProviderImpl consoleProvider = new NetconfConsoleProviderImpl(dataBroker, configPusher, mountService);
